export const Y8_CH12G_QUESTIONS = [
  // --- Question 1 (Split, Easy) ---
  {
    ...
    "a": "$\\triangle DEF$ with $DE = 6\\text{ cm}$, $EF = 7\\text{ cm}$, and $DF = 5\\text{ cm}$",
    "opts": [
  ...
  },
  {
    ...
    "a": "A rectangle with dimensions $5\\text{ cm} \\times 8\\text{ cm}$",
    "opts": [
  ...
  },
  {
    ...
    "a": "A regular hexagon with side length $4\\text{ cm}$ split by a diagonal line (rotated by $90^\\circ$)",
    "opts": [
  ...
  },
  {
    ...
    "a": "$\\triangle ABC \\equiv \\triangle ZYX$ (SAS)",
    "opts": [
  ...
  },
  {
    ...
    "a": "$\\triangle ABC \\equiv \\triangle RQP$ (AAS)",
    "opts": [
  ...
  },
  {
    ...
    "a": "$\\triangle ABC \\equiv \\triangle EDF$ (AAS)",
    "opts": [
      "$\\triangle ABC \\equiv \\triangle EDF$ (AAS)",
      "$\\triangle ABC \\equiv \\triangle DEF$ (ASA)",
