  ...
  },
  {
    ...
    "graphData": {
      "jsxGraph": {
        ...
        "script": "board.suspendUpdate();\nvar pA = board.create('point', [1, 1], {size: 3, color: 'black', name: 'A(1, 1)', withLabel: true, label: {autoPosition: false, offset: [10, -5]}});\nvar pB = board.create('point', [5, 4], {size: 3, color: 'black', name: 'B(5, 4)', withLabel: true, label: {autoPosition: false, offset: [10, 10]}});\nvar pC = board.create('point', [2, 8], {size: 3, color: 'black', name: 'C(2, 8)', withLabel: true, label: {autoPosition: false, offset: [10, 10]}});\nvar pD = board.create('point', [-2, 5], {size: 3, color: 'black', name: 'D(-2, 5)', withLabel: true, label: {autoPosition: false, offset: [-60, 5]}});\nboard.create('polygon', [pA, pB, pC, pD], {fillColor: 'none', borders: {strokeColor: 'black', strokeWidth: 1.5}});\nboard.unsuspendUpdate();"
      }
    },
    "subQuestions": [
      {
