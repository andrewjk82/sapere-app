...
export const buildRightTriangleTrigLesson = ({ audioBase = null } = {}) => {
  ...
  const steps = [
    ...
    },
    {
      ...
      speech: `Calculators only have sine, cosine and tangent buttons — no cosecant, secant or cotangent button. So instead of hunting for one, just use the reciprocal. Cosecant theta equals 1 over sine theta, secant theta equals 1 over cosine theta, and cotangent theta equals 1 over tangent theta.`,
      board: [
        triangle([[0, 0], [4, 0], [4, 3]], ['adj', 'opp', 'hyp'], ['θ', '90°', '']),
        { type: 'math', content: `$$\\operatorname{cosec}\\theta = \\dfrac{1}{\\sin\\theta} \\qquad \\sec\\theta = \\dfrac{1}{\\cos\\theta} \\qquad \\cot\\theta = \\dfrac{1}{\\tan\\theta}$$`, emphasis: true },
      ],
    },
    {
      ...
      board: [{ type: 'row', items: [{
        type: 'graph', showAxes: false, width: 280, height: 280,
