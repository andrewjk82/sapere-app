...
export const questions9A = [
  {
    ...
    "question": "Write the function $f(x) = 2x + 3$ (with a swapped number coefficient of $f(x) = 4x + 7$) in the form $f(x) = mx + b$, and hence write down $f'(x)$.",
    "options": [
      { "text": "$f(x) = 4x + 7, \\, f'(x) = 4$", "imageUrl": "" },
      { "text": "$f(x) = 7x + 4, \\, f'(x) = 7$", "imageUrl": "" },
      { "text": "$f(x) = 4x + 7, \\, f'(x) = 7$", "imageUrl": "" },
      { "text": "$f(x) = 4x + 7, \\, f'(x) = 4x$", "imageUrl": "" }
    ],
    "answer": "0",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "type": "multiple_choice",
    "question": "Write the function $f(x) = 5 - 3x$ (with a swapped number coefficient of $f(x) = 9 - 6x$) in the form $f(x) = mx + b$, and hence write down $f'(x)$.",
    "options": [
      { "text": "$f(x) = -6x + 9, \\, f'(x) = -6$", "imageUrl": "" },
      { "text": "$f(x) = -6x + 9, \\, f'(x) = 9$", "imageUrl": "" },
      { "text": "$f(x) = 6x - 9, \\, f'(x) = 6$", "imageUrl": "" },
      { "text": "$f(x) = -6x + 9, \\, f'(x) = -6x$", "imageUrl": "" }
    ],
    "answer": "0",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "type": "multiple_choice",
    "question": "Write the function $f(x) = \\frac{1}{2}x - 7$ (with a swapped number coefficient of $f(x) = \\frac{1}{5}x - 3$) in the form $f(x) = mx + b$, and hence write down $f'(x)$.",
    "options": [
      { "text": "$f(x) = \\frac{1}{5}x - 3, \\, f'(x) = \\frac{1}{5}$", "imageUrl": "" },
      { "text": "$f(x) = \\frac{1}{5}x - 3, \\, f'(x) = -3$", "imageUrl": "" },
      { "text": "$f(x) = 5x - 3, \\, f'(x) = 5$", "imageUrl": "" },
      { "text": "$f(x) = \\frac{1}{5}x - 3, \\, f'(x) = \\frac{1}{5}x$", "imageUrl": "" }
    ],
    "answer": "0",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "type": "multiple_choice",
    "question": "Write the function $f(x) = -4$ (with a swapped constant of $f(x) = -8$) in the form $f(x) = mx + b$, and hence write down $f'(x)$.",
    "options": [
      { "text": "$f(x) = -8, \\, f'(x) = 0$", "imageUrl": "" },
      { "text": "$f(x) = -8, \\, f'(x) = -8$", "imageUrl": "" },
      { "text": "$f(x) = 0x - 8, \\, f'(x) = -8$", "imageUrl": "" },
      { "text": "$f(x) = -8x, \\, f'(x) = -8$", "imageUrl": "" }
    ],
    "answer": "0",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "type": "multiple_choice",
    "question": "Write the general function $f(x) = ax + b$ (with swapped pronumerals of $f(x) = px + q$) in the form $f(x) = mx + b$, and hence write down $f'(x)$.",
    "options": [
      { "text": "$f(x) = px + q, \\, f'(x) = p$", "imageUrl": "" },
      { "text": "$f(x) = px + q, \\, f'(x) = q$", "imageUrl": "" },
      { "text": "$f(x) = qx + p, \\, f'(x) = q$", "imageUrl": "" },
      { "text": "$f(x) = px + q, \\, f'(x) = px$", "imageUrl": "" }
    ],
    "answer": "0",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "type": "multiple_choice",
    "question": "Write the function $f(x) = \\frac{2}{3}(x + 4)$ (with a swapped number coefficient of $f(x) = \\frac{3}{5}(x + 7)$) in the form $f(x) = mx + b$, and hence write down $f'(x)$.",
    "options": [
      { "text": "$f(x) = \\frac{3}{5}x + \\frac{21}{5}, \\, f'(x) = \\frac{3}{5}$", "imageUrl": "" },
      { "text": "$f(x) = \\frac{3}{5}x + 7, \\, f'(x) = \\frac{3}{5}$", "imageUrl": "" },
      { "text": "$f(x) = \\frac{3}{5}x + \\frac{21}{5}, \\, f'(x) = \\frac{21}{5}$", "imageUrl": "" },
      { "text": "$f(x) = 3x + 21, \\, f'(x) = 3$", "imageUrl": "" }
    ],
    "answer": "0",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "type": "multiple_choice",
    "question": "Write the function $f(x) = \\frac{3 - 5x}{4}$ (with a swapped number coefficient of $f(x) = \\frac{7 - 4x}{3}$) in the form $f(x) = mx + b$, and hence write down $f'(x)$.",
    "options": [
      { "text": "$f(x) = -\\frac{4}{3}x + \\frac{7}{3}, \\, f'(x) = -\\frac{4}{3}$", "imageUrl": "" },
      { "text": "$f(x) = \\frac{4}{3}x + \\frac{7}{3}, \\, f'(x) = \\frac{4}{3}$", "imageUrl": "" },
      { "text": "$f(x) = -\\frac{4}{3}x + \\frac{7}{3}, \\, f'(x) = \\frac{7}{3}$", "imageUrl": "" },
      { "text": "$f(x) = -\\frac{4}{3}x - \\frac{7}{3}, \\, f'(x) = -\\frac{4}{3}$", "imageUrl": "" }
    ],
    "answer": "0",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "type": "multiple_choice",
    "question": "Write the function $f(x) = \\frac{5}{2}(7 - \\frac{4}{3}x)$ (with a swapped number coefficient of $f(x) = \\frac{3}{4}(5 - \\frac{2}{3}x)$) in the form $f(x) = mx + b$, and hence write down $f'(x)$.",
    "options": [
      { "text": "$f(x) = -\\frac{1}{2}x + \\frac{15}{4}, \\, f'(x) = -\\frac{1}{2}$", "imageUrl": "" },
      { "text": "$f(x) = -\\frac{2}{3}x + 5, \\, f'(x) = -\\frac{2}{3}$", "imageUrl": "" },
      { "text": "$f(x) = -\\frac{1}{2}x + \\frac{15}{4}, \\, f'(x) = \\frac{15}{4}$", "imageUrl": "" },
      { "text": "$f(x) = \\frac{1}{2}x + \\frac{15}{4}, \\, f'(x) = \\frac{1}{2}$", "imageUrl": "" }
    ],
    "answer": "0",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "type": "multiple_choice",
    "question": "Write the constant function $f(x) = \\frac{1}{2} + \\frac{1}{3}$ (with a swapped number coefficient of $f(x) = \\frac{2}{5} + \\frac{3}{4}$) in the form $f(x) = mx + b$, and hence write down $f'(x)$.",
    "options": [
      { "text": "$f(x) = \\frac{23}{20}, \\, f'(x) = 0$", "imageUrl": "" },
      { "text": "$f(x) = \\frac{23}{20}, \\, f'(x) = \\frac{23}{20}$", "imageUrl": "" },
      { "text": "$f(x) = \\frac{23}{20}x, \\, f'(x) = \\frac{23}{20}$", "imageUrl": "" },
      { "text": "$f(x) = 0, \\, f'(x) = 0$", "imageUrl": "" }
    ],
    "answer": "0",
  ...
  },
  {
    ...
    "difficulty": "hard",
    "type": "multiple_choice",
    "question": "Simplify the compound function $f(x) = \\frac{3 + 5x}{2} - \\frac{5 - 2x}{2}$ (with a swapped number coefficient of $f(x) = \\frac{5 + 7x}{3} - \\frac{2 - 4x}{3}$) into the linear form $f(x) = mx + b$, and hence find the derived function $f'(x)$.",
    "options": [
      { "text": "$f(x) = \\frac{11}{3}x + 1, \\, f'(x) = \\frac{11}{3}$", "imageUrl": "" },
      { "text": "$f(x) = x + 1, \\, f'(x) = 1$", "imageUrl": "" },
      { "text": "$f(x) = \\frac{11}{3}x + 1, \\, f'(x) = 1$", "imageUrl": "" },
      { "text": "$f(x) = \\frac{11}{3}x - 1, \\, f'(x) = \\frac{11}{3}$", "imageUrl": "" }
    ],
    "answer": "0",
  ...
  },
  {
    ...
    "difficulty": "hard",
    "type": "multiple_choice",
    "question": "Simplify the quadratic difference function $f(x) = (x+3)^2 - (x-3)^2$ (with a swapped number coefficient of $f(x) = (x+4)^2 - (x-4)^2$) into the linear form $f(x) = mx + b$, and hence find the derived function $f'(x)$.",
    "options": [
      { "text": "$f(x) = 16x, \\, f'(x) = 16$", "imageUrl": "" },
      { "text": "$f(x) = 8x, \\, f'(x) = 8$", "imageUrl": "" },
      { "text": "$f(x) = 2x^2 + 32, \\, f'(x) = 4x$", "imageUrl": "" },
      { "text": "$f(x) = 16x, \\, f'(x) = 16x$", "imageUrl": "" }
    ],
    "answer": "0",
  ...
  },
  {
    ...
    "difficulty": "hard",
    "type": "multiple_choice",
    "question": "Simplify the algebraic variable expression $f(x) = \\frac{k - \\ell x}{r} + \\frac{k + \\ell x}{r}$ (with swapped pronumerals of $f(x) = \\frac{a - b x}{c} + \\frac{a + b x}{c}$) into standard form, and hence write down the derived function $f'(x)$.",
    "options": [
      { "text": "$f(x) = \\frac{2a}{c}, \\, f'(x) = 0$", "imageUrl": "" },
      { "text": "$f(x) = -\\frac{2bx}{c}, \\, f'(x) = -\\frac{2b}{c}$", "imageUrl": "" },
      { "text": "$f(x) = \\frac{2a}{c}, \\, f'(x) = \\frac{2a}{c}$", "imageUrl": "" },
      { "text": "$f(x) = \\frac{2a - 2bx}{c}, \\, f'(x) = -\\frac{2b}{c}$", "imageUrl": "" }
    ],
    "answer": "0",
  ...
  },
  {
    ...
    "difficulty": "hard",
    "type": "multiple_choice",
    "question": "Consider the quadratic function $f(x) = 4 - x^2$ (with a swapped constant of $f(x) = 9 - x^2$). Using graphical analysis and tangents at key points, determine the derived function $f'(x)$ and calculate the exact gradient of the tangent at $x = 2$.",
    "options": [
      { "text": "$f'(x) = -2x \\text{ and the gradient of the tangent at } x = 2 \\text{ is } -4$", "imageUrl": "" },
      { "text": "$f'(x) = 2x \\text{ and the gradient of the tangent at } x = 2 \\text{ is } 4$", "imageUrl": "" },
      { "text": "$f'(x) = -2x \\text{ and the gradient of the tangent at } x = 2 \\text{ is } -2$", "imageUrl": "" },
      { "text": "$f'(x) = -x \\text{ and the gradient of the tangent at } x = 2 \\text{ is } -2$", "imageUrl": "" }
    ],
    "answer": "0",
  ...
  },
  {
    ...
    "difficulty": "hard",
    "type": "multiple_choice",
    "question": "Consider the rational function $f(x) = \\frac{1}{x}$ (with a swapped numerator of $f(x) = \\frac{2}{x}$). Find the derived function $f'(x)$ and determine the exact gradient of the tangent line to the curve at $x = -1$.",
    "options": [
      { "text": "$f'(x) = -\\frac{2}{x^2} \\text{ and the gradient of the tangent at } x = -1 \\text{ is } -2$", "imageUrl": "" },
      { "text": "$f'(x) = \\frac{2}{x^2} \\text{ and the gradient of the tangent at } x = -1 \\text{ is } 2$", "imageUrl": "" },
      { "text": "$f'(x) = -\\frac{2}{x^2} \\text{ and the gradient of the tangent at } x = -1 \\text{ is } 2$", "imageUrl": "" },
      { "text": "$f'(x) = -\\frac{1}{x^2} \\text{ and the gradient of the tangent at } x = -1 \\text{ is } -1$", "imageUrl": "" }
    ],
    "answer": "0",
  ...
  },
  {
    ...
    "difficulty": "hard",
    "type": "multiple_choice",
    "question": "Consider the exponential function $f(x) = 2^x$ (with a swapped base of $f(x) = 3^x$). Using the natural logarithm, state the exact derived function $f'(x)$ and determine the exact gradient of the tangent line to the curve at $x = 1$.",
    "options": [
      { "text": "$f'(x) = 3^x \\ln(3) \\text{ and the gradient of the tangent at } x = 1 \\text{ is } 3\\ln(3)$", "imageUrl": "" },
      { "text": "$f'(x) = 3^x \\text{ and the gradient of the tangent at } x = 1 \\text{ is } 3$", "imageUrl": "" },
      { "text": "$f'(x) = 3^x \\ln(3) \\text{ and the gradient of the tangent at } x = 1 \\text{ is } \\ln(3)$", "imageUrl": "" },
      { "text": "$f'(x) = x \\cdot 3^{x-1} \\text{ and the gradient of the tangent at } x = 1 \\text{ is } 1$", "imageUrl": "" }
    ],
    "answer": "0",
...
export const importYear11AdvCh9 = async (forceReset = false) => {
  console.log(`Starting sync of Y11 Adv Ch9A (Total ${questions9A.length})...` + '\n' + `Chapter: Differentiation`);
  try {
    const qSnap = await getDocs(query(collection(db, 'questions'), 
      where('chapterId', '==', 'y11a-9'),
      where('topicCode', '==', '9A')
    ));
    ...
    await batch.commit();
    console.log(`Cleared ${qSnap.size} old questions under chapter y11a-9, topicCode 9A.`);

    let count = 0;
    for (const q of questions9A) {
