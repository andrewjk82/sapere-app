...
export const allQuestions = [
  ...
  {
    chapterId: 'y11a-14', chapterTitle: 'Chapter 14: Inequalities', topicId: 'y11a-14a', topicCode: '14A', topicTitle: 'Linear Inequalities',
...
export const importYear11Ch14A = async () => {
  const { collection, getDocs, query, where, addDoc } = await import('firebase/firestore');
  console.log('[Ch14A Import] Starting audit...');
  let importedCount = 0;
  ...
  console.log(`[Ch14A Import] Successfully added ${importedCount} NEW questions.`);
