export const BLACKTOWN_BOYS_2020_QUESTIONS = [
  {
    ...
    "solutionSteps": [
      ...
      {
        "explanation": "Both endpoints are included since \\(\\sqrt{0} = 0\\) is defined.",
        "workingOut": "\\text{Domain} = [-1, 1]"
      }
    ]
  },
  {
    ...
    "solutionSteps": [
      ...
      {
        "explanation": "Use \\(\\tan\\theta = m\\) to find the angle of inclination.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Recognise the change of base formula: \\(\\frac{\\log_b A}{\\log_b C} = \\log_C A\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Cake names are labels — there is no numerical quantity and no natural order between cake types.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Break-even occurs where income equals cost — the intersection point of the two lines.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Total orders = 25 + 9 + 8 + 5 + 3 = 50.",
        "workingOut": "\\text{Total} = 50"
      },
      {
        "explanation": "May's percentage.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Decreasing curve → negative gradient.",
        "workingOut": "f'(a) < 0"
      },
      {
        "explanation": "Concave down → second derivative is negative.",
        "workingOut": "f''(a) < 0"
      }
    ]
  },
  {
    ...
    "solutionSteps": [
      ...
      {
        "explanation": "Calculate the probability of selecting no red marbles (all blue).",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Apply the cosine rule: \\(\\cos A = \\frac{b^2 + c^2 - a^2}{2bc}\\), where \\(a = 7\\), \\(b = 8\\), \\(c = 10\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "At the \\(x\\)-intercept \\(x = 2.5\\): \\(2.5a + b = 0\\).",
        "workingOut": "2.5a = -b"
      },
      {
        "explanation": "At the \\(y\\)-intercept: \\(f(0) = |b| = 5\\), so \\(b = \\pm5\\).",
        "workingOut": "b = \\pm5"
      },
      {
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Differentiate the outer cube: bring down the power, reduce by 1.",
        "workingOut": "\\frac{d}{dx}[u^3] = 3u^2 \\frac{du}{dx}"
      },
      {
        "explanation": "Differentiate \\(\\tan(x/4)\\) using the chain rule.",
  ...
  },
  {
    ...
    "solutionSteps": [
      ...
      {
        "explanation": "Since \\(|r| = \\frac{2}{5} < 1\\), the limiting sum exists.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "The 4th term is \\(ar^3 = 750\\).",
        "workingOut": "48r^3 = 750 \\Rightarrow r^3 = \\frac{125}{8} \\Rightarrow r = \\frac{5}{2}"
      },
      {
        "explanation": "Find \\(m = ar = 48 \\times \\frac{5}{2}\\).",
        "workingOut": "m = 120"
      },
      {
        "explanation": "Find \\(n = ar^2 = 48 \\times \\frac{25}{4}\\).",
        "workingOut": "n = 300"
      }
    ]
  },
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Integrate \\(2x^3\\).",
        "workingOut": "\\frac{2x^4}{4} = \\frac{x^4}{2}"
      },
      {
        "explanation": "Integrate \\(\\frac{1}{3x+1}\\) using the log rule.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Integrate \\(\\sin 10x\\).",
        "workingOut": "-\\frac{1}{10}\\cos 10x"
      },
      {
        "explanation": "Rewrite \\(\\frac{2}{e^{5x}} = 2e^{-5x}\\) and integrate.",
        "workingOut": "\\int 2e^{-5x}\\,dx = \\frac{2}{-5}e^{-5x} = -\\frac{2}{5e^{5x}}"
      },
      {
        "explanation": "Subtract and add constant.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Read the PVA factor for \\(N = 8\\), \\(r = 6\\%\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      ...
      {
        "explanation": "Substitute the point \\((-1, 2)\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Rewrite and integrate using the reverse chain rule.",
      ...
      {
        "explanation": "Evaluate \\(9^{3/2} = (\\sqrt{9})^3 = 27\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      ...
      {
        "explanation": "From \\(\\cos x = +\\frac{\\sqrt{3}}{2}\\): reference angle \\(\\frac{\\pi}{6}\\), solutions in Q1 and Q4.",
  ...
  },
  {
    ...
    "solutionSteps": [
      ...
      },
      {
        ...
        "workingOut": "\\text{Var}(X) = E(X^2) - [E(X)]^2 = 473.24 - 21.72^2 \\approx 1.4816"
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Direction: as fertiliser increases, yield increases — positive.",
        "workingOut": "\\text{Direction: positive}"
      },
      {
        "explanation": "Strength: \\(R^2 = 0.9453\\) indicates \\(r \\approx 0.97\\), a strong relationship.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Substitute \\(x = 2.2\\) into \\(y = 1.4x + 2.6\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "The data only covers the range \\(1 \\leq x \\leq 3.5\\) g. Extrapolating assumes the linear trend continues, which may be invalid.",
  ...
  },
  {
    ...
    "solutionSteps": [
      ...
      {
        "explanation": "The proportion above \\(z = -1\\) equals \\(50\\% + 34\\% = 84\\%\\) (from the 68% rule).",
  ...
  },
  {
    ...
    "solutionSteps": [
      ...
      {
        "explanation": "\\(z = -3\\) corresponds to the bottom 0.15% (from 99.7% rule: \\(\\frac{1}{2}(100\\% - 99.7\\%) = 0.15\\%\\)).",
        "workingOut": "P(X < 13.6) = 0.15\\%"
      },
      {
        "explanation": "Set up equation: proportion × sample size = 6.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Apply the general term formula with \\(a = 24\\), \\(d = 5\\), \\(n = 8\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Differentiate \\(v = 2 - 4\\cos 2t\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Substitute \\(r = \\frac{16\\pi}{4+\\pi}\\) into the area formula.",
