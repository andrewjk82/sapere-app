  ...
  },
  {
    ...
    graphData: {
      jsxGraph: {
            ...
            script: "board.suspendUpdate();\nvar A = board.create('point', [0,0], {name: 'A', size: 0, label: {offset: [-10,-10]}});\nvar B = board.create('point', [5,0], {name: 'B', size: 0, label: {offset: [10,-10]}});\nvar C = board.create('point', [2,4], {name: 'C', size: 0, label: {offset: [0,10]}});\nvar t = board.create('polygon', [A,B,C], {fillColor: '#e0e7ff', borders: {strokeColor: '#4f46e5', strokeWidth: 2}});\nboard.unsuspendUpdate();"
      }
},
  ...
  },
  {
    ...
    graphData: {
      jsxGraph: {
            ...
            script: "board.suspendUpdate();\nvar A = board.create('point', [0,0], {name: 'A', size: 0, label: {offset: [-10,-10]}});\nvar D = board.create('point', [4,0], {name: 'D', size: 0, label: {offset: [10,-10]}});\nvar C = board.create('point', [4,5], {name: 'C', size: 0, label: {offset: [10,10]}});\nvar B = board.create('point', [1,3], {name: 'B', size: 0, label: {offset: [-10,10]}});\nvar p = board.create('polygon', [A,B,C,D], {fillColor: '#e0e7ff', borders: {strokeColor: '#4f46e5', strokeWidth: 2}});\nboard.unsuspendUpdate();"
      }
},
  ...
  },
  {
    ...
    graphData: {
      jsxGraph: {
            ...
            script: "board.suspendUpdate();\nvar A = board.create('point', [0, 4], {name: 'A', size: 0});\nvar B = board.create('point', [4, 1], {name: 'B', size: 0});\nvar C = board.create('point', [2.5, -3], {name: 'C', size: 0});\nvar D = board.create('point', [-2.5, -3], {name: 'D', size: 0});\nvar E = board.create('point', [-4, 1], {name: 'E', size: 0});\nvar p = board.create('polygon', [A,B,C,D,E], {fillColor: '#e0e7ff', borders: {strokeColor: '#4f46e5', strokeWidth: 2}});\nboard.create('segment', [A,C], {strokeColor: '#4f46e5', dash: 2});\nboard.create('segment', [A,D], {strokeColor: '#4f46e5', dash: 2});\nboard.unsuspendUpdate();"
      }
},
