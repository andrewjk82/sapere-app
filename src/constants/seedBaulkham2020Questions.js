export const BAULKHAM_2020_QUESTIONS = [
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Apply the Pythagorean identity \\(\\tan^2 x = \\sec^2 x - 1\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Factorise the numerator: \\(4x^2-9=(2x-3)(2x+3)\\).",
        "workingOut": "\\frac{4x^2-9}{2x-3} = 2x+3"
      },
      {
        "explanation": "Simplify the logarithm.",
  ...
  },
  {
    ...
    "solutionSteps": [
      ...
      {
        "explanation": "Differentiate \\(\\ln(3x+2)\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Rewrite: \\(\\frac{x}{e^{x^2}-8} = xe^{-x^2}\\cdot\\frac{e^8}{e^8-e^{x^2}}\\)... Try differentiating option (D).",
        "workingOut": "\\frac{d}{dx}\\left[-\\frac{1}{2}e^{8-x^2}\\right] = -\\frac{1}{2}\\cdot e^{8-x^2}\\cdot(-2x) = xe^{8-x^2}"
      },
      {
        "explanation": "Note \\(e^{8-x^2}=e^8\\cdot e^{-x^2}\\), and \\(c\\) can absorb the constant 8.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Numerator is \\(\\frac{1}{2}\\) of the derivative of denominator.",
        "workingOut": "\\frac{d}{dx}(x^2+3)=2x"
      },
      {
        "explanation": "Apply \\(\\int\\frac{f'}{f}\\,dx=\\ln|f|+C\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Decreasing curve means the gradient is negative.",
        "workingOut": "\\frac{dy}{dx} < 0"
      },
      {
        "explanation": "Concave up means the second derivative is positive.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Increasing means positive gradient.",
        "workingOut": "\\frac{dy}{dx} > 0"
      },
      {
        "explanation": "Concave down means negative second derivative.",
        "workingOut": "\\frac{d^2y}{dx^2} < 0"
      }
    ]
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Apply the \\(z\\)-score formula: \\(x = \\mu + z\\sigma\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Apply \\(x = \\mu + z\\sigma\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "The shaded region area from \\(x=2\\) to \\(x=4\\): \\(\\int_2^4 k(x-2)^3\\,dx = k\\cdot 4\\).",
        "workingOut": "k\\Big[\\frac{(x-2)^4}{4}\\Big]_2^4 = 4k"
      },
      {
        "explanation": "But solution shows total area from \\(x=1\\) to \\(x=4\\) = 34: \\(k(\\frac{1}{4}+4)=\\frac{17k}{4}=34\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Find \\(\\sigma = \\sqrt{\\text{Var}(T)} = \\sqrt{400} = 20\\).",
        "workingOut": "\\sigma = 20"
      },
      {
        "explanation": "Middle 95% spans \\(\\mu \\pm 2\\sigma\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Trapezoidal with \\(h=1\\), 2 values: \\(f(1)=\\frac{\\ln 1}{1}=0\\), \\(f(2)=\\frac{\\ln 2}{2}\\).",
        "workingOut": "T = \\frac{1}{2}(0+\\frac{\\ln 2}{2}) = \\frac{\\ln 2}{4} \\approx 0.1733"
      },
      {
        "explanation": "Exact value: \\(\\frac{(\\ln 2)^2}{2} \\approx 0.2402\\).",
        "workingOut": "I_{\\text{exact}} \\approx 0.2402"
      },
      {
        "explanation": "Trapezoidal is smaller. Percentage error \\(\\approx \\frac{0.2402-0.1733}{0.2402}\\approx 27.9\\% \\approx 28\\%\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Trap with \\(h=1\\): \\(\\frac{1}{2}[f(0)+2f(1)+f(2)]=\\frac{1}{2}[0+2+4]=3\\).",
        "workingOut": "T=3"
      },
      {
        "explanation": "Exact: \\(\\frac{x^3}{3}\\Big]_0^2=\\frac{8}{3}\\).",
        "workingOut": "I=\\frac{8}{3}"
      },
      {
        "explanation": "Percentage: \\(\\frac{3-8/3}{8/3}\\times 100=12.5\\%\\) larger.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Test odd/even: compute \\(f(-x)\\).",
        "workingOut": "f(-x) = \\frac{-x}{x^2-5} = -f(x) \\Rightarrow \\text{odd}"
      },
      {
        "explanation": "Apply horizontal line test: the graph has two branches that take the same \\(y\\)-values.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "\\(f(-x)=f(x)\\) → even.",
        "workingOut": "f(-x)=(-x)^2-3=x^2-3=f(x)"
      },
      {
        "explanation": "Fails horizontal line test → many-to-one.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Find the rate of change: differentiate \\(M\\).",
        "workingOut": "\\frac{dM}{dt} = 18t - 3t^2"
      },
      {
        "explanation": "Find when the rate is maximum: set \\(\\frac{d^2M}{dt^2}=0\\).",
        "workingOut": "18-6t=0 \\Rightarrow t=3"
      },
      {
        "explanation": "Verify maximum (second derivative of rate = \\(-6 < 0\\)).",
  ...
  },
  {
    ...
    "solutionSteps": [
      ...
      {
        "explanation": "Maximise: \\(12-6t=0 \\Rightarrow t=2\\).",
        "workingOut": "t=2"
      }
    ]
  },
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Apply chain rule with \\(u = \\sin x\\).",
        "workingOut": "\\frac{dy}{dx}=2\\sin x\\cdot\\cos x"
      },
      {
        "explanation": "Apply double angle identity \\(2\\sin x\\cos x=\\sin 2x\\).",
        "workingOut": "=\\sin 2x"
      }
    ]
  },
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Write equations from \\(T_3\\) and \\(T_{10}\\).",
        "workingOut": "a+2d=5\\quad\\cdots(1);\\quad a+9d=26\\quad\\cdots(2)"
      },
      {
        "explanation": "Subtract (1) from (2).",
      ...
      {
        "explanation": "Apply \\(S_{14}=\\frac{14}{2}(2a+13d)\\).",
        "workingOut": "S_{14}=7(2(-1)+39)=7(37)=259"
      }
    ]
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Find \\(d\\) and \\(a\\).",
        "workingOut": "6d=18\\Rightarrow d=3;\\quad a=4"
      },
      {
        "explanation": "\\(S_{12}=6(2(4)+11(3))=6(41)=246\\).",
        "workingOut": "246"
      }
    ]
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Antiderivative: \\(\\frac{(9x-4)^5}{9\\times 5}=\\frac{(9x-4)^5}{45}\\).",
        "workingOut": "5\\cdot\\frac{(9x-4)^5}{45}=\\frac{(9x-4)^5}{9}"
      },
      {
        "explanation": "Evaluate at \\(x=4\\): \\((36-4)^5=32^5\\).",
        "workingOut": "32^5 = 33\\,554\\,432"
      },
      {
        "explanation": "Evaluate at \\(x=1\\): \\((9-4)^5=5^5=3125\\).",
        "workingOut": "5^5=3125"
      },
      {
        "explanation": "Subtract.",
        "workingOut": "\\frac{1}{9}(32^5-5^5) = \\frac{33\\,551\\,307}{9} \\approx 3\\,727\\,923"
      }
    ]
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Antiderivative: \\(\\frac{3(2x+1)^4}{8}\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      ...
      {
        "explanation": "Since \\(e^x>0\\), reject \\(m=-5\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Let \\(m=e^x\\): \\(m^2-5m+6=0\\).",
        "workingOut": "(m-2)(m-3)=0"
      },
      {
        "explanation": "Both positive, so both valid.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Write \\(\\sec^2 x = (\\cos x)^{-2}\\).",
      ...
      {
        "explanation": "Simplify using \\(\\tan x=\\sin x/\\cos x\\) and \\(\\sec x=1/\\cos x\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "From part (i): \\(2\\tan x\\sec^2 x = \\frac{d}{dx}(\\sec^2 x)\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Use the given derivative as antiderivative directly.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Check \\(f(x)\\geq 0\\): \\(6x(1-x)\\geq 0\\) for \\(0\\leq x\\leq 1\\).",
        "workingOut": "f(x)=6x(1-x)\\geq 0\\checkmark"
      },
      {
        "explanation": "Integrate over the domain.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Differentiate and set \\(f'(x)=0\\).",
        "workingOut": "f'(x)=6-12x=0 \\Rightarrow x=\\frac{1}{2}"
      },
      {
        "explanation": "\\(f''(x)=-12<0\\) confirms maximum.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Differentiate: \\(f'(x)=24x-36x^2=12x(2-3x)=0\\).",
        "workingOut": "x=0 \\text{ or } x=\\frac{2}{3}"
      },
      {
        "explanation": "Mode = \\(\\frac{2}{3}\\) (interior maximum).",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "The line has gradient 2, so set \\(y'=4x+6=2\\).",
        "workingOut": "4x+6=2 \\Rightarrow x=-1"
      },
      {
        "explanation": "Find the \\(y\\)-value on the parabola at \\(x=-1\\).",
        "workingOut": "y=2(1)+6(-1)-5=-9"
      },
      {
        "explanation": "Substitute \\((-1,-9)\\) into \\(y=2x+b\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Set \\(y'=4\\): \\(2x+2=4 \\Rightarrow x=1\\).",
        "workingOut": "x=1"
      },
      {
        "explanation": "\\(y=1+2+3=6\\). Substitute.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "\\(P(\\text{correct})=\\frac{1}{4}\\), \\(P(\\text{wrong})=\\frac{3}{4}\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Use complement: \\(P(\\text{at least one}) = 1-P(\\text{none})\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "\\(P(\\text{none correct})=(\\frac{1}{2})^4=\\frac{1}{16}\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Apply the shift: replace \\(x\\) with \\(x-3\\), subtract 1.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Equation after shift.",
        "workingOut": "y=\\frac{1}{x-4}-1"
      },
      {
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "New equation: \\(y=\\frac{1}{x+2}+3\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Use \\(x^2-1\\) since \\(x=1\\leq 1\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Piece 1 (\\(x\\leq1\\)): \\(x^2=1 \\Rightarrow x=\\pm1\\).",
        "workingOut": "x=-1 \\text{ and } x=1 \\text{ both}\\leq 1\\checkmark"
      },
      {
        "explanation": "Piece 2 (\\(x>1\\)): \\(x^2=4 \\Rightarrow x=\\pm2\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Plot left piece \\(y=x^2-1\\), \\(x\\leq1\\): \\(x\\)-ints \\(\\pm1\\), \\(y\\)-int \\(-1\\), closed dot at \\((1,0)\\).",
        "workingOut": "(−1,0),\\ (0,−1),\\ (1,0)"
      },
      {
        "explanation": "Plot right piece \\(y=4-x^2\\), \\(x>1\\): open dot at \\((1,3)\\), \\(x\\)-int at \\((2,0)\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Piece 1: \\(x+2=2\\Rightarrow x=0\\), but \\(x<0\\) required → rejected.",
        "workingOut": "\\text{no solution from piece 1}"
      },
      {
        "explanation": "Piece 2: \\(x^2+1=2\\Rightarrow x=\\pm1\\); only \\(x=1\\geq0\\).",
        "workingOut": "x=1"
      }
    ]
  },
  {
    ...
    "solutionSteps": [
      ...
      {
        "explanation": "\\(g(x)=x-1\\): gradient 1, \\(y\\)-int \\(-1\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      ...
      {
        "explanation": "Sign analysis: negative between the roots.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "In right triangle with angle 30° at \\(P\\).",
        "workingOut": "\\tan 30°=\\frac{h}{OP}"
      },
      {
        "explanation": "Solve for \\(OP\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "\\(OB=h/\\tan45°=h\\).",
        "workingOut": "OB=h"
      },
      {
        "explanation": "\\(OP=h\\sqrt{3}\\), angle between \\(OB\\) and \\(OP\\) is 60°.",
      ...
      {
        "explanation": "Rewrite in terms of \\(\\tan30°\\).",
        "workingOut": "=h^2+\\frac{h^2}{\\tan^230°}-\\frac{h^2}{\\tan30°}\\checkmark"
      }
    ]
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "\\(10000=h^2(1+3-\\sqrt{3})=h^2(4-\\sqrt{3})\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Enter bivariate data into calculator.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "For \\(\\ln\\) to be defined, need \\(x^2+1>0\\).",
        "workingOut": "x^2+1\\geq 1>0 \\text{ for all } x"
      },
      {
        "explanation": "Domain is all real \\(x\\).",
        "workingOut": "x\\in\\mathbb{R}"
      }
    ]
  },
  {
    ...
    "solutionSteps": [
      ...
      {
        "explanation": "\\(f''(0)=2>0\\) → minimum turning point.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "\\(f'=e^{-x}(1-x)=0\\Rightarrow x=1\\).",
        "workingOut": "\\text{Max at }(1,e^{-1})"
      },
      {
        "explanation": "\\(f''=e^{-x}(x-2)=0\\Rightarrow x=2\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      ...
      {
        "explanation": "Group \\(1+\\tan^2 x\\) and apply identity.",
        "workingOut": "(1+\\tan^2 x)+2\\tan x=\\sec^2 x+2\\tan x"
      },
      {
        "explanation": "This equals RHS.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Use part (i) to rewrite integrand.",
        "workingOut": "\\int_{-\\pi/4}^{\\pi/4}(2\\tan x+\\sec^2 x)\\,dx"
      },
      {
        "explanation": "Integrate: antiderivative is \\(-2\\ln|\\cos x|+\\tan x\\).",
        "workingOut": "[-2\\ln|\\cos x|+\\tan x]_{-\\pi/4}^{\\pi/4}"
      },
      {
        "explanation": "Evaluate at \\(x=\\pi/4\\): \\(-2\\ln\\frac{1}{\\sqrt{2}}+1=\\ln 2+1\\).",
        "workingOut": "\\ln 2+1"
      },
      {
        "explanation": "Evaluate at \\(x=-\\pi/4\\): \\(-2\\ln\\frac{1}{\\sqrt{2}}-1=\\ln 2-1\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Antiderivative is \\(\\tan x\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Amplitude is the coefficient of sin.",
        "workingOut": "\\text{Amplitude}=2"
      },
      {
        "explanation": "Period \\(=2\\pi/2=\\pi\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "\\(y\\)-intercept: \\(y=2\\sin(-\\pi/3)=-\\sqrt{3}\\).",
        "workingOut": "(0,-\\sqrt{3})"
      },
      {
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Key intercepts: \\((0,-\\sqrt{3})\\), \\((\\pi/6,0)\\), \\((2\\pi/3,0)\\).",
        "workingOut": "\\text{from part (ii)}"
      },
      {
        "explanation": "Max at \\(x=5\\pi/12\\): \\(y=2\\).",
        "workingOut": "\\left(\\frac{5\\pi}{12},2\\right)"
      },
      {
        "explanation": "Min at \\(x=11\\pi/12\\): \\(y=-2\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "\\(P(X=0)=\\frac{3}{7}\\cdot\\frac{2}{6}=\\frac{1}{7}\\).",
        "workingOut": "P(0)=\\frac{1}{7}"
      },
      {
        "explanation": "\\(P(X=1)=2\\cdot\\frac{3}{7}\\cdot\\frac{4}{6}=\\frac{4}{7}\\).",
        "workingOut": "P(1)=\\frac{4}{7}"
      },
      {
        "explanation": "\\(P(X=2)=\\frac{4}{7}\\cdot\\frac{3}{6}=\\frac{2}{7}\\).",
        "workingOut": "P(2)=\\frac{2}{7}"
      },
      {
        "explanation": "\\(E(X)=0+\\frac{4}{7}+\\frac{4}{7}=\\frac{8}{7}\\).",
        "workingOut": "E(X)=\\frac{8}{7}"
      }
    ]
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "\\(E(X^2)=0+\\frac{4}{7}+\\frac{8}{7}=\\frac{12}{7}\\).",
        "workingOut": "E(X^2)=\\frac{12}{7}"
      },
      {
        "explanation": "\\(\\text{Var}(X)=\\frac{12}{7}-\\left(\\frac{8}{7}\\right)^2=\\frac{12}{7}-\\frac{64}{49}=\\frac{20}{49}\\).",
        "workingOut": "\\text{Var}(X)=\\frac{20}{49}"
      },
      {
        "explanation": "\\(\\sigma=\\sqrt{20/49}\\approx0.638\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Probabilities: \\(P(0)=\\frac{1}{10}\\), \\(P(1)=\\frac{3}{5}\\), \\(P(2)=\\frac{3}{10}\\).",
        "workingOut": "\\text{(by combinations without replacement)}"
      },
      {
        "explanation": "\\(E(X)=\\frac{6}{5}\\), \\(E(X^2)=\\frac{9}{5}\\).",
        "workingOut": "E(X)=\\frac{6}{5}"
      },
      {
        "explanation": "\\(\\text{Var}(X)=\\frac{9}{5}-\\frac{36}{25}=\\frac{9}{25}\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      ...
      {
        "explanation": "No real solution since \\(e^{-t}>0\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "At \\(t=0\\): \\(v=10\\).",
        "workingOut": "(0,10)"
      },
      {
        "explanation": "Asymptote: as \\(t\\to\\infty\\), \\(e^{-t}\\to0\\), so \\(v\\to5\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Since \\(v>0\\) always, distance equals the integral.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Sketch \\(\\ln(2x-1)\\): asymptote \\(x=\\frac{1}{2}\\), \\(x\\)-int \\((1,0)\\).",
        "workingOut": "x=\\tfrac{1}{2} \\text{ (asymptote)}"
      },
      {
        "explanation": "Line \\(y=mx\\) through origin; mark \\(P\\) as tangent point.",
        "workingOut": "P=(x_P,y_P)\\text{ on both}"
      }
    ]
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Set gradient equal to \\(m\\).",
        "workingOut": "\\frac{2}{2x-1}=m\\Rightarrow x=\\frac{2+m}{2m}"
      },
      {
        "explanation": "Find \\(y=mx\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Sub \\(P\\) into \\(y=\\ln(2x-1)\\).",
        "workingOut": "\\frac{2+m}{2}=\\ln\\left(\\frac{2+m}{m}-1\\right)=\\ln\\frac{2}{m}"
      },
      {
        "explanation": "Double both sides.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Integrate \\(f(t)\\) from 0 to \\(x\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Set \\(F(m)=\\frac{1}{2}\\).",
        "workingOut": "1-e^{-2m}=\\frac{1}{2}\\Rightarrow e^{-2m}=\\frac{1}{2}"
      },
      {
        "explanation": "Take \\(\\ln\\) and solve.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "\\(e^{-3m}=\\frac{1}{2}\\Rightarrow m=\\frac{\\ln2}{3}\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "After 1st repayment.",
        "workingOut": "A_1=450000(1.005)-M"
      },
      {
        "explanation": "Apply interest then subtract repayment.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Write out the general pattern.",
        "workingOut": "A_n=450000(1.005)^n-M\\sum_{k=0}^{n-1}(1.005)^k"
      },
      {
        "explanation": "Sum the geometric series \\(a=1\\), \\(r=1.005\\), \\(n\\) terms.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Set \\(A_{300}=0\\) and solve.",
        "workingOut": "M=\\frac{450000\\times(1.005)^{300}\\times0.005}{(1.005)^{300}-1}"
      },
      {
        "explanation": "Evaluate with \\(n=300\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Apply loan repayment formula with \\(P=300000\\), \\(r=0.005\\), \\(n=240\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Differentiate \\(A=\\sin\\theta(1+\\cos\\theta)\\).",
        "workingOut": "A'=\\cos\\theta+\\cos^2\\theta-\\sin^2\\theta"
      },
      {
        "explanation": "Set \\(A'=0\\): use \\(\\cos^2\\theta-\\sin^2\\theta=\\cos2\\theta\\).",
        "workingOut": "\\cos\\theta+\\cos2\\theta=0\\Rightarrow(2\\cos\\theta-1)(\\cos\\theta+1)=0"
      },
      {
        "explanation": "Valid solution: \\(\\cos\\theta=\\frac{1}{2}\\Rightarrow\\theta=\\frac{\\pi}{3}\\).",
        "workingOut": "\\theta=\\frac{\\pi}{3}"
      },
      {
        "explanation": "Verify maximum. When \\(\\theta=\\pi/3\\): all angles 60° → equilateral.",
        "workingOut": "\\triangle ABC \\text{ equilateral at maximum}\\checkmark"
      }
    ]
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Area between two curves: top \\(-\\) bottom.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Simplify the integrand using part (ii): \\(x^2e^{kx}+\\frac{2xe^{kx}}{k}=\\frac{1}{k}\\cdot xe^{kx}(kx+2)=\\frac{f'(x)}{k}\\).",
        "workingOut": "A=\\frac{1}{k}\\int_0^2 f'(x)\\,dx=\\frac{1}{k}[x^2e^{kx}]_0^2"
      },
      {
        "explanation": "Evaluate.",
        "workingOut": "=\\frac{4e^{2k}}{k}"
      },
      {
        "explanation": "Set equal to \\(16/k\\).",
        "workingOut": "4e^{2k}=16\\Rightarrow e^{2k}=4\\Rightarrow k=\\ln2"
      }
    ]
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Substitute \\(k=1\\).",
        "workingOut": "\\frac{e-1}{1}-\\frac{1}{1}=e-2"
      }
    ]
  }
];
