export const BAULKHAM_2020_QUESTIONS = [
...

  {
    ...
    s: '$\\log_e(3x+2)$. $\\dfrac{d}{dx} = \\dfrac{3}{3x+2} \\cdot 2 = \\dfrac{6}{3x+2}$... Actually $\\frac{d}{dx}\\ln(3x+2)=\\frac{3}{3x+2}$. Hmm. Let me recalculate. $\\frac{d}{dx}\\ln(3x+2) = \\frac{3}{3x+2}$. So the answer should be $\\frac{3}{3x+2}$. Let me fix the variant.',
    a: '$\\dfrac{3}{3x+2}$',
    opts: [
      '$\\dfrac{9}{3x-2}$',
      '$\\dfrac{3}{3x+2}$',
...

  {
    ...
    a: '$\\dfrac{dy}{dx} < 0$ and $\\dfrac{d^2y}{dx^2} > 0$',
    opts: [
...

  {
    ...
    a: 'larger by 50%',
    opts: ['exactly correct', 'smaller by 25%', 'larger by 50%', 'larger by 25%'],
...

  {
    ...
    a: '$x = -0$ (i.e. $x=0$) wait: $g(0)=0^2+1=1\\neq 2$. And $x+2=2\\Rightarrow x=0$ but $x<0$ is required. So no solution from either. Let me adjust. $g(x)=2$: Piece 1: $x+2=2\\Rightarrow x=0$, but $x<0$ required, rejected. Piece 2: $x^2+1=2\\Rightarrow x^2=1\\Rightarrow x=\\pm1$, but $x\\geq0$ required, so $x=1$ only.',
    a: '$x = 1$',
    opts: [],
...

  {
    ...
    s: '$x-2<3x-x^2 \\Rightarrow x^2-2x-2<0$... wait: $x-2-3x+x^2<0 \\Rightarrow x^2-2x-2+0 = x^2-2x-2<0$. Hmm, $x^2-2x-2=0\\Rightarrow x=1\\pm\\sqrt{3}$. Not clean. Let me use: $x-2<3x-x^2\\Rightarrow x^2-2x-2<0$, roots $x=1\\pm\\sqrt{3}$. So $(1-\\sqrt{3},1+\\sqrt{3})$. Not clean. Adjust: solve $2x-1<x^2+x-2$, i.e. $0<x^2-x-1$... still not clean. Use: $x^2-4x+3<0\\Rightarrow (x-1)(x-3)<0\\Rightarrow 1<x<3$. So the question should be: solve $x-1<x^2-3x+1$, i.e. $0<x^2-4x+2$... still not clean. Let me use a clean one: $2x-3<x^2-2x+1\\Rightarrow x^2-4x+4>0$... always true. Hmm. Try: $3x-2>x^2+x\\Rightarrow x^2-2x+2<0$ — no real roots. OK let me just use: Solve $x+1>2x^2-x\\Rightarrow 2x^2-2x-1<0$, roots $x=\\frac{2\\pm\\sqrt{4+8}}{4}=\\frac{2\\pm2\\sqrt{3}}{4}$. Not clean. Simplest clean variant: solve $x-1<x(2-x)$, i.e. $x-1<2x-x^2\\Rightarrow x^2-x-1<0$, roots $(1\\pm\\sqrt{5})/2$. Still not clean. OK just use the original format with different numbers that work: $3x-2<4x-x^2\\Rightarrow x^2-x-2<0\\Rightarrow (x-2)(x+1)<0\\Rightarrow -1<x<2$. ✓',
