    ...
    graphData: {
      jsxGraph: {
        ...
        elements: [
          ...
          { type: 'segment', from: 'E', to: 'F', color: 'blue', dash: 2 },
          { type: 'text', coords: [-0.4, 4.4], content: 'A' },
          { type: 'text', coords: [4.2, 5.2], content: 'B' },
          { type: 'text', coords: [12.2, 4.7], content: 'C' },
          { type: 'text', coords: [8.2, 3.7], content: 'D' },
          { type: 'text', coords: [-0.4, 2.5], content: 'E' },
          { type: 'text', coords: [3.4, 3.7], content: 'F' },
          { type: 'text', coords: [12.2, 1.5], content: 'G' },
          { type: 'text', coords: [8.2, 0.5], content: 'H' },
          { type: 'text', coords: [7.5, 5], content: '25 m' },
          { type: 'text', coords: [1.5, 5.0], content: '12 m' },
          { type: 'text', coords: [-1.4, 3.5], content: '1 m' },
          { type: 'text', coords: [7.1, 2.2], content: '2.5 m' }
        ]
      }
    },
    solutionSteps: [
