export const CRANBROOK_2023_SIMILAR_QUESTIONS = [
...

  {
    ...
    a: 'Athlete P is shorter and weighs more than Athlete Q.',
    opts: [
...

  {
    ...
    a: 'Domain: $(2, \\infty)$, Range $(0, \\infty)$',
    opts: [
