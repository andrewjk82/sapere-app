export const Y11A_CH2C_QUESTIONS = [
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "text": "\\\\(\\\\frac{6\\\\sqrt{5}}{13}\\\\)",
        "imageUrl": ""
      },
      {
        "text": "\\\\(\\\\frac{6\\\\sqrt{7}}{13}\\\\)",
        "imageUrl": ""
      }
    ],
    "hint": "Simplify the expression step-by-step.",
