export const DANEBANK_2020_SIMILAR_QUESTIONS = [
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Isolate the \\(y\\) term to begin rearranging into gradient–intercept form.",
        "workingOut": "\\frac{y}{3} = 1 - \\frac{x}{4}"
      },
      {
        "explanation": "Multiply every term by \\(3\\) to make \\(y\\) the subject.",
        "workingOut": "y = 3 - \\frac{3}{4}x"
      },
      {
        "explanation": "Read off the gradient as the coefficient of \\(x\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Rewrite using a negative index.",
        "workingOut": "y = \\frac{1}{x^3} = x^{-3}"
      },
      {
        "explanation": "Apply the power rule: bring down \\(-3\\), reduce the index by \\(1\\).",
        "workingOut": "\\frac{dy}{dx} = -3x^{-4}"
      },
      {
        "explanation": "Rewrite with a positive index.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Identify the centre from the standard form.",
        "workingOut": "\\text{Centre } (2, 5)"
      },
      {
        "explanation": "For the circle to touch the \\(x\\)-axis, the radius equals the \\(y\\)-coordinate of the centre.",
        "workingOut": "r = 5"
      },
      {
        "explanation": "Since \\(c = r^2\\), substitute \\(r = 5\\).",
        "workingOut": "c = 25"
      }
    ]
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "The square root \\(\\sqrt{x}\\) requires a non-negative argument.",
        "workingOut": "x \\geq 0"
      },
      {
        "explanation": "The term \\(\\frac{1}{\\sqrt{3-x}}\\) needs \\(3 - x > 0\\) (strict, since it is a denominator).",
        "workingOut": "3 - x > 0 \\Rightarrow x < 3"
      },
      {
        "explanation": "Combine both restrictions.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Write the \\(5^{\\text{th}}\\) term using \\(T_n = a + (n-1)d\\).",
        "workingOut": "a + 4d = 23"
      },
      {
        "explanation": "Write the \\(9^{\\text{th}}\\) term.",
        "workingOut": "a + 8d = 43"
      },
      {
        "explanation": "Subtract to eliminate \\(a\\) and solve for \\(d\\).",
        "workingOut": "4d = 20 \\Rightarrow d = 5"
      },
      {
        "explanation": "Back-substitute to find \\(a\\).",
        "workingOut": "a = 23 - 20 = 3"
      }
    ]
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "On \\(B < x < C\\) the curve continues to decrease towards the minimum at \\(C\\).",
        "workingOut": "f'(x) < 0 \\quad (\\text{decreasing})"
      },
      {
        "explanation": "Concavity changes at the inflection \\(B\\); just to the right of \\(B\\) the curve is concave up.",
        "workingOut": "f''(x) > 0 \\quad (\\text{concave up})"
      },
      {
        "explanation": "Combine the two conditions.",
  ...
  },
  {
    ...
    "solutionSteps": [
      ...
      {
        "explanation": "Compare periods: factor of \\(2\\).",
        "workingOut": "\\frac{2\\pi/3}{\\pi/3} = 2 \\Rightarrow \\text{doubled}"
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Find the primitive, dividing by the inner derivative \\(-1\\) and \\(\\ln 3\\).",
        "workingOut": "\\int 3^{-x}\\,dx = \\frac{3^{-x}}{-\\ln 3}"
      },
      {
        "explanation": "Substitute the limits \\(x = 2\\) and \\(x = 1\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      ...
      {
        "explanation": "Apply to the second strip (heights \\(9\\) and \\(12\\)).",
        "workingOut": "A_2 = \\frac{5}{2}(9 + 12) = 52.5"
      },
      {
        "explanation": "Add the two strip areas.",
        "workingOut": "A \\approx 42.5 + 52.5 = 95 \\text{ m}^2"
      }
    ]
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Dividing the left sides cancels \\(r\\theta\\), leaving \\(\\frac{1}{2}r\\).",
        "workingOut": "\\frac{\\frac{1}{2}r^2\\theta}{r\\theta} = \\frac{1}{2}r"
      },
      {
        "explanation": "Check the right sides divide to \\((3)\\)’s value.",
        "workingOut": "\\frac{49\\pi/8}{7\\pi/4} = \\frac{7}{2}"
      },
      {
        "explanation": "State the operation.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Confirm the radius from equation \\((3)\\).",
        "workingOut": "r = 7 \\text{ units}"
      },
      {
        "explanation": "Substitute into the arc-length equation.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "By alternate angles between the parallel north lines, the angle between \\(BA\\) and north at \\(B\\) is \\(180° - 125°\\).",
        "workingOut": "\\angle ABN_1 = 180° - 125° = 55° \\quad [\\text{alternate angles}]"
      },
      {
        "explanation": "The bearing of \\(C\\) from \\(B\\) gives the angle from north to \\(BC\\).",
        "workingOut": "\\angle N_1BC = 35°"
      },
      {
        "explanation": "Add the two angles at \\(B\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "State the area formula with two sides and the included angle.",
        "workingOut": "A = \\frac{1}{2}ac\\sin B"
      },
      {
        "explanation": "Substitute \\(a = c = 6\\) and \\(B = 90°\\).",
        "workingOut": "A = \\frac{1}{2}(6)(6)\\sin 90°"
      },
      {
        "explanation": "Evaluate (\\(\\sin 90° = 1\\)).",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Set up the area as upper minus lower curve between the intersections.",
        "workingOut": "A = \\int_1^2 \\left[\\left(2 - \\tfrac{2}{x}\\right) - (x - 1)\\right] dx"
      },
      {
        "explanation": "Simplify the integrand.",
      ...
      {
        "explanation": "Substitute the limits (\\(\\ln 1 = 0\\)).",
        "workingOut": "= (6 - 2\\ln 2 - 2) - \\left(3 - \\tfrac{1}{2}\\right)"
      },
      {
        "explanation": "Combine constants.",
        "workingOut": "A = \\frac{3}{2} - 2\\ln 2 \\text{ units}^2"
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "solutionSteps": [
      ...
      },
      {
        ...
        "workingOut": "m_{BC} = \\frac{4 - 0}{-3 - 7} = -\\frac{2}{5}"
      },
      {
        "explanation": "Equal gradients imply parallel lines.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Count the total who were lying.",
        "workingOut": "\\text{lying} = 120 + 30 = 150"
      },
      {
        "explanation": "Count those lying who tested positive.",
        "workingOut": "\\text{lying and positive} = 120"
      },
      {
        "explanation": "Form and simplify the conditional probability.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Identify the two inaccurate outcomes.",
        "workingOut": "(\\text{lying} \\cap \\text{negative}) \\cup (\\text{not lying} \\cap \\text{positive})"
      },
      {
        "explanation": "Add the two counts.",
        "workingOut": "30 + 10 = 40"
      },
      {
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Differentiate \\(y = x^{1/2}\\).",
        "workingOut": "\\frac{dy}{dx} = \\frac{1}{2\\sqrt{x}}"
      },
      {
        "explanation": "Evaluate the tangent gradient at \\(x = 9\\).",
      ...
      {
        "explanation": "Find the point of contact.",
        "workingOut": "y = \\sqrt{9} = 3 \\Rightarrow (9, 3)"
      },
      {
        "explanation": "Use point–gradient form and rearrange to general form.",
        "workingOut": "y - 3 = -6(x - 9) \\Rightarrow 6x + y - 57 = 0"
      }
    ]
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Apply the change-of-base rule with base \\(3\\).",
        "workingOut": "\\log_x 3 = \\frac{\\log_3 3}{\\log_3 x}"
      },
      {
        "explanation": "Simplify using \\(\\log_3 3 = 1\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Substitute the result from (a).",
        "workingOut": "\\log_3 x = 9 \\times \\frac{1}{\\log_3 x}"
      },
      {
        "explanation": "Multiply through by \\(\\log_3 x\\).",
      ...
      },
      {
        ...
        "workingOut": "x = 27 \\text{ or } \\frac{1}{27}"
      }
    ]
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Integrate term by term, adding a constant.",
        "workingOut": "f(x) = 2x^3 - 2x^2 + 3x + C"
      },
      {
        "explanation": "Substitute \\(f(1) = 8\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      ...
      },
      {
        ...
        "workingOut": "f''(x) = 48x - 36x^2"
      },
      {
        "explanation": "At \\(x = 0\\), \\(f''(0) = 0\\) and a sign table shows \\(f' > 0\\) on both sides — a horizontal point of inflection.",
        "workingOut": "(0, 0): \\text{ horizontal POI}"
      },
      {
        "explanation": "At \\(x = 2\\), \\(f''(2) = 96 - 144 = -48 < 0\\) — a maximum.",
        "workingOut": "(2, 16): \\text{ maximum}"
      }
    ]
  },
  {
    ...
    "solutionSteps": [
      ...
      {
        "explanation": "Sketch the curve through the key points.",
        "workingOut": "",
        "graphData": {
          "jsxGraph": {
            "width": 400,
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "All probabilities sum to \\(1\\).",
        "workingOut": "0.25 + 0.4 + a + b = 1 \\Rightarrow a + b = 0.35"
      },
      {
        "explanation": "Apply \\(E(X) = \\sum x P(x) = 2.2\\), with \\(1(0.25) + 2(0.4) = 1.05\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Scale the first equation to match the \\(a\\)-terms.",
        "workingOut": "3a + 3b = 1.05"
      },
      {
        "explanation": "Subtract to eliminate \\(a\\).",
        "workingOut": "(3a + 4b) - (3a + 3b) = 1.15 - 1.05 \\Rightarrow b = 0.10"
      },
      {
        "explanation": "Back-substitute for \\(a\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      ...
      {
        "explanation": "Simplify.",
        "workingOut": "\\frac{dy}{dx} = \\cos 3x - 3x\\sin 3x"
      }
    ]
  },
  {
    ...
    "solutionSteps": [
      ...
      {
        "explanation": "Simplify using \\(e^{\\ln A} = A\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Read the correlation coefficient from the calculator output.",
        "workingOut": "r \\approx 0.9"
      },
      {
        "explanation": "Interpret a value near \\(+1\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Substitute the English mark \\(x = 83\\) into the regression line.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Integrate \\(\\cos 2x\\).",
        "workingOut": "\\int \\cos 2x\\,dx = \\frac{1}{2}\\sin 2x"
      },
      {
        "explanation": "Integrate \\(-\\sin 3x\\) (gives \\(+\\frac{1}{3}\\cos 3x\\)).",
        "workingOut": "\\int -\\sin 3x\\,dx = \\frac{1}{3}\\cos 3x"
      },
      {
        "explanation": "Combine with the constant of integration.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Write the total surface area of the closed box.",
      ...
      {
        "explanation": "Use the fixed volume to express \\(h\\).",
        "workingOut": "V = 3x^2 h = 36 \\Rightarrow h = \\frac{12}{x^2}"
      },
      {
        "explanation": "Substitute \\(h\\).",
        "workingOut": "A = 6x^2 + 8x \\cdot \\frac{12}{x^2}"
      },
      {
        "explanation": "Simplify the second term.",
        "workingOut": "A = 6x^2 + \\frac{96}{x}"
      }
    ]
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Differentiate \\(A = 6x^2 + 96x^{-1}\\).",
      ...
      {
        "explanation": "Confirm a minimum with the second derivative.",
        "workingOut": "A'' = 12 + \\frac{192}{x^3}; \\quad A''(2) = 36 > 0"
      },
      {
        "explanation": "Evaluate \\(A\\) at \\(x = 2\\).",
        "workingOut": "A = 6(4) + \\frac{96}{2} = 24 + 48 = 72 \\text{ m}^2"
      }
    ]
  },
  {
    ...
    "solutionSteps": [
      ...
      {
        "explanation": "Use the point \\((0, -8)\\) with \\(f(-2) = (-2)^2 = 4\\).",
        "workingOut": "-8 = k(4) - 4"
      },
      {
        "explanation": "Solve for \\(k\\).",
        "workingOut": "4k = -4 \\Rightarrow k = -1"
      },
      {
        "explanation": "State the final function.",
  ...
  },
  {
    ...
    "solutionSteps": [
      ...
      {
        "explanation": "Expand the domain for \\(3\\theta\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Each solution is an intersection of the two graphs.",
        "workingOut": "\\cos\\pi x = 1 - |x| \\iff \\text{graphs intersect}"
      },
      {
        "explanation": "Restrict the search: \\(1 - |x| < -1\\) for \\(|x| > 2\\).",
        "workingOut": "|x| > 2 \\Rightarrow \\text{no intersections}"
      },
      {
        "explanation": "Count the intersections from the sketch.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Differentiability requires a smooth curve with no corners.",
        "workingOut": "\\text{differentiable} \\Rightarrow \\text{smooth}"
      },
      {
        "explanation": "Locate the corners at \\(B\\) and \\(C\\) (the join at \\(D\\) is smooth).",
        "workingOut": "\\text{corners at } B(2,0), \\; C(3,-2)"
      },
      {
        "explanation": "State the non-differentiable \\(x\\)-values.",
  ...
  },
  {
    ...
    "solutionSteps": [
      ...
      {
        "explanation": "Multiply by the contribution.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Apply the compound interest formula.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Differentiate \\(y = 2\\tan^2 x\\) and expand using \\(\\sec^2 x = 1 + \\tan^2 x\\).",
      ...
      {
        "explanation": "Replace each \\(\\sec^2 x\\) with \\(1 + \\tan^2 x\\) and expand.",
        "workingOut": "= 4 + 4\\tan^2 x + 12\\tan^2 x + 12\\tan^4 x = 12\\tan^4 x + 16\\tan^2 x + 4"
      },
      {
        "explanation": "Use \\(\\tan^2 x = \\frac{y}{2}\\), so \\(\\tan^4 x = \\frac{y^2}{4}\\), and substitute.",
        "workingOut": "y'' = 12\\cdot\\tfrac{y^2}{4} + 16\\cdot\\tfrac{y}{2} + 4 = 3y^2 + 8y + 4"
      },
      {
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Sum the geometric series (ratio \\(1.005\\), \\(n\\) terms).",
        "workingOut": "1 + 1.005 + \\cdots + (1.005)^{n-1} = \\frac{(1.005)^n - 1}{0.005}"
      },
      {
        "explanation": "Substitute into \\(A_n\\) and set equal to half the initial value.",
        "workingOut": "400\\,000 = 800\\,000(1.005)^n - 1\\,000\\,000((1.005)^n - 1)"
      },
      {
        "explanation": "Collect the exponential terms.",
        "workingOut": "400\\,000 = 1\\,000\\,000 - 200\\,000(1.005)^n"
      },
      {
        "explanation": "Rearrange.",
        "workingOut": "200\\,000(1.005)^n = 600\\,000 \\Rightarrow (1.005)^n = 3"
      },
      {
        "explanation": "Solve with logarithms.",
        "workingOut": "n = \\frac{\\ln 3}{\\ln 1.005} \\approx 220.3"
      },
      {
        "explanation": "Round up and convert.",
        "workingOut": "n \\approx 220 \\text{ months} \\approx 18 \\text{ years } 4 \\text{ months}"
      }
    ]
  },
  {
    ...
    "solutionSteps": [
      ...
      },
      {
        ...
        "workingOut": "C_1 = 0 \\Rightarrow x = t^3 - 9t^2"
      }
    ]
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Set velocity to zero and factorise.",
        "workingOut": "3t^2 - 18t = 0 \\Rightarrow 3t(t - 6) = 0"
      },
      {
        "explanation": "Solve; the next rest after \\(t = 0\\) is \\(t = 6\\).",
        "workingOut": "t = 0 \\text{ or } t = 6 \\Rightarrow t = 6 \\text{ s}"
      },
      {
        "explanation": "Substitute \\(t = 6\\) into the displacement.",
        "workingOut": "x = 6^3 - 9(6)^2 = 216 - 324 = -108"
      },
      {
        "explanation": "Interpret the sign.",
        "workingOut": "x = -108 \\text{ m (108 m left of } O)"
      }
    ]
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Set up the area integral from \\(0\\) to \\(k\\).",
        "workingOut": "A = \\int_0^k \\frac{e^x - e^{-x}}{e^x + e^{-x}}\\,dx"
      },
      {
        "explanation": "The numerator is the derivative of the denominator, giving a \\(\\ln\\) primitive.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Set the area expression equal to \\(2\\).",
        "workingOut": "\\ln\\!\\left(\\frac{e^k + e^{-k}}{2}\\right) = 2"
      },
      {
        "explanation": "Exponentiate and multiply out.",
        "workingOut": "e^k + e^{-k} = 2e^2"
      },
      {
        "explanation": "Multiply by \\(e^k\\) to form a quadratic in \\(e^k\\).",
        "workingOut": "(e^k)^2 - 2e^2 e^k + 1 = 0"
      },
      {
        "explanation": "Let \\(u = e^k\\) and apply the quadratic formula.",
        "workingOut": "u = \\frac{2e^2 \\pm \\sqrt{4e^4 - 4}}{2} = e^2 \\pm \\sqrt{e^4 - 1}"
      },
      {
        "explanation": "Reject the root \\(< 1\\) (gives \\(k < 0\\)); keep the larger root.",
        "workingOut": "u = e^2 + \\sqrt{e^4 - 1}"
      },
      {
