    ...
    graphData: {
      jsxGraph: {
        ...
        elements: [
          ...
          { type: 'point', id: 'D', coords: [4,4], visible: false },
          { type: 'point', id: 'O1', coords: [0,0], visible: false },
          ...
          { type: 'arc', center: 'O2', from: 'C', to: 'D', color: 'blue' },
          { type: 'arc', center: 'O2', from: 'D', to: 'C', color: 'blue', dash: 2 },
          { type: 'point', id: 'A3', coords: [-2,4], visible: false },
          { type: 'point', id: 'B3', coords: [2,4], visible: false },
          { type: 'point', id: 'C3', coords: [-2,8], visible: false },
          { type: 'point', id: 'D3', coords: [2,8], visible: false },
          { type: 'point', id: 'O3', coords: [0,8], visible: false },
          { type: 'segment', from: 'C3', to: 'A3', color: 'blue' },
          { type: 'segment', from: 'D3', to: 'B3', color: 'blue' },
          { type: 'arc', center: 'O3', from: 'C3', to: 'D3', color: 'blue' },
          { type: 'arc', center: 'O3', from: 'D3', to: 'C3', color: 'blue', dash: 2 },
          { type: 'segment', from: 'O3', to: 'D3', color: 'red', dash: 2 },
          { type: 'segment', from: 'O2', to: 'D', color: 'red', dash: 2 },
          { type: 'text', coords: [1,8.4], content: '3 cm' },
          { type: 'text', coords: [2.5,4.4], content: '6 cm' },
          { type: 'text', coords: [-2.8,6], content: '4 cm' },
          { type: 'text', coords: [-4.8,2], content: '5 cm' }
        ]
      }
    },
    solutionSteps: [
