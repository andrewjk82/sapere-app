export const Y9_CH11F_QUESTIONS = [
  ...
  },
  {
    ...
    "a": "2",
    "solution": "By comparing \\(y = 2x + 6\\) to \\(y = mx + c\\), the gradient is \\(m = 2\\).",
    "t": "The equation of a line using the gradient and a point",
    "hint": "Identify the gradient \\(m\\) and y-intercept \\(c\\) from \\(y = mx + c\\) to answer the sub-questions.",
    "solutionSteps": [
      {
  ...
  },
  {
    ...
    "a": "3",
    "solution": "Using gradient formula:\n\\(m = \\frac{13 - 4}{5 - 2} = \\frac{9}{3} = 3\\).",
    "t": "The equation of a line using the gradient and a point",
  ...
  },
  {
    ...
    "graphData": {
      "jsxGraph": {
        ...
        "script": "board.suspendUpdate();\nvar pA = board.create('point', [-2, -5], {size: 3, color: 'black', name: 'A(-2, -5)', withLabel: true, label: {autoPosition: false, offset: [-20, -10]}});\nvar pB = board.create('point', [4, 7], {size: 3, color: 'black', name: 'B(4, 7)', withLabel: true, label: {autoPosition: false, offset: [10, 10]}});\nboard.create('segment', [pA, pB], {strokeColor: 'black', strokeWidth: 1.5});\nvar pC = board.create('point', [1, 1], {size: 3, color: 'blue', name: 'C(1, 1)', withLabel: true, label: {autoPosition: false, offset: [10, 10]}});\nboard.create('line', [[1, 1], [0, 1.5]], {strokeColor: 'red', strokeWidth: 1.5, strokeDasharray: '6 4'});\nvar pD = board.create('point', [0, 1.5], {size: 3, color: 'red', name: 'D(0, 1.5)', withLabel: true, label: {autoPosition: false, offset: [-35, 10]}});\nboard.unsuspendUpdate();"
      }
    },
    "subQuestions": [
      {
  ...
  },
  {
    ...
    "graphData": {
      "jsxGraph": {
        ...
        "script": "board.suspendUpdate();\nvar pA = board.create('point', [2, -3], {size: 3, color: 'black', name: 'A(2, -3)', withLabel: true, label: {autoPosition: false, offset: [-10, -10]}});\nvar pB = board.create('point', [3, 4], {size: 3, color: 'black', name: 'B(3, 4)', withLabel: true, label: {autoPosition: false, offset: [10, 10]}});\nboard.create('line', [[2, -3], [0, -7]], {strokeColor: 'blue', strokeWidth: 1.5});\nboard.create('line', [[3, 4], [0, -7]], {strokeColor: 'red', strokeWidth: 1.5, strokeDasharray: '6 4'});\nvar pD = board.create('point', [0, -7], {size: 3, color: 'red', name: 'D(0, -7)', withLabel: true, label: {autoPosition: false, offset: [10, 0]}});\nboard.unsuspendUpdate();"
      }
    },
    "subQuestions": [
      {
  ...
  },
  {
    ...
    "graphData": {
      "jsxGraph": {
        ...
        "script": "board.suspendUpdate();\nvar pB = board.create('point', [3, 6], {size: 3, color: 'black', name: 'B(3, 6)', withLabel: true, label: {autoPosition: false, offset: [-15, -15]}});\nvar pW = board.create('point', [9, 18], {size: 3, color: 'black', name: 'W(9, 18)', withLabel: true, label: {autoPosition: false, offset: [10, 5]}});\nboard.create('segment', [pB, pW], {strokeColor: 'blue', strokeWidth: 2});\nvar pM = board.create('point', [6, 12], {size: 3, color: 'red', name: 'M(6, 12)', withLabel: true, label: {autoPosition: false, offset: [-20, 10]}});\nboard.unsuspendUpdate();"
      }
    },
    "subQuestions": [
      {
  ...
  },
  {
    ...
    "graphData": {
      "jsxGraph": {
        ...
        "script": "board.suspendUpdate();\nvar pA = board.create('point', [2, 3], {size: 3, color: 'black', name: 'A(2, 3)', withLabel: true, label: {autoPosition: false, offset: [-20, 10]}});\nvar pB = board.create('point', [6, 7], {size: 3, color: 'black', name: 'B(6, 7)', withLabel: true, label: {autoPosition: false, offset: [10, 10]}});\nvar pC = board.create('point', [9, 1], {size: 3, color: 'black', name: 'C(9, 1)', withLabel: true, label: {autoPosition: false, offset: [10, -5]}});\nvar pD = board.create('point', [7, -3], {size: 3, color: 'black', name: 'D(7, -3)', withLabel: true, label: {autoPosition: false, offset: [-15, -15]}});\nboard.create('polygon', [pA, pB, pC, pD], {fillColor: 'none', borders: {strokeColor: 'black', strokeWidth: 1}});\nvar pM = board.create('point', [4, 5], {size: 3, color: 'blue', name: 'M(4, 5)', withLabel: true, label: {autoPosition: false, offset: [-15, 10]}});\nvar pN = board.create('point', [8, -1], {size: 3, color: 'blue', name: 'N(8, -1)', withLabel: true, label: {autoPosition: false, offset: [10, 5]}});\nboard.create('line', [pM, pN], {strokeColor: 'blue', strokeWidth: 1.5});\nvar pP = board.create('point', [5.5, 2], {size: 3, color: 'red', name: 'P(5.5, 2)', withLabel: true, label: {autoPosition: false, offset: [10, 10]}});\nboard.create('line', [[5.5, 2], [6, 3.5]], {strokeColor: 'red', strokeWidth: 1.5, strokeDasharray: '4 4'});\nboard.unsuspendUpdate();"
      }
    },
    "subQuestions": [
      {
