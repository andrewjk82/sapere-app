export const Y12A_CH3D_QUESTIONS = [
  {
    ...
    "graphData": {
      "jsxGraph": {
        ...
        "height": 250,
        "boundingbox": [-3, 6, 4, -6],
        "script": "board.suspendUpdate();\nboard.create('arrow', [[-2.5,0], [3.5,0]], {strokeColor: 'black', strokeWidth: 1});\nboard.create('arrow', [[0,-5.5], [0,5.5]], {strokeColor: 'black', strokeWidth: 1});\nboard.create('text', [3.3, -0.5, 'x'], {fontSize: 14});\nboard.create('text', [-0.5, 5.2, 'y'], {fontSize: 14});\nvar f = function(x) { return 0.25*x*x*x*x - 2*x*x; };\nboard.create('functiongraph', [f, -2.5, 2.5], {strokeColor: 'blue', strokeWidth: 2});\nboard.create('point', [-2, -4], {name: 'A', size: 3, color: 'red', label: {offset: [-5, -15]}});\nboard.create('point', [-1.15, -2.31], {name: 'B', size: 3, color: 'red', label: {offset: [-15, 10]}});\nboard.create('point', [0, 0], {name: 'C', size: 3, color: 'red', label: {offset: [-5, 12]}});\nboard.create('point', [1.15, -2.31], {name: 'D', size: 3, color: 'red', label: {offset: [10, 10]}});\nboard.create('point', [1.5, -3.23], {name: 'E', size: 3, color: 'red', label: {offset: [10, 5]}});\nboard.create('point', [1.8, -3.83], {name: 'F', size: 3, color: 'red', label: {offset: [10, -5]}});\nboard.create('point', [2, -4], {name: 'G', size: 3, color: 'red', label: {offset: [-5, -15]}});\nboard.create('point', [2.2, -3.83], {name: 'H', size: 3, color: 'red', label: {offset: [-15, 10]}});\nboard.create('point', [2.4, -3.23], {name: 'I', size: 3, color: 'red', label: {offset: [-15, 10]}});\nboard.unsuspendUpdate();"
      }
    }
  },
  {
