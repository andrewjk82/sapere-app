export const BARKER_2020_QUESTIONS = [
  ...
  },
  {
    ...
    "solutionSteps": [
      ...
      {
        "explanation": "Final answer: Graph shows: \\(y\\)-intercept at \\((0,6)\\) (horizontal POI); minimum at \\((2,-10)\\); curve rises steeply for large \\(|x|\\); no \\(x\\)-intercepts visible between 0 and 2.. Interpret it in context (gradient, area, amount of money, exact value) and confirm it matches one option exactly. If two roots appeared, discard any that violate the domain or problem conditions.",
        "workingOut": "Graph shows: \\(y\\)-intercept at \\((0,6)\\) (horizontal POI); minimum at \\((2,-10)\\); curve rises steeply for large \\(|x|\\); no \\(x\\)-intercepts visible between 0 and 2.",
        "graphData": null
      }
    ],
    "graphData": null,
