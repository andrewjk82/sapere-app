export const CTHS_2020_SIMILAR_QUESTIONS = [
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Differentiate \\(f(x) = 3x^3 + x^2\\) once to find the first derivative using the power rule.",
      ...
      {
        "explanation": "Divide both sides by 18 to solve for \\(x\\).",
        "workingOut": "x < -\\frac{2}{18} = -\\frac{1}{9}"
      },
      {
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "For \\(\\sqrt{x}\\) to be defined, the expression under the square root must be non-negative.",
        "workingOut": "x \\geq 0"
      },
      {
      ...
      {
        "explanation": "Take the intersection of both restrictions.",
        "workingOut": "0 \\leq x < 5"
      },
      {
  ...
  },
  {
    ...
    "solutionSteps": [
      ...
      {
        "explanation": "Eliminate option A: \\(P(D|C)\\) is the conditional probability, not the joint probability.",
        "workingOut": "P(D|C) = \\frac{P(C \\cap D)}{P(C)}"
      },
      {
        "explanation": "Eliminate option C: \\(P(C \\cup D)\\) is the probability of at least one event occurring.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Recall the variance rule for a linear transformation: \\(\\text{Var}(aX + b) = a^2 \\cdot \\text{Var}(X)\\). The constant \\(b\\) does not affect the variance.",
      ...
      {
        "explanation": "Multiply by \\(\\text{Var}(X) = 3.5\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      ...
      },
      {
        ...
        "workingOut": "f'(x) = 12x^2(3-x)^2 + 4x^3 \\cdot (-2)(3-x)"
      },
      {
        "explanation": "Factor out \\(4x^2(3-x)\\) from both terms.",
        "workingOut": "f'(x) = 4x^2(3-x)\\bigl[3(3-x) - 2x\\bigr]"
      },
      {
        "explanation": "Expand the bracket: \\(3(3-x)-2x = 9-3x-2x = 9-5x\\).",
        "workingOut": "3(3-x) - 2x = 9 - 5x"
      },
      {
        "explanation": "Write the final factored answer.",
        "workingOut": "f'(x) = 4x^2(3-x)(9-5x)"
      }
    ]
  },
  {
    ...
    "solutionSteps": [
      ...
      {
        "explanation": "Conclude: since multiple inputs share a single output, the relation is many-to-one.",
  ...
  },
  {
    ...
    "solutionSteps": [
      ...
      },
      {
        ...
        "workingOut": "\\text{Amplitude} = 3"
      },
      {
        "explanation": "The period is \\(\\frac{2\\pi}{|b|} = \\frac{2\\pi}{1/3} = 6\\pi\\).",
        "workingOut": "\\text{Period} = 6\\pi"
      },
      {
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Step 1 — Translate right 3 units: replace \\(x\\) with \\((x-3)\\).",
        "workingOut": "f(x) \\to f(x-3)"
      },
      {
        "explanation": "Step 2 — Horizontally dilate by factor 2: replace \\(x\\) with \\(x/2\\) throughout.",
        "workingOut": "f(x-3) \\to f\\!\\left(\\frac{x}{2}-3\\right)"
      },
      {
        "explanation": "Step 3 — Translate up 5 units: add 5 to the entire function.",
        "workingOut": "f\\!\\left(\\frac{x}{2}-3\\right) \\to f\\!\\left(\\frac{x}{2}-3\\right) + 5"
      },
      {
        "explanation": "The final equation matches option (A).",
        "workingOut": "f\\!\\left(\\frac{x}{2}-3\\right) + 5"
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "solutionSteps": [
      ...
      {
        "explanation": "Multiply both sides by 27.",
        "workingOut": "r^6 = 729 \\times 27 = 19683"
      },
      {
      ...
      {
        "explanation": "Verify: \\(\\frac{1}{3} \\times 3^6 = \\frac{729}{3} = 243\\) ✓.",
        "workingOut": "\\frac{1}{3} \\times 3^6 = 243 \\checkmark"
      }
    ]
  },
  {
    ...
    "solutionSteps": [
      ...
      },
      {
        ...
        "workingOut": "\\frac{\\sqrt{2}}{2} - \\frac{1}{2} = \\frac{\\sqrt{2}-1}{2}"
      }
    ]
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Find the angle at \\(P\\) between the directions to \\(Q\\) and \\(R\\): subtract the bearings.",
        "workingOut": "\\angle QPR = 250° - 120° = 130°"
      },
      {
        "explanation": "Apply the cosine rule with \\(PQ = 60\\), \\(PR = 30\\), \\(\\angle QPR = 130°\\).",
        "workingOut": "QR^2 = 60^2 + 30^2 - 2(60)(30)\\cos 130°"
      },
      {
        "explanation": "Evaluate: \\(3600 + 900 = 4500\\), \\(2(60)(30)=3600\\), \\(\\cos 130° \\approx -0.643\\).",
        "workingOut": "QR^2 = 4500 - 3600 \\times (-0.643) = 4500 + 2315 \\approx 6815"
      },
      {
        "explanation": "Take the square root.",
        "workingOut": "QR = \\sqrt{6815} \\approx 82.5"
      },
      {
        "explanation": "Round to the nearest kilometre.",
        "workingOut": "QR \\approx 76 \\text{ km}"
      }
    ]
  },
  {
    ...
    "solutionSteps": [
      ...
      {
        "explanation": "Differentiate \\(v = \\tan 3x\\) using the chain rule.",
        "workingOut": "v' = 3\\sec^2 3x"
      },
      {
        "explanation": "Apply the product rule.",
        "workingOut": "\\frac{d}{dx}(x^2 \\tan 3x) = 2x\\tan 3x + x^2 \\cdot 3\\sec^2 3x"
      },
      {
        "explanation": "Factor out the common factor \\(x\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      ...
      {
        "explanation": "Determine end behaviour from the leading term \\(\\approx -x^4\\).",
        "workingOut": "\\text{As } x \\to \\pm\\infty,\\; y \\to -\\infty"
      },
      {
        "explanation": "Sketch with key points \\((-2,0)\\), \\((0,2)\\), \\((1,0)\\) and the described shape.",
        "workingOut": "\\text{Sketch with } (-2,0),\\;(0,2),\\;(1,0)"
      }
    ]
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Use the Pythagorean identity to find \\(\\sin^2\\theta\\).",
      ...
      {
        "explanation": "Since \\(270° \\leq \\theta \\leq 360°\\) is the 4th quadrant, \\(\\sin\\theta < 0\\).",
        "workingOut": "\\sin\\theta < 0"
      },
      {
        "explanation": "State the exact value.",
        "workingOut": "\\sin\\theta = -\\frac{\\sqrt{55}}{8}"
      }
    ]
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Write \\(\\cot x = \\frac{\\cos x}{\\sin x}\\) and \\(\\csc x = \\frac{1}{\\sin x}\\) and combine.",
      ...
      {
        "explanation": "Replace \\(\\sin^2 x = 1 - \\cos^2 x\\) using the Pythagorean identity.",
        "workingOut": "= \\frac{(1+\\cos x)^2}{1-\\cos^2 x}"
      },
      {
        "explanation": "Factorise the denominator as a difference of squares.",
        "workingOut": "= \\frac{(1+\\cos x)^2}{(1-\\cos x)(1+\\cos x)}"
      },
      {
        "explanation": "Cancel the common factor \\((1+\\cos x)\\).",
        "workingOut": "= \\frac{1+\\cos x}{1-\\cos x} = \\text{RHS}\\quad\\blacksquare"
      }
    ]
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Substitute \\(u = \\cos\\beta\\) to form a quadratic.",
      ...
      {
        "explanation": "Solve: \\(u = -\\frac{1}{2}\\) or \\(u = 3\\).",
        "workingOut": "u = -\\frac{1}{2} \\quad \\text{or} \\quad u = 3"
      },
      {
        "explanation": "Reject \\(u = 3\\) since \\(\\cos\\beta \\in [-1,1]\\).",
        "workingOut": "\\cos\\beta = -\\frac{1}{2}"
      },
      {
        "explanation": "The reference angle is \\(\\frac{\\pi}{3}\\); in the 2nd quadrant (where cosine is negative): \\(\\beta = \\pi - \\frac{\\pi}{3} = \\frac{2\\pi}{3}\\).",
        "workingOut": "\\beta = \\frac{2\\pi}{3}"
      }
    ]
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Form the composite: substitute \\(g(x) = \\ln(x-5)\\) into \\(f(x) = e^x\\).",
      ...
      {
        "explanation": "Domain: \\(g(x)\\) requires \\(x - 5 > 0\\), so \\(x > 5\\).",
        "workingOut": "\\text{Domain: } x > 5"
      },
      {
        "explanation": "When \\(x > 5\\), \\(x - 5 > 0\\), so range \\(= (0, +\\infty)\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Integrate \\(\\frac{dy}{dx} = x^2 + 4x - 5\\) term by term.",
        "workingOut": "y = \\frac{x^3}{3} + 2x^2 - 5x + C"
      },
      {
        "explanation": "Substitute the point \\(Q(3, 10)\\): \\(x=3\\), \\(y=10\\).",
      ...
      {
        "explanation": "Write the complete equation.",
        "workingOut": "y = \\frac{x^3}{3} + 2x^2 - 5x - 2"
      },
      {
        "explanation": "Find the tangent gradient at \\(x=3\\) by substituting into \\(\\frac{dy}{dx}\\).",
        "workingOut": "m_{\\text{tangent}} = 9 + 12 - 5 = 16"
      },
      {
        "explanation": "The normal gradient is \\(-\\frac{1}{16}\\). Use point-slope form and rearrange.",
        "workingOut": "y - 10 = -\\frac{1}{16}(x-3) \\Rightarrow 16y - 160 = -x + 3 \\Rightarrow x + 16y - 163 = 0"
      }
    ]
  },
  {
    ...
    "solutionSteps": [
      {
        ...
        "workingOut": "y' = 6x^2 - 6x - 12 = 6(x^2 - x - 2) = 6(x+1)(x-2)"
      },
      {
        "explanation": "Set \\(y'=0\\): \\(x=-1\\) or \\(x=2\\).",
        "workingOut": "x = -1 \\quad \\text{or} \\quad x = 2"
      },
      {
        "explanation": "Second derivative: \\(y''=12x-6\\).",
        "workingOut": "y'' = 12x - 6"
      },
      {
        "explanation": "At \\(x=-1\\): \\(y''=-18<0\\) (max). \\(y=2(-1)-3(1)-12(-1)+4=11\\).",
        "workingOut": "\\text{Local max at }(-1, 11)"
      },
      {
        "explanation": "At \\(x=2\\): \\(y''=18>0\\) (min). \\(y=16-12-24+4=-16\\).",
        "workingOut": "\\text{Local min at }(2, -16)"
      },
      {
        "explanation": "POI: \\(12x-6=0 \\Rightarrow x=\\frac{1}{2}\\). \\(y=2(\\frac{1}{8})-3(\\frac{1}{4})-12(\\frac{1}{2})+4=\\frac{1}{4}-\\frac{3}{4}-6+4=-\\frac{5}{2}\\).",
        "workingOut": "\\text{POI at }\\left(\\tfrac{1}{2}, -\\tfrac{5}{2}\\right)"
      },
      {
        "explanation": "\\(y\\)-intercept: \\(y=4\\).",
        "workingOut": "y\\text{-intercept: }(0,4)"
      }
    ],
    "subQuestions": [
      {
        ...
        "solutionSteps": [
          {
            "explanation": "Plot key points: $(-1,11)$, $(\\frac{1}{2},-\\frac{5}{2})$, $(2,-16)$, $(0,4)$.",
            "workingOut": "(-1,11),\\;(\\tfrac{1}{2},-\\tfrac{5}{2}),\\;(2,-16),\\;(0,4)"
          },
          {
            "explanation": "Draw the cubic rising from bottom-left, through the local max, POI, local min, then rising to the right.",
  ...
  },
  {
    ...
    "solutionSteps": [
      ...
      {
        "explanation": "The rightmost intersection occurs near \\(x \\approx 6.5\\).",
    ...
    "subQuestions": [
      {
        ...
        "solutionSteps": [
          {
            "explanation": "Mark zeros at $x=-4,-2,1$.",
            "workingOut": "h'(-4)=h'(-2)=h'(1)=0"
          },
          {
            "explanation": "Sketch the curve with correct sign in each interval.",
            "workingOut": "+,\\;0,\\;-,\\;0,\\;+,\\;0,\\;-"
          }
        ]
      },
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Split using \\(\\ln(A/B)=\\ln A - \\ln B\\).",
      ...
      {
        "explanation": "Combine over common denominator \\((5+x)(5-x)=25-x^2\\).",
        "workingOut": "\\frac{(5-x)+(5+x)}{25-x^2} = \\frac{10}{25-x^2}\\quad\\blacksquare"
      },
      {
        "explanation": "From (a): \\(\\int\\frac{10}{25-x^2}dx = \\ln|\\frac{5+x}{5-x}|+C\\). Divide both sides by 10.",
        "workingOut": "\\int\\frac{1}{25-x^2}dx = \\frac{1}{10}\\ln\\!\\left|\\frac{5+x}{5-x}\\right|+C"
      }
    ]
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Determine \\(h = \\frac{2-0}{4} = 0.5\\).",
        "workingOut": "h = 0.5"
      },
      {
        "explanation": "Evaluate \\(f(x) = \\sqrt{9-x^2}\\) at each point.",
      ...
      },
      {
        ...
        "workingOut": "= 0.25[5.236 + 2(8.384)] = 0.25[5.236+16.768] = 0.25 \\times 22.004 \\approx 4.441"
      }
    ]
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Verify the PDF is valid: \\(\\int_0^4|2-y|\\frac{1}{4}\\,dy=1\\). For this variant, \\(f(y)=\\frac{1}{4}|2-y|\\) on \\([0,4]\\).",
        "workingOut": "\\int_0^4 \\frac{1}{4}|2-y|\\,dy = \\frac{1}{4}\\cdot 4 = 1\\checkmark"
      },
      {
        "explanation": "Split: \\(|2-y| = (2-y)\\) for \\(y\\leq2\\), \\((y-2)\\) for \\(y>2\\).",
        "workingOut": "P(Y\\leq 3) = \\frac{1}{4}\\!\\left[\\int_0^2(2-y)dy+\\int_2^3(y-2)dy\\right]"
      },
      {
        "explanation": "First integral.",
        "workingOut": "\\int_0^2(2-y)dy = \\left[2y-\\frac{y^2}{2}\\right]_0^2 = 4-2=2"
      },
      {
        "explanation": "Second integral.",
        "workingOut": "\\int_2^3(y-2)dy = \\left[\\frac{y^2}{2}-2y\\right]_2^3 = (\\frac{9}{2}-6)-(2-4)=(-\\frac{3}{2})+2=\\frac{1}{2}"
      },
      {
        "explanation": "Combine.",
        "workingOut": "P(Y\\leq 3) = \\frac{1}{4}(2+\\frac{1}{2}) = \\frac{1}{4}\\cdot\\frac{5}{2} = \\frac{5}{8}"
      }
    ]
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Part (a): Distance below mean \\(= |z|\\sigma = 1.4 \\times 15\\).",
        "workingOut": "1.4 \\times 15 = 21 \\text{ mL}"
      },
      {
        "explanation": "Part (b): 97.5% above means 2.5% below the label value, corresponding to \\(z=-2\\).",
        "workingOut": "z = -2"
      },
      {
        "explanation": "Convert to raw value: \\(x = \\mu + z\\sigma = 500 + (-2)(15)\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Part (a): Independent selections, multiply probabilities.",
        "workingOut": "P(\\text{both}) = (0.2)^2 = 0.04"
      },
      {
        "explanation": "Part (b): Complement rule — none have virus \\(= (0.8)^4\\).",
        "workingOut": "P(\\text{at least one}) = 1-(0.8)^4 = 1-0.4096 = 0.5904 \\approx 0.590"
      },
      {
        "explanation": "Part (c): Solve \\((0.8)^n < 0.05\\).",
        "workingOut": "n\\ln(0.8) < \\ln(0.05) \\Rightarrow n > \\frac{\\ln(0.05)}{\\ln(0.8)} \\approx \\frac{-2.996}{-0.223} \\approx 13.4"
      },
      {
        "explanation": "Round up to the nearest whole number.",
        "workingOut": "n = 14 \\text{ people}"
      }
    ]
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "\\(y=\\sqrt{x+4}\\) meets \\(x\\)-axis at \\(x=-4\\). The line \\(y=10-x\\) meets \\(x\\)-axis at \\(x=10\\). Intersection at \\(x=5\\). Split area there.",
        "workingOut": "A = \\int_{-4}^{5}\\sqrt{x+4}\\,dx + \\int_{5}^{10}(10-x)\\,dx"
      },
      {
        "explanation": "First integral: \\(\\int(x+4)^{1/2}dx = \\frac{2(x+4)^{3/2}}{3}\\).",
      ...
      },
      {
        ...
        "workingOut": "A = 18 + \\frac{25}{2} = \\frac{36+25}{2} = \\frac{61}{2} = 30.5 \\text{ square units}"
      }
    ]
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Set up the equal-ratio condition for a GP.",
      ...
      },
      {
        ...
        "workingOut": "(k-1)(k-15) = 0"
      },
      {
        "explanation": "Solve and verify: \\(k=1\\): terms \\(1,4,16\\) (ratio 4) ✓; \\(k=15\\): terms \\(15,60,240\\) (ratio 4) ✓.",
        "workingOut": "k = 1 \\quad\\text{or}\\quad k = 15"
      }
    ]
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Set \\(\\int_0^4 ke^{-2x}dx=1\\) and integrate.",
      ...
      {
        "explanation": "Solve \\(\\int_0^m ke^{-2x}dx=0.5\\).",
        "workingOut": "\\frac{k}{2}(1-e^{-2m}) = 0.5 \\Rightarrow 1-e^{-2m} = \\frac{1}{k} \\approx 0.4998"
      },
      {
        "explanation": "Solve for \\(e^{-2m}\\).",
        "workingOut": "e^{-2m} \\approx 0.5002 \\Rightarrow -2m = \\ln(0.5002) \\approx -0.6929"
      },
      {
        "explanation": "Solve for \\(m\\).",
        "workingOut": "m \\approx \\frac{0.6929}{2} \\approx 0.347"
      }
    ]
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Part (a): probabilities must sum to 1. Sum given values and solve.",
        "workingOut": "0.2+0.15+0.08+b+0.12+0.10 = 1 \\Rightarrow 0.65+b=1 \\Rightarrow b=0.35"
      },
      {
        "explanation": "Part (b): \\(P(1<X\\leq4) = P(X=2)+P(X=3)+P(X=4)\\).",
        "workingOut": "0.15+0.08+0.35 = 0.58"
      },
      {
        "explanation": "Part (c): \\(P(X>1) = 1-P(X=1) = 0.80\\). Apply conditional probability formula.",
        "workingOut": "P(X\\leq4|X>1) = \\frac{0.58}{0.80} = \\frac{29}{40}"
      },
      {
        "explanation": "Part (d): Compute \\(E(X) = \\sum xP(X=x)\\).",
        "workingOut": "E(X) = 0.2+0.30+0.24+1.40+0.60+0.60 = 3.34"
      },
      {
        "explanation": "Part (e): \\(E(3X+2) = 3E(X)+2\\).",
        "workingOut": "3(3.34)+2 = 10.02+2 = 12.02"
      },
      {
        "explanation": "Part (f): \\(E(X^2)=0.2+0.6+0.72+5.6+3.0+3.6=13.72\\); \\(\\text{Var}(X)=13.72-(3.34)^2\\).",
        "workingOut": "\\text{Var}(X) = 13.72 - 11.156 = 2.564"
      }
    ]
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Part (a): Compute Pearson's \\(r\\) using a calculator.",
        "workingOut": "r \\approx 0.99 \\Rightarrow \\text{very strong positive correlation}"
      },
      {
        "explanation": "Part (b): Use least-squares regression on the calculator.",
        "workingOut": "S = 4h + 32"
      },
      {
        "explanation": "Part (c): Substitute \\(h = 12\\).",
        "workingOut": "S = 4(12)+32 = 80"
      },
      {
        "explanation": "Part (d): The regression equation is valid only within the observed range \\([1,14]\\). Using it beyond this range (extrapolation) may give inaccurate predictions.",
        "workingOut": "\\text{Valid for } 1 \\leq h \\leq 14 \\text{ only}"
      }
    ]
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Part (a): Differentiate \\(W(t) = 1250(20-t)^2\\) using the chain rule.",
        "workingOut": "W'(t) = 1250 \\cdot 2(20-t)(-1) = -2500(20-t)"
      },
      {
        "explanation": "Removal rate \\(= -W'(t) = 2500(20-t)\\) L/min.",
        "workingOut": "\\text{Rate} = 2500(20-t)"
      },
      {
        "explanation": "Part (b): \\(W(0)=1250(400)=500000\\) L. Solve \\(W(t)=250000\\).",
        "workingOut": "1250(20-t)^2=250000 \\Rightarrow (20-t)^2=200 \\Rightarrow t=20-\\sqrt{200}\\approx 5.86\\approx 6 \\text{ min}"
      },
      {
        "explanation": "Part (c): \\(2500(20-t)=12500 \\Rightarrow 20-t=5 \\Rightarrow t=15\\) min.",
        "workingOut": "t = 15 \\text{ min}"
      },
      {
        "explanation": "Part (d): As \\(t\\) increases, \\((20-t)\\) decreases, so the rate \\(2500(20-t)\\) decreases. The tank empties at a decreasing rate.",
        "workingOut": "\\text{Decreasing rate as } t \\text{ increases}"
      }
    ]
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Part (a): Equilateral triangle with perimeter \\(x\\) has each side \\(= \\frac{x}{3}\\). Area of equilateral triangle with side \\(s\\) is \\(\\frac{\\sqrt{3}}{4}s^2\\).",
        "workingOut": "A_{\\triangle} = \\frac{\\sqrt{3}}{4}\\left(\\frac{x}{3}\\right)^2 = \\frac{\\sqrt{3}}{4}\\cdot\\frac{x^2}{9} = \\frac{\\sqrt{3}\\,x^2}{36}"
      },
      {
        "explanation": "The remaining piece \\((120-x)\\) forms a circle. Its circumference \\(= 120-x\\), so \\(r = \\frac{120-x}{2\\pi}\\).",
        "workingOut": "A_{\\circ} = \\pi r^2 = \\pi\\left(\\frac{120-x}{2\\pi}\\right)^2 = \\frac{(120-x)^2}{4\\pi}"
      },
      {
        "explanation": "Total area: \\(A = A_{\\triangle} + A_{\\circ}\\).",
        "workingOut": "A = \\frac{\\sqrt{3}\\,x^2}{36} + \\frac{(120-x)^2}{4\\pi}\\quad\\blacksquare"
      },
      {
        "explanation": "Part (b): Differentiate and set \\(\\frac{dA}{dx}=0\\).",
        "workingOut": "\\frac{dA}{dx} = \\frac{\\sqrt{3}\\,x}{18} - \\frac{120-x}{2\\pi} = 0"
      },
      {
      ...
      },
      {
        ...
        "workingOut": "A'' > 0 \\Rightarrow \\text{minimum}"
      }
    ]
  }
];
