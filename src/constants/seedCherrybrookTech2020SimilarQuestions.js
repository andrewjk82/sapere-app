export const CTHS_2020_SIMILAR_QUESTIONS = [
  ...
  },
  {
    ...
    "topicId": "y12a-exam",
    "c": "EXAM",
    "t": "Cherrybrook Tech 2020 Trial Exam (Similar)",
    "type": "subquestions",
    "difficulty": "hard",
    "timeLimit": 300,
    "question": "A function is given by \\( y = 2x^3 - 3x^2 - 12x + 4 \\).",
    "isNew": true,
    "requiresManualGrading": true,
    "subQuestions": [
      {
        ...
        "opts": [
          "Local max at \\((-1, 11)\\), local min at \\((2, -16)\\), inflection at \\((\\frac{1}{2}, -\\frac{5}{2})\\)",
          "Local min at \\((-1, 11)\\), local max at \\((2, -16)\\), inflection at \\((\\frac{1}{2}, -\\frac{5}{2})\\)",
          "Local max at \\((-2, 15)\\), local min at \\((1, -12)\\), inflection at \\((-\\frac{1}{2}, \\frac{3}{2})\\)",
          "Local max at \\((1, 11)\\), local min at \\((-2, -16)\\), inflection at \\((-\\frac{1}{2}, -\\frac{5}{2})\\)"
        ],
        "options": [
          {
            "text": "Local max at \\((-1, 11)\\), local min at \\((2, -16)\\), inflection at \\((\\frac{1}{2}, -\\frac{5}{2})\\)",
            "imageUrl": ""
          },
          {
            "text": "Local min at \\((-1, 11)\\), local max at \\((2, -16)\\), inflection at \\((\\frac{1}{2}, -\\frac{5}{2})\\)",
            "imageUrl": ""
          },
          {
        ...
        "solutionSteps": [
          ...
          },
          {
            ...
            "workingOut": "x=-1:\\quad y''=-18 < 0 \\Rightarrow \\text{local max at } (-1, 11)\nx=2:\\quad y''=18 > 0 \\Rightarrow \\text{local min at } (2, -16)"
          },
          {
            "explanation": "Find points of inflection by setting \\(y'' = 0\\).",
            "workingOut": "12x - 6 = 0 \\Rightarrow x = \\frac{1}{2}\n\\text{POI at } \\left(\\frac{1}{2}, -\\frac{5}{2}\\right)"
          }
        ]
      },
      {
        ...
        "solutionSteps": [
          {
            ...
            "workingOut": "y\\text{-intercept occurs when } x=0: y = 4"
          },
          {
            "explanation": "Sketch the curve passing through these key features.",
            "workingOut": "\\text{Plot local max } (-1,11)\\text{, POI } \\left(\\frac{1}{2}, -\\frac{5}{2}\\right)\\text{, local min } (2,-16)\\text{, and } y\\text{-intercept } (0,4)\\text{.}",
            "graphData": {
              "jsxGraph": {
                "width": 300,
                "height": 300,
