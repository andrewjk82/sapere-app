export const Y12A_CH3_QUESTIONS = [
  {
    ...
    "graphData": {
      "jsxGraph": {
        ...
        "height": 250,
        "boundingbox": [-1, 6, 8, -1],
        "script": "board.suspendUpdate();\nvar f = function(x) { return x*(x-3)*(x-6)/8 + 3; };\nboard.create('functiongraph', [f, -0.5, 7.5], {strokeColor: 'blue', strokeWidth: 2});\nboard.create('point', [0, f(0)], {name: 'A', size: 3, color: 'red', label: {offset: [-5, 10]}});\nboard.create('point', [1.27, f(1.27)], {name: 'B', size: 3, color: 'red', label: {offset: [-5, 10]}});\nboard.create('point', [2.5, f(2.5)], {name: 'C', size: 3, color: 'red', label: {offset: [-5, -10]}});\nboard.create('point', [3.5, f(3.5)], {name: 'D', size: 3, color: 'red', label: {offset: [-5, -10]}});\nboard.create('point', [4.73, f(4.73)], {name: 'E', size: 3, color: 'red', label: {offset: [-5, -10]}});\nboard.create('point', [5.8, f(5.8)], {name: 'F', size: 3, color: 'red', label: {offset: [-5, 10]}});\nboard.create('point', [6.8, f(6.8)], {name: 'G', size: 3, color: 'red', label: {offset: [-5, 10]}});\nboard.unsuspendUpdate();"
      }
    }
  },
  {
  ...
  },
  {
    ...
    "solutionSteps": [
      ...
      },
      {
        ...
        "workingOut": "\\text{Peak at } x = -1, \\text{ rises to the left, falls to the right.}"
      }
    ]
  },
  {
    ...
    "solutionSteps": [
      {
        ...
        "workingOut": "\\text{Odd function: passing through } (0,0), \\text{ x-intercepts at } \\pm 3, \\text{ stationary at } \\pm 1"
      },
      {
  ...
  },
  {
    ...
    "solutionSteps": [
      ...
      },
      {
        ...
        "workingOut": "\\text{Minimum vertex at } x = 0, \\text{ decreasing on the left, increasing on the right.}"
      }
    ]
  }
];
