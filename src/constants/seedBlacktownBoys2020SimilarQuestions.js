export const BLACKTOWN_BOYS_2020_SIMILAR_QUESTIONS = [
  {
    ...
    "solutionSteps": [
      {
        "explanation": "The expression under a square root must be non-negative.",
  ...
  },
  {
    ...
    "solutionSteps": [
      ...
      {
        "explanation": "Read off the gradient.",
        "workingOut": "m = \\frac{1}{\\sqrt{3}}"
      },
      {
        "explanation": "Use \\(\\tan\\theta = m\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Recognise: \\(\\frac{\\log_b A}{\\log_b C} = \\log_C A\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Genre names are labels — no numerical quantity and no natural order between genres.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Break-even occurs at the intersection of the cost and income lines.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Total complaints = 30 + 10 + 6 + 4 + 2 = 52.",
        "workingOut": "\\text{Total} = 52"
      },
      {
        "explanation": "July's percentage.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Increasing curve → positive gradient.",
        "workingOut": "f'(b) > 0"
      },
      {
        "explanation": "Concave up → second derivative is positive.",
        "workingOut": "f''(b) > 0"
      }
    ]
  },
  {
    ...
    "solutionSteps": [
      ...
      {
        "explanation": "Calculate the probability of selecting no red balls (all blue).",
        "workingOut": "P(0 \\text{ red}) = \\frac{4}{10} \\times \\frac{3}{9} \\times \\frac{2}{8} = \\frac{24}{720} = \\frac{1}{30}"
      },
      {
        "explanation": "Apply the complement.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Area between two curves where top \\(= q(x)\\), bottom \\(= p(x)\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Apply the cosine rule with \\(a = 6\\) (opposite side), \\(b = 9\\), \\(c = 12\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Find \\(\\sin A\\) using the Pythagorean identity.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Use the sum formula \\(S_n = \\frac{n}{2}(a + l)\\).",
        "workingOut": "S_{20} = \\frac{20}{2}(20 + l) = 1160"
      },
      {
        "explanation": "Solve for the last term \\(l\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Apply the general term formula.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "At the vertex \\(x = 1.5\\): \\(1.5a + b = 0\\).",
        "workingOut": "1.5a = -b"
      },
      {
        "explanation": "At the \\(y\\)-intercept: \\(|b| = 3\\), so \\(b = \\pm 3\\).",
        "workingOut": "b = \\pm 3"
      },
      {
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Split into two inequalities.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Differentiate the outer cube.",
        "workingOut": "\\frac{d}{dx}[u^3] = 3u^2 \\frac{du}{dx}"
      },
      {
        "explanation": "Differentiate \\(\\sin(x/3)\\) using chain rule.",
  ...
  },
  {
    ...
    "solutionSteps": [
      ...
      {
        "explanation": "Since \\(|r| < 1\\), the limiting sum exists.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "The 4th term is \\(ar^3 = 375\\).",
        "workingOut": "3r^3 = 375 \\Rightarrow r^3 = 125 \\Rightarrow r = 5"
      },
      {
        "explanation": "Find \\(m = ar\\).",
        "workingOut": "m = 3 \\times 5 = 15"
      },
      {
        "explanation": "Find \\(n = ar^2\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Increase the power by 1 and divide by the new power times the coefficient of \\(x\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Integrate \\(3x^4\\).",
        "workingOut": "\\frac{3x^5}{5}"
      },
      {
        "explanation": "Integrate \\(\\frac{1}{2x+1}\\) using the log rule.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Integrate \\(\\cos 6x\\).",
        "workingOut": "\\frac{1}{6}\\sin 6x"
      },
      {
        "explanation": "Rewrite \\(\\frac{3}{e^{4x}} = 3e^{-4x}\\) and integrate.",
        "workingOut": "\\int 3e^{-4x}\\,dx = \\frac{3}{-4}e^{-4x} = -\\frac{3}{4e^{4x}}"
      },
      {
        "explanation": "Subtract gives a positive term; combine and add constant.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Find the gradient at \\(x = 0\\) using the result from part (a).",
        "workingOut": "m = e^{0}(3\\sin 0 + \\cos 0) = 1"
      },
      {
        "explanation": "Find the \\(y\\)-coordinate at \\(x = 0\\).",
        "workingOut": "y = e^{0}\\sin 0 = 0"
      },
      {
        "explanation": "Write the tangent equation.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Read the PVA factor for \\(N = 10\\), \\(r = 5\\%\\).",
        "workingOut": "\\text{PVA factor} = 7.7217"
      },
      {
        "explanation": "Multiply by the annual payment.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Set up the equation: loan = repayment × PVA factor.",
  ...
  },
  {
    ...
    "solutionSteps": [
      ...
      {
        "explanation": "Substitute the point \\((1, -3)\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Factor: \\(\\sqrt{4x+4} = 2\\sqrt{x+1} = 2(x+1)^{1/2}\\).",
        "workingOut": "\\int_0^3 2(x+1)^{1/2}\\,dx = \\left[\\frac{4}{3}(x+1)^{3/2}\\right]_0^3"
      },
      {
        "explanation": "Substitute upper limit: \\((3+1)^{3/2} = 4^{3/2} = 8\\).",
        "workingOut": "\\frac{4}{3}(8)"
      },
      {
        "explanation": "Substitute lower limit: \\((0+1)^{3/2} = 1\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      ...
      {
        "explanation": "From \\(\\sin x = +\\frac{1}{2}\\): in Q1 and Q2.",
        "workingOut": "x = \\frac{\\pi}{6},\\ \\frac{5\\pi}{6}"
      },
      {
        "explanation": "From \\(\\sin x = -\\frac{1}{2}\\): in Q3 and Q4.",
        "workingOut": "x = -\\frac{\\pi}{6},\\ -\\frac{5\\pi}{6}"
      },
      {
        "explanation": "All solutions.",
        "workingOut": "x = -\\frac{5\\pi}{6},\\ -\\frac{\\pi}{6},\\ \\frac{\\pi}{6},\\ \\frac{5\\pi}{6}"
      }
    ]
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Find \\(m\\): all probabilities sum to 1.",
      ...
      },
      {
        ...
        "workingOut": "\\text{Var}(X) = 133.80 - 11.5^2 = 133.80 - 132.25 = 1.55"
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Apply the trapezoidal rule with \\(h = 0.5\\) and 4 strips.",
        "workingOut": "A \\approx \\frac{h}{2}[y_0 + 2(y_1 + y_2 + y_3) + y_4]"
      },
      {
        "explanation": "Substitute the \\(y\\)-values.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Direction: as study hours increase, exam score increases — positive.",
        "workingOut": "\\text{Direction: positive}"
      },
      {
        "explanation": "Strength: \\(R^2 = 0.9901\\) indicates \\(r \\approx 0.995\\), a very strong relationship.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Substitute \\(x = 2.5\\) into \\(y = 8.5x + 27\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "The data only covers \\(1 \\leq x \\leq 5\\) hours. Extrapolation to 20 hours may be invalid.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Differentiate and set \\(y' = 0\\).",
      ...
      {
        "explanation": "Use the second derivative \\(y'' = 6x\\) to classify.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "\\(2.5\\%\\) above corresponds to \\(z = 2\\) (from the 95% rule).",
        "workingOut": "z = 2"
      },
      {
        "explanation": "Convert to the actual value.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Find the \\(z\\)-score.",
        "workingOut": "z = \\frac{55 - 75}{10} = -2"
      },
      {
        "explanation": "The proportion above \\(z = -2\\) equals \\(50\\% + 47.5\\% = 97.5\\%\\) (from the 95% rule).",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Find the \\(z\\)-score for 45 min.",
        "workingOut": "z = \\frac{45 - 75}{10} = -3"
      },
      {
        "explanation": "\\(z = -3\\) corresponds to the bottom 0.15% (from 99.7% rule).",
        "workingOut": "P(X < 45) = 0.15\\%"
      },
      {
        "explanation": "Set up equation: proportion × sample size = 3.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Set the integral of the PDF equal to 1.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Integrate the PDF from 0 to \\(x\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      ...
      {
        "explanation": "Multiply both sides by \\((2x-1)\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Set up the integral (top curve minus bottom curve).",
        "workingOut": "A = \\int_1^{5.5}\\!\\left[(6-x) - \\frac{5}{2x-1}\\right]dx"
      },
      {
        "explanation": "Find the primitive function.",
        "workingOut": "\\left[6x - \\frac{x^2}{2} - \\frac{5}{2}\\ln|2x-1|\\right]_1^{5.5}"
      },
      {
        "explanation": "Substitute limits. At \\(x=5.5\\): \\(6(5.5) - (5.5)^2/2 - (5/2)\\ln 10 = 33 - 15.125 - (5/2)\\ln 10\\). At \\(x=1\\): \\(6 - 0.5 - 0 = 5.5\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Apply the general term formula with \\(a = 30\\), \\(d = 5\\), \\(n = 8\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      ...
      {
        "explanation": "First integer value.",
        "workingOut": "n = 36"
      }
    ]
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Set up the sum equation.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Substitute \\(t = 0\\) into the velocity function.",
  ...
  },
  {
    ...
    "solutionSteps": [
      ...
      {
        "explanation": "Solve for \\(2t\\) in \\([0, 4\\pi]\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Differentiate \\(v = 3 - 6\\cos 2t\\).",
        "workingOut": "a = \\frac{dv}{dt} = 12\\sin 2t"
      },
      {
        "explanation": "Substitute \\(t = \\pi/2\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Integrate the velocity.",
        "workingOut": "x = 3t - 3\\sin 2t + C"
      },
      {
        "explanation": "Apply \\(x(0) = 5\\).",
        "workingOut": "5 = 0 - 0 + C \\Rightarrow C = 5"
      },
      {
        "explanation": "Substitute \\(t = \\pi\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Write the area formula.",
        "workingOut": "A = 2rh + \\frac{1}{2}\\pi r^2"
      },
      {
        "explanation": "Substitute the expression for \\(h\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      ...
      {
        "explanation": "Verify maximum: \\(\\frac{d^2A}{dr^2} = -4 - \\pi < 0\\) ✓",
        "workingOut": "\\frac{d^2A}{dr^2} < 0 \\Rightarrow \\text{maximum}"
      }
    ]
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Substitute \\(r = \\frac{20\\pi}{4+\\pi}\\) into the area formula.",
        "workingOut": "A = 20\\pi \\times \\frac{20\\pi}{4+\\pi} - 2\\left(\\frac{20\\pi}{4+\\pi}\\right)^2 - \\frac{\\pi}{2}\\left(\\frac{20\\pi}{4+\\pi}\\right)^2"
      },
      {
        "explanation": "Simplify to \\(\\frac{200\\pi^2}{4+\\pi}\\) and evaluate numerically.",
