export const Y11A_CH2D_QUESTIONS = [
  ...
  },
  {
    ...
    "answer": "\\frac{8\\sqrt{2}+4\\sqrt{3}}{5}",
    "options": [],
    "hint": "Simplify the expression step-by-step.",
    "solution": "",
    "solutionSteps": [
    ...
    "solutionSteps": [
      {
        ...
        "workingOut": "Consider the following expression problems.",
        "graphData": null
      },
      {
