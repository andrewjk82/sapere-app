export const Y7_CH1A_QUESTIONS = [
  ...
  // Q4
  {
    ...
    difficulty: 'hard',
    timeLimit: 120,
    question: 'Write down all of the three-digit numbers that can be formed from the digits 3, 7 and 8 (use each digit only once in each number formed), and list them from largest to smallest. (Separate the numbers with a comma and a space).',
  ...
  // Q5
  {
    ...
    difficulty: 'hard',
    timeLimit: 180,
    question: 'Write down all of the three-digit numbers that can be formed from the digits 1, 4 and 6 (each digit can be used more than once in each number formed), and list them from largest to smallest. Separate each number with a comma and a space.',
