...
export const FORTST_2020_SIMILAR_QUESTIONS = [
...

  {
    ...
    a: '$x = \\dfrac{\\pi}{12}, \\dfrac{11\\pi}{12}, \\dfrac{-11\\pi}{12}, \\dfrac{-\\pi}{12}$',
    opts: [
...

  {
    ...
    a: 'A horizontal point of inflexion at $x = 3$',
    opts: [
...

  {
    ...
    a: 'A positive cubic ($y = x^3 - 9x + C$) with a maximum then a minimum (Option B).',
    opts: [
