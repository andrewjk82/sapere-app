export const FORTST_2020_SIMILAR_QUESTIONS = [
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Reflect in the \\(x\\)-axis by negating the function.",
        "workingOut": "y = -2x^{7/2}"
      },
      {
        "explanation": "Translate \\(2\\) right by replacing \\(x\\) with \\(x - 2\\).",
        "workingOut": "y = -2(x-2)^{7/2}"
      },
      {
        "explanation": "Translate \\(5\\) down by subtracting \\(5\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      ...
      {
        "explanation": "Reference angle for \\(\\cos u = \\frac{\\sqrt3}{2}\\) is \\(\\frac{\\pi}{6}\\) (Q1/Q4).",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "State the trapezoidal rule with \\(h = 4\\), first/last ordinates once and interior ones twice.",
        "workingOut": "A \\approx \\frac{4}{2}[y_1 + y_5 + 2(y_2 + y_3 + y_4)]"
      },
      {
        "explanation": "Substitute the five ordinates \\(3, 5, 6, 4, 0\\).",
        "workingOut": "= 2[3 + 0 + 2(5 + 6 + 4)]"
      },
      {
        "explanation": "Simplify and evaluate.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "The angle of inclination satisfies \\(\\tan\\theta = m\\).",
        "workingOut": "\\tan\\theta = \\sqrt{3}"
      },
      {
        "explanation": "A positive gradient means an acute angle.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Stationary points occur where \\(f'(x) = 0\\): at \\(x = -1\\) and \\(x = 3\\).",
        "workingOut": "f'(x) = 0 \\text{ at } x = -1, \\; 3"
      },
      {
        "explanation": "At \\(x = 3\\) the curve touches the axis (double root), so \\(f'\\) does not change sign — a horizontal point of inflexion.",
        "workingOut": "x = 3: \\text{ touch} \\Rightarrow \\text{horizontal inflexion}"
      },
      {
        "explanation": "At \\(x = -1\\) the curve crosses the axis, so it is a turning point.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Use the sector area formula to find \\(\\theta\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Sum the probabilities to find \\(a\\).",
        "workingOut": "15a = 1 \\Rightarrow a = \\frac{1}{15}"
      },
      {
        "explanation": "Apply \\(E(X) = \\sum x\\,P(x)\\).",
        "workingOut": "E(X) = 1(2a) + 2(4a) + 3(8a) = 34a"
      },
      {
        "explanation": "Substitute \\(a\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Integrate \\(f'(x)\\) to find \\(f(x)\\).",
        "workingOut": "f(x) = \\int (3x^2 - 9)\\,dx = x^3 - 9x + C"
      },
      {
        "explanation": "Find the turning points by setting \\(f'(x) = 0\\).",
        "workingOut": "3x^2 - 9 = 0 \\Rightarrow x = \\pm\\sqrt{3}"
      },
      {
        "explanation": "A positive cubic with two turning points has a maximum then a minimum — Option B.",
        "workingOut": "\\text{positive cubic, max then min}"
      },
      {
        "explanation": "Shape of \\(y = x^3 - 9x\\) confirming two turning points.",
        "workingOut": "",
        "graphData": {
          "jsxGraph": {
            "width": 360,
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Find the back-bearing of \\(A\\) from \\(B\\).",
        "workingOut": "60° + 180° = 240°"
      },
      {
        "explanation": "Subtract the bearing of \\(C\\) from \\(B\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "State the cosine rule for \\(AC\\).",
      ...
      },
      {
        ...
        "workingOut": "AC \\approx 2481 \\text{ m}"
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Apply the log-derivative rule with \\(a = 3\\), \\(u = x^2 + 5\\), \\(u' = 2x\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Use \\(\\int \\cos(ax)\\,dx = \\frac{1}{a}\\sin(ax)\\) with \\(a = \\frac{1}{4}\\) (divide by \\(\\frac14\\), i.e. multiply by \\(4\\)).",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Identify the inner function \\(u = x^4 - 3\\), with \\(u' = 4x^3\\).",
        "workingOut": "\\frac{d}{dx}(x^4 - 3) = 4x^3"
      },
      {
        "explanation": "Apply the reverse chain rule (raise power to \\(3\\), divide by \\(3 \\times 4 = 12\\)).",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Rewrite the numerator as \\(\\frac{1}{2}(2x-2)\\) to match the derivative of the denominator.",
        "workingOut": "= \\frac{1}{2}\\int_0^1 \\frac{2x-2}{x^2-2x+5}dx"
      },
      {
        "explanation": "Integrate using \\(\\int\\frac{f'}{f} = \\ln|f|\\).",
        "workingOut": "= \\frac{1}{2}[\\ln(x^2-2x+5)]_0^1"
      },
      {
        "explanation": "Substitute the limits: at \\(x=1\\), \\(4\\); at \\(x=0\\), \\(5\\).",
        "workingOut": "= \\frac{1}{2}(\\ln 4 - \\ln 5)"
      },
      {
        "explanation": "Combine and simplify with a square root.",
        "workingOut": "= \\frac{1}{2}\\ln\\frac{4}{5} = \\ln\\frac{2}{\\sqrt5}"
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "solutionSteps": [
      ...
      {
        "explanation": "Horizontal asymptote as \\(x \\to \\pm\\infty\\).",
        "workingOut": "y = 3"
      },
      {
      ...
      {
        "explanation": "Sketch the hyperbola with asymptotes and intercepts.",
        "workingOut": "",
        "graphData": {
          "jsxGraph": {
            "width": 400,
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Split using log laws.",
      ...
      {
        "explanation": "Evaluate the tangent gradient at \\(x = 1\\).",
        "workingOut": "4 - 1 = 3"
      },
      {
      ...
      },
      {
        ...
        "workingOut": "y = -\\frac{1}{3}(x-1) \\Rightarrow x + 3y - 1 = 0"
      }
    ]
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Group and complete the square (add \\(9\\) for \\(x\\), \\(16\\) for \\(y\\)).",
        "workingOut": "(x^2 - 6x + 9) + (y^2 + 8y + 16) = -9 + 9 + 16"
      },
      {
        "explanation": "Write as perfect squares.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Set the function to zero for \\(x\\)-intercepts.",
        "workingOut": "(x+3)(x-1)^3 = 0 \\Rightarrow x = -3, \\; 1"
      },
      {
        "explanation": "Substitute \\(x = 0\\) for the \\(y\\)-intercept.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Differentiate with the product rule.",
        "workingOut": "f'(x) = (x-1)^3 + (x+3)\\cdot 3(x-1)^2"
      },
      {
        "explanation": "Factor out \\((x-1)^2\\) and simplify.",
        "workingOut": "= (x-1)^2(4x + 8) = 4(x-1)^2(x+2)"
      },
      {
        "explanation": "Differentiate again, factor out \\((x-1)\\).",
        "workingOut": "f''(x) = 4(x-1)[2(x+2)+(x-1)] = 4(x-1)(3x+3)"
      },
      {
        "explanation": "Simplify.",
        "workingOut": "= 12(x-1)(x+1)"
      }
    ]
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Find the stationary points.",
      ...
      {
        "explanation": "Test \\(x = -2\\) with the second derivative.",
        "workingOut": "f''(-2) = 12(-3)(-1) = 36 > 0 \\Rightarrow \\text{min}"
      },
      {
        "explanation": "At \\(x = 1\\), \\(f''(1) = 0\\); a concavity table shows a sign change, so it is a horizontal inflexion.",
        "workingOut": "(-2,-27)\\text{ min}, \\; (1,0)\\text{ horizontal inflexion}"
      }
    ]
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Find candidate inflection points where \\(f''(x) = 0\\).",
        "workingOut": "12(x-1)(x+1) = 0 \\Rightarrow x = 1, \\; -1"
      },
      {
        "explanation": "Find \\(f(-1)\\) and confirm a concavity change there.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Collect the features from parts (a), (c) and (d).",
        "workingOut": "(-3,0),(1,0),(0,-3),(-2,-27)\\text{ min}"
      },
      {
        "explanation": "Note the end behaviour of a positive quartic.",
        "workingOut": "x \\to \\pm\\infty \\Rightarrow f(x) \\to +\\infty"
      },
      {
        "explanation": "Sketch through all key points.",
        "workingOut": "",
        "graphData": {
          "jsxGraph": {
            "width": 400,
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Identify the horizontal dilation from the factor \\(2\\).",
        "workingOut": "\\text{horizontal dilation, factor } \\tfrac{1}{2}"
      },
      {
        "explanation": "Identify the horizontal translation.",
        "workingOut": "\\text{translation } \\tfrac{1}{4} \\text{ right}"
      },
      {
        "explanation": "State the order: dilation first, then translation.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Apply the mapping \\(x \\mapsto \\frac{x}{2} + \\frac{1}{4}\\) (dilation then shift); \\(y\\)-values unchanged.",
      ...
      {
        "explanation": "Transform the minimum and inflection.",
        "workingOut": "(-2,-27)\\to(-\\tfrac34,-27); \\; (-1,-16)\\to(-\\tfrac14,-16)"
      },
      {
        "explanation": "Sketch the transformed quartic.",
        "workingOut": "",
        "graphData": {
          "jsxGraph": {
            "width": 400,
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "The yearly growths form a GP with \\(a = 40\\), \\(r = 0.8\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Since \\(|r| = 0.8 < 1\\), the total growth has a limiting sum.",
        "workingOut": "S_\\infty = \\frac{40}{1 - 0.8} = 200 \\text{ cm}"
      },
      {
        "explanation": "Add the initial height.",
        "workingOut": "60 + 200 = 260 \\text{ cm}"
      },
      {
        "explanation": "Compare with \\(3\\) m \\(= 300\\) cm.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "A height of \\(250\\) cm requires growth of \\(250 - 60 = 190\\) cm.",
        "workingOut": "\\text{growth needed} = 190 \\text{ cm}"
      },
      {
        "explanation": "Set the GP sum equal to \\(190\\).",
        "workingOut": "\\frac{40(1 - 0.8^n)}{0.2} = 190 \\Rightarrow 0.8^n = 0.05"
      },
      {
        "explanation": "Take logarithms and solve.",
        "workingOut": "n = \\frac{\\ln 0.05}{\\ln 0.8} \\approx 13.4"
      },
      {
        "explanation": "Round up to the year.",
        "workingOut": "\\text{14th year}"
      }
    ]
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Substitute \\(t = 0\\) (\\(e^0 = 1\\)).",
        "workingOut": "C_0 = 8"
      },
      {
        "explanation": "Substitute \\(t = 1\\), \\(C = 3\\).",
        "workingOut": "3 = 8e^{-k} \\Rightarrow e^{-k} = \\frac{3}{8}"
      },
      {
        "explanation": "Take logarithms.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Set the concentration to the threshold.",
        "workingOut": "0.5 = 8e^{-kt} \\Rightarrow e^{-kt} = \\frac{1}{16}"
      },
      {
        "explanation": "Take logarithms; with \\(k = -\\ln\\frac{3}{8}\\), solve for \\(t\\).",
        "workingOut": "t = \\frac{\\ln(1/16)}{\\ln(3/8)} \\approx 2.83 \\text{ years}"
      },
      {
        "explanation": "Convert the decimal part to months (\\(0.83 \\times 12 \\approx 10\\)).",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Each throw is win (W, game ends) or miss (W'). Play continues only along miss branches.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Bo wins on his first throw.",
        "workingOut": "P_1 = \\frac{1}{20}"
      },
      {
        "explanation": "Bo wins on his second throw: Bo misses, Cara misses, Bo hits.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Bo's winning probabilities form a geometric series.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Set the two \\(y\\)-values equal.",
        "workingOut": "6e^{-x} = e^x - 1"
      },
      {
        "explanation": "Multiply by \\(e^x\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      ...
      {
        "explanation": "Reject \\(u = -2\\) since \\(e^x > 0\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Acceleration is the gradient of the velocity–time graph.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Speed \\(= |v|\\) increases when \\(v\\) and \\(a\\) have the same sign.",
        "workingOut": "\\text{speed} \\uparrow \\iff v, a \\text{ same sign}"
      },
      {
        "explanation": "On \\(0 < t < 2\\), velocity is positive and rising.",
        "workingOut": "0 < t < 2: \\; v > 0, \\; a > 0"
      },
      {
        "explanation": "On \\(4 < t < 6\\), velocity is negative and falling.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Differentiate velocity to get acceleration.",
  ...
  },
  {
    ...
    "solutionSteps": [
      ...
      {
        "explanation": "Apply \\(x = 0\\) at \\(t = 0\\).",
        "workingOut": "C = 0"
      },
      {
        "explanation": "State the displacement.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Set velocity to zero.",
        "workingOut": "\\frac{6}{1+t} - t = 0"
      },
      {
        "explanation": "Multiply by \\((1+t)\\).",
        "workingOut": "6 = t(1+t) \\Rightarrow t^2 + t - 6 = 0"
      },
      {
        "explanation": "Factorise and reject the negative root.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "The particle reverses direction at \\(t = 2\\), so compute displacements at \\(t = 0, 2, 3\\).",
        "workingOut": "x(0) = 0"
      },
      {
        "explanation": "Find \\(x(2)\\).",
        "workingOut": "x(2) = 6\\ln 3 - 2 \\approx 4.592"
      },
      {
        "explanation": "Find \\(x(3)\\).",
        "workingOut": "x(3) = 6\\ln 4 - 4.5 \\approx 3.818"
      },
      {
        "explanation": "Add the distance of each leg (out then back).",
        "workingOut": "d = 4.592 + (4.592 - 3.818) \\approx 5.37 \\text{ m}"
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Differentiate \\(V\\) with the chain rule.",
        "workingOut": "\\frac{dV}{dt} = -140\\left(1 - \\frac{t}{70}\\right)"
      },
      {
        "explanation": "Substitute \\(t = 14\\).",
        "workingOut": "= -140\\left(1 - \\frac{14}{70}\\right) = -140\\cdot\\frac{4}{5}"
      },
      {
        "explanation": "Evaluate (negative = draining).",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Write the magnitude of the drain rate.",
        "workingOut": "\\left|\\frac{dV}{dt}\\right| = 140\\left(1 - \\frac{t}{70}\\right)"
      },
      {
        "explanation": "It decreases with \\(t\\), so the maximum is at \\(t = 0\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Sine ranges from \\(-1\\) to \\(1\\); amplitude \\(8\\), shift \\(15\\).",
        "workingOut": "-1 \\le \\sin(nx + 1) \\le 1"
      },
      {
        "explanation": "Maximum when \\(\\sin = 1\\).",
        "workingOut": "T_{\\max} = 8 + 15 = 23°"
      },
      {
        "explanation": "Minimum when \\(\\sin = -1\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Set the period formula equal to \\(12\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "The minimum occurs when the sine equals \\(-1\\), i.e. argument \\(= \\frac{3\\pi}{2}\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      ...
      {
        "explanation": "Sketch the sine curve over \\(1 \\le x \\le 12\\).",
        "workingOut": "",
        "graphData": {
          "jsxGraph": {
            "width": 440,
  ...
  },
  {
    ...
    "solutionSteps": [
      ...
      {
        "explanation": "The skated distance is \\(8\\) minus the two horizontal offsets.",
        "workingOut": "BC = 8 - 3\\tan\\theta"
      },
      {
        "explanation": "Time skated \\(= \\frac{BC}{15}\\).",
        "workingOut": "\\text{time skated} = \\frac{8 - 3\\tan\\theta}{15} = \\frac{8}{15} - \\frac{\\tan\\theta}{5}"
      },
      {
        "explanation": "Add the times.",
        "workingOut": "T = \\frac{3}{5\\cos\\theta} + \\frac{8}{15} - \\frac{\\tan\\theta}{5}"
      }
    ]
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Differentiate \\(T\\) using the chain rule on \\(\\frac{3}{5}\\sec\\theta\\) and \\(-\\frac{1}{5}\\tan\\theta\\).",
        "workingOut": "\\frac{dT}{d\\theta} = \\frac{3\\sin\\theta}{5\\cos^2\\theta} - \\frac{\\sec^2\\theta}{5}"
      },
      {
        "explanation": "Factor out \\(\\frac{1}{5\\cos^2\\theta}\\) (always positive).",
        "workingOut": "= \\frac{1}{5\\cos^2\\theta}(3\\sin\\theta - 1)"
      },
      {
        "explanation": "Set \\(\\frac{dT}{d\\theta} = 0\\).",
      ...
      {
        "explanation": "Confirm a minimum with a table of slopes (gradient \\(-,0,+\\)).",
        "workingOut": "\\text{minimum at } \\theta \\approx 19°28'"
      }
    ]
  }
];
