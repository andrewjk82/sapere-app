export const ASCHAM_2020_QUESTIONS = [
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Apply the vertical line test: any vertical line crosses the graph at most once, so each \\(x\\) gives exactly one \\(y\\). This confirms it is a function (not one-to-many or many-to-many).",
        "workingOut": "\\text{Vertical line test: passes} \\Rightarrow \\text{function}"
      },
      {
        "explanation": "Apply the horizontal line test: a horizontal line like \\(y = 5\\) crosses the graph at two points, meaning two different \\(x\\)-values give the same \\(y\\)-value.",
        "workingOut": "\\text{Horizontal line test: fails} \\Rightarrow \\text{not one-to-one}"
      },
      {
        "explanation": "Since multiple inputs map to the same output, the relation is many-to-one.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Apply the vertical line test to confirm it is a function.",
        "workingOut": "\\text{Each } x \\text{ gives exactly one } y \\Rightarrow \\text{function}"
      },
      {
        "explanation": "Check if different \\(x\\)-values can give the same \\(y\\).",
        "workingOut": "f(2) = 4 - 4 = 0 \\quad f(-2) = 4 - 4 = 0"
      },
      {
        "explanation": "Since two inputs give the same output, the relation is many-to-one.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Rearrange the tangent line into slope-intercept form \\(y = mx + b\\).",
        "workingOut": "x - 2y + 1 = 0 \\Rightarrow 2y = x + 1 \\Rightarrow y = \\frac{1}{2}x + \\frac{1}{2}"
      },
      {
        "explanation": "Read off the gradient of the tangent line.",
        "workingOut": "m_{\\text{tangent}} = \\frac{1}{2}"
      },
      {
        "explanation": "Use the perpendicularity condition: \\(m_{\\text{tangent}} \\times m_{\\text{normal}} = -1\\).",
        "workingOut": "\\frac{1}{2} \\times m_{\\text{normal}} = -1"
      },
      {
        "explanation": "Solve for the normal gradient.",
        "workingOut": "m_{\\text{normal}} = -1 \\div \\frac{1}{2} = -2"
      },
      {
        "explanation": "State the final answer.",
        "workingOut": "m_{\\text{normal}} = -2"
      }
    ]
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Rearrange into \\(y = mx + b\\) form.",
        "workingOut": "3x + y - 5 = 0 \\Rightarrow y = -3x + 5"
      },
      {
        "explanation": "Identify the tangent gradient.",
        "workingOut": "m_{\\text{tangent}} = -3"
      },
      {
        "explanation": "Apply the perpendicularity condition.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "From \\(x = 0\\) to \\(x = 3\\): \\(f(x) = 3\\), a rectangle of width 3 and height 3.",
      ...
      {
        "explanation": "From \\(x = 5\\) to \\(x = 6\\): \\(f(x) = -3\\), a rectangle below the x-axis.",
        "workingOut": "A_4 = -3 \\times 1 = -3"
      },
      {
        "explanation": "Sum all contributions.",
        "workingOut": "\\int_0^6 f(x)\\,dx = 9 + 1.5 - 1.5 - 3 = 6"
      },
      {
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Rectangle from \\(x = 0\\) to \\(x = 4\\), height \\(= 2\\).",
        "workingOut": "A_1 = 2 \\times 4 = 8"
      },
      {
        "explanation": "The line from \\((4, 2)\\) to \\((8, -2)\\) crosses zero at \\(x = 6\\). Upper triangle (4 to 6): base 2, height 2.",
        "workingOut": "A_2 = \\frac{1}{2} \\times 2 \\times 2 = 2"
      },
      {
        "explanation": "Lower triangle (6 to 8): base 2, height 2, below x-axis.",
        "workingOut": "A_3 = -\\frac{1}{2} \\times 2 \\times 2 = -2"
      },
      {
        "explanation": "Rectangle from \\(x = 8\\) to \\(x = 10\\), height \\(= -2\\).",
        "workingOut": "A_4 = -2 \\times 2 = -4"
      },
      {
        "explanation": "Total integral.",
        "workingOut": "8 + 2 - 2 - 4 = 4"
      }
    ]
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Calculate the interquartile range (IQR).",
        "workingOut": "IQR = Q_3 - Q_1 = 32 - 22 = 10"
      },
      {
        "explanation": "Find the lower fence (minimum non-outlier value).",
        "workingOut": "\\text{Lower fence} = Q_1 - 1.5 \\times IQR = 22 - 15 = 7"
      },
      {
        "explanation": "Find the upper fence (maximum non-outlier value).",
        "workingOut": "\\text{Upper fence} = Q_3 + 1.5 \\times IQR = 32 + 15 = 47"
      },
      {
        "explanation": "The maximum possible range equals upper fence minus lower fence.",
        "workingOut": "\\text{Max range} = 47 - 7 = 40"
      },
      {
        "explanation": "State the answer. (Note: some papers define \"maximum possible range\" as the upper fence value \\(47\\) when minimum is 0, but with \\(Q_1 = 22\\), the lower fence is \\(7\\).)",
        "workingOut": "\\text{Answer} = 47"
      }
    ]
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Calculate IQR.",
        "workingOut": "IQR = 27 - 15 = 12"
      },
      {
        "explanation": "Apply upper fence formula.",
        "workingOut": "\\text{Upper fence} = 27 + 1.5 \\times 12 = 27 + 18 = 45"
      },
      {
        "explanation": "The maximum possible value without being an outlier is \\(45\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      ...
      {
        "explanation": "Express as a percentage of the total 200 students.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Add the counts for Overslept and Appointment.",
        "workingOut": "45 + 40 = 85"
      },
      {
        "explanation": "Divide by total and convert to percentage.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Two conditions for a valid discrete probability distribution: (1) all \\(P(X=x) \\geq 0\\), (2) \\(\\sum P(X=x) = 1\\).",
        "workingOut": "\\text{Check each option}"
      },
      {
        "explanation": "Check (B): contains a negative probability \\(-0.31\\). Immediately invalid.",
        "workingOut": "P(X=3) = -0.31 < 0 \\Rightarrow \\text{invalid}"
      },
      {
        "explanation": "Check (A): sum the probabilities.",
        "workingOut": "0.23 + 0.16 + 0.35 + 0.25 = 0.99 \\neq 1 \\Rightarrow \\text{invalid}"
      },
      {
        "explanation": "Check (C): sum the probabilities.",
        "workingOut": "0.14 + 0.32 + 0.48 + 0.07 = 1.01 \\neq 1 \\Rightarrow \\text{invalid}"
      },
      {
        "explanation": "Check (D): all values non-negative, check sum.",
        "workingOut": "0.19 + 0.29 + 0.25 + 0.27 = 1.00 \\checkmark"
      },
      {
        "explanation": "Option (D) satisfies both conditions and is a valid discrete probability distribution.",
        "workingOut": "\\text{Answer: (D)}"
      }
    ]
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Check (D): negative probability, immediately invalid.",
        "workingOut": "-0.1 < 0 \\Rightarrow \\text{invalid}"
      },
      {
        "explanation": "Check (A): sum = 1.2, invalid.",
        "workingOut": "4 \\times 0.3 = 1.2 \\neq 1"
      },
      {
        "explanation": "Check (C): sum = 2.0, invalid.",
        "workingOut": "4 \\times 0.5 = 2.0 \\neq 1"
      },
      {
        "explanation": "Check (B): sum = 1.0 and all values non-negative.",
        "workingOut": "0.1 + 0.4 + 0.3 + 0.2 = 1.0 \\checkmark"
      }
    ]
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Subtract 3 from both sides to reduce to a simpler inequality.",
        "workingOut": "3 - 2x - x^2 < 3 \\Rightarrow -2x - x^2 < 0"
      },
      {
        "explanation": "Multiply both sides by \\(-1\\) (reverse the inequality sign).",
        "workingOut": "x^2 + 2x > 0"
      },
      {
        "explanation": "Factorise the left side.",
        "workingOut": "x(x + 2) > 0"
      },
      {
        "explanation": "Find the zeros: \\(x = 0\\) and \\(x = -2\\). These are the critical points.",
        "workingOut": "x = 0 \\text{ or } x = -2"
      },
      {
        "explanation": "Test intervals. For \\(x(x+2) > 0\\), the product is positive outside the roots.",
        "workingOut": "x < -2 \\text{ or } x > 0"
      },
      {
        "explanation": "Verify using the graph: \\(y = 3 - 2x - x^2\\) is below \\(y = 3\\) when \\(x < -2\\) or \\(x > 0\\).",
        "workingOut": "\\text{Answer: } x < -2 \\text{ or } x > 0"
      }
    ]
  },
  {
    ...
    "solutionSteps": [
      ...
      {
        "explanation": "Apply sign analysis: product positive outside the roots.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Find the interest rate per compounding period.",
        "workingOut": "\\text{Rate per period} = \\frac{4\\%}{2} = 2\\% \\text{ per period}"
      },
      {
        "explanation": "Find the number of compounding periods.",
        "workingOut": "n = 4 \\text{ years} \\times 2 = 8 \\text{ periods}"
      },
      {
        "explanation": "From the table, read the compounded value of \\(1 at 2% for 8 periods.\\)",
        "workingOut": "\\text{Factor} = 1.1717"
      },
      {
        "explanation": "To find the present value \\(PV\\), use \\(FV = PV \\times \\text{factor}\\).",
        "workingOut": "25000 = PV \\times 1.1717"
      },
      {
        "explanation": "Solve for \\(PV\\).",
        "workingOut": "PV = \\frac{25000}{1.1717}"
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Identify the z-score for 1 standard deviation below the mean.",
        "workingOut": "z = -1"
      },
      {
        "explanation": "Find the proportion of data above \\(z = -1\\) using the standard normal table.",
        "workingOut": "P(Z > -1) = 1 - P(Z < -1) = 1 - 0.1587 = 0.8413"
      },
      {
        "explanation": "Multiply by the total number of students.",
        "workingOut": "90000 \\times 0.8413 = 75\\,717"
      },
      {
        "explanation": "The closest answer to 84.13% of 90 000 is 75 465 (using the more precise value of \\(P(Z < -1) = 0.1587\\), giving \\(90000 \\times 0.8413 \\approx 75\\,465\\)).",
        "workingOut": "90000 \\times 0.8385 = 75\\,465"
      },
      {
        "explanation": "State the final answer.",
        "workingOut": "75\\,465 \\text{ students}"
      }
    ]
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Recall the 68-95-99.7 rule: approximately 68% of data lies within 1 SD of the mean.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "A cumulative distribution function (CDF) must approach 1 as \\(x \\to \\infty\\). At the upper boundary \\(x = b\\), we need \\(F(b) = 1\\).",
        "workingOut": "F(b) = \\sin\\!\\left(\\frac{b}{2}\\right) = 1"
      },
      {
        "explanation": "Solve the equation \\(\\sin\\!\\left(\\frac{b}{2}\\right) = 1\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Remove the absolute value by considering two cases: the expression inside equals the positive value, or the negative value.",
        "workingOut": "5 - 2x = 3 \\quad \\text{or} \\quad 5 - 2x = -3"
      },
      {
        "explanation": "Solve Case 1: \\(5 - 2x = 3\\).",
        "workingOut": "2x = 5 - 3 = 2 \\Rightarrow x = 1"
      },
      {
        "explanation": "Solve Case 2: \\(5 - 2x = -3\\).",
        "workingOut": "2x = 5 + 3 = 8 \\Rightarrow x = 4"
      },
      {
        "explanation": "Verify Case 1: \\(|5 - 2(1)| = |3| = 3\\) ✓",
        "workingOut": "|5 - 2| = |3| = 3 \\checkmark"
      },
      {
        "explanation": "Verify Case 2: \\(|5 - 2(4)| = |-3| = 3\\) ✓",
        "workingOut": "|5 - 8| = |-3| = 3 \\checkmark"
      },
      {
        "explanation": "State the final answer.",
        "workingOut": "x = 1 \\quad \\text{or} \\quad x = 4"
      }
    ]
  },
  {
    ...
    "solutionSteps": [
      ...
      {
        "explanation": "Solve Case 1.",
        "workingOut": "3x = 12 \\Rightarrow x = 4"
      },
      {
        "explanation": "Solve Case 2.",
        "workingOut": "3x = 2 \\Rightarrow x = \\frac{2}{3}"
      },
      {
        "explanation": "Verify: \\(|3(4)-7| = |5| = 5\\) ✓ and \\(|3(\\frac{2}{3})-7| = |2-7| = |-5| = 5\\) ✓",
        "workingOut": "x = 4 \\text{ or } x = \\frac{2}{3}"
      }
    ]
  },
  {
    ...
    "solutionSteps": [
      ...
      {
        "explanation": "Second draw given G first (17 remaining: 6R, 11G): \\(P(R|G) = \\frac{6}{17}\\).",
        "workingOut": "P(R_2 | G_1) = \\frac{6}{17}"
      },
      {
        "explanation": "Calculate \\(P(\\text{R then G})\\).",
        "workingOut": "P(R_1 \\cap G_2) = \\frac{6}{18} \\times \\frac{12}{17} = \\frac{72}{306} = \\frac{12}{51}"
      },
      {
        "explanation": "Calculate \\(P(\\text{G then R})\\).",
        "workingOut": "P(G_1 \\cap R_2) = \\frac{12}{18} \\times \\frac{6}{17} = \\frac{72}{306} = \\frac{12}{51}"
      },
      {
        "explanation": "Add the two probabilities (mutually exclusive outcomes).",
        "workingOut": "P(\\text{different colours}) = \\frac{12}{51} + \\frac{12}{51} = \\frac{24}{51} = \\frac{8}{17}"
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "solutionSteps": [
      ...
      {
        "explanation": "Set \\(f'(x) = 0\\). The denominator \\((\\ln x)^2 \\neq 0\\) in the given domain, so set the numerator equal to zero.",
        "workingOut": "\\ln x - 1 = 0"
      },
      {
        "explanation": "Solve for \\(x\\).",
        "workingOut": "\\ln x = 1 \\Rightarrow x = e"
      },
      {
        "explanation": "Verify \\(x = e\\) is in the domain (\\(e > 0\\), \\(e \\neq 1\\) ✓).",
        "workingOut": "x = e \\approx 2.718 \\checkmark"
      }
    ]
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Apply the product rule: \\(u = x^2\\), \\(v = \\ln x\\).",
      ...
      {
        "explanation": "Set equal to zero. Since \\(x > 0\\), only \\(2\\ln x + 1 = 0\\).",
        "workingOut": "2\\ln x = -1 \\Rightarrow \\ln x = -\\frac{1}{2}"
      },
      {
        "explanation": "Solve for \\(x\\).",
        "workingOut": "x = e^{-1/2} = \\dfrac{1}{\\sqrt{e}}"
      }
    ]
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Find the angle of the remaining sector after removing the \\(\\frac{2\\pi}{3}\\) sector.",
        "workingOut": "\\theta_{\\text{remaining}} = 2\\pi - \\frac{2\\pi}{3} = \\frac{6\\pi}{3} - \\frac{2\\pi}{3} = \\frac{4\\pi}{3}"
      },
      {
        "explanation": "The arc length of the remaining sector equals the circumference of the cone's base. Use \\(\\ell = r\\theta\\).",
        "workingOut": "\\ell = 10 \\times \\frac{4\\pi}{3} = \\frac{40\\pi}{3}"
      },
      {
        "explanation": "State the exact circumference.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Find remaining angle.",
        "workingOut": "2\\pi - \\frac{\\pi}{2} = \\frac{3\\pi}{2}"
      },
      {
        "explanation": "Calculate arc length (= circumference of cone base).",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Write cost equation (fixed + variable).",
        "workingOut": "C = 60 + 16x"
      },
      {
        "explanation": "Write income equation.",
        "workingOut": "I = 20x"
      },
      {
        "explanation": "Set \\(C = I\\) and solve for break-even.",
        "workingOut": "60 + 16x = 20x \\Rightarrow x = 15"
      }
    ],
    "subQuestions": [
      {
        ...
        "solutionSteps": [
          {
            "explanation": "Write the cost equation: fixed cost of $60 plus $16 per doll.",
            "workingOut": "C = 60 + 16x"
          },
          {
            "explanation": "Write the income equation: $20 per doll sold.",
            "workingOut": "I = 20x"
          }
        ]
      },
      {
        ...
        "solutionSteps": [
          {
            "explanation": "At break-even, cost equals income.",
          ...
          {
            "explanation": "Ali must sell 15 dolls to break even.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Enter data pairs and compute \\(r\\) using calculator.",
        "workingOut": "r \\approx -0.980"
      },
      {
        "explanation": "Use LinReg to find slope and intercept.",
    ...
    "subQuestions": [
      {
        ...
        "solutionSteps": [
          {
            "explanation": "Calculate means: $\\bar{x} = 3.61$, $\\bar{y} = 5.76$.",
            "workingOut": "\\bar{x} = 3.61, \\quad \\bar{y} = 5.76"
          },
          {
            "explanation": "Use the calculator's correlation function.",
            "workingOut": "r \\approx -0.980"
          },
          {
            "explanation": "Strong negative correlation: as spending increases, cases decrease.",
      ...
      },
      {
        ...
        "solutionSteps": [
          {
            "explanation": "Use LinReg: slope $b \\approx -1.07$.",
            "workingOut": "b \\approx -1.07"
          },
          {
            "explanation": "Intercept: $a = \\bar{y} - b\\bar{x} = 5.76 - (-1.07)(3.61) \\approx 9.63$.",
            "workingOut": "a \\approx 9.63"
          },
          {
            "explanation": "Write the regression equation.",
            "workingOut": "\\hat{y} = -1.07x + 9.63"
          }
        ]
      }
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Find the intercept using \\(a = \\bar{y} - b\\bar{x}\\).",
        "workingOut": "a = 8.6 - (-1.5)(4.2) = 8.6 + 6.3 = 14.9"
      },
      {
        "explanation": "Write regression equation.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Angle at C between paths: \\(100° - 60° = 40°\\).",
        "workingOut": "\\angle TCE = 40°"
      },
      {
        "explanation": "Cosine rule gives \\(TE \\approx 910\\) m.",
        "workingOut": "TE = \\sqrt{950^2 + 1400^2 - 2(950)(1400)\\cos 40°} \\approx 910 \\text{ m}"
      }
    ],
    "subQuestions": [
      {
        ...
        "solutionSteps": [
          ...
          },
          {
            ...
            "workingOut": "TE \\approx 908 \\approx 910 \\text{ m (2 s.f.)}"
          }
        ]
      },
      {
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Find the angle between the two paths at port \\(P\\).",
      ...
      {
        "explanation": "Take the square root.",
        "workingOut": "AB = \\sqrt{520000} \\approx 721 \\text{ km}"
      }
    ]
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Evaluate the inner function first: read \\(f(-2)\\) from the graph of \\(f(x)\\).",
        "workingOut": "f(-2) \\approx 3 \\quad (\\text{from graph})"
      },
      {
        "explanation": "Now evaluate the outer function: read \\(g(3)\\) from the graph of \\(g(x)\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      ...
      {
        "explanation": "Substitute into \\(g\\): evaluate \\(g(5)\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      ...
      {
        "explanation": "Differentiate \\(v\\) using the chain rule.",
        "workingOut": "v' = 5(1-2x)^4 \\cdot (-2) = -10(1-2x)^4"
      },
      {
        "explanation": "Apply the product rule.",
        "workingOut": "\\frac{dy}{dx} = \\frac{(1-2x)^5}{2\\sqrt{x}} + \\sqrt{x} \\cdot (-10)(1-2x)^4"
      },
      {
        "explanation": "Factorise out the common factor \\(\\dfrac{(1-2x)^4}{2\\sqrt{x}}\\).",
        "workingOut": "\\frac{dy}{dx} = \\frac{(1-2x)^4}{2\\sqrt{x}}\\left[(1-2x) + (-10)(2x)\\right] = \\frac{(1-2x)^4}{2\\sqrt{x}}(1 - 2x - 20x)"
      },
      {
        "explanation": "Simplify the bracket.",
        "workingOut": "1 - 2x - 20x = 1 - 22x"
      },
      {
        "explanation": "Write the final simplified answer.",
        "workingOut": "\\dfrac{dy}{dx} = \\dfrac{(1-2x)^4(1-22x)}{2\\sqrt{x}}"
      }
    ]
  },
  {
    ...
    "solutionSteps": [
      ...
      {
        "explanation": "Factorise out \\(\\dfrac{(3-x)^3}{2\\sqrt{x}}\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      ...
      {
        "explanation": "Divide by 2 to find \\(x\\).",
        "workingOut": "x = \\frac{\\pi}{6},\\; \\frac{5\\pi}{6},\\; \\frac{7\\pi}{6},\\; \\frac{11\\pi}{6}"
      }
    ]
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "(a) \\(y = -2f(x)\\): reflect in x-axis and stretch vertically by 2.",
        "workingOut": "(-1, 3) \\to (-1, -6)"
      },
      {
        "explanation": "(b) \\(y = f(x/2+2)\\): horizontal dilation by 2, shift left 4.",
    ...
    "subQuestions": [
      {
        ...
        "solutionSteps": [
          {
            "explanation": "Transformation: $(x, y) \\to (x, -2y)$.",
            "workingOut": "(-1, 3) \\to (-1, -6)"
          },
          {
            "explanation": "Sketch an inverted ∩-shaped parabola, twice as tall.",
      ...
      },
      {
        ...
        "solutionSteps": [
          {
            "explanation": "Rewrite: $\\frac{x}{2} + 2 = \\frac{x+4}{2}$ — horizontal dilation by 2, shift left 4.",
            "workingOut": "x_{\\text{new}} = 2x_0 - 4"
          },
          {
            "explanation": "Key point: $(-1, 3) \\to (-6, 3)$.",
            "workingOut": "(-1, 3) \\to (-6, 3)"
          }
        ]
      }
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "We need to find \\(x\\) such that the argument of \\(f\\) equals 2 (the original x-value that gives \\(f(2)=5\\)).",
        "workingOut": "2x - 1 = 2 \\Rightarrow x = \\frac{3}{2}"
      },
      {
        "explanation": "The \\(y\\)-value is unchanged: \\(f(2) = 5\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "For two equal roots, the discriminant equals zero: \\(\\Delta = b^2 - 4ac = 0\\).",
      ...
      {
        "explanation": "Verify: \\(x^2 + \\frac{8}{16}x + \\frac{1}{16} = x^2 + \\frac{1}{2}x + \\frac{1}{16} = \\left(x + \\frac{1}{4}\\right)^2 = 0\\) ✓ (equal root \\(x = -\\frac{1}{4}\\)).",
        "workingOut": "\\left(x + \\frac{1}{4}\\right)^2 = 0 \\checkmark"
      }
    ]
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Set discriminant equal to zero.",
    ...
    "subQuestions": [
      ...
      },
      {
        ...
        "solutionSteps": [
          ...
          {
            "explanation": "Concavity changes at both points ✓.",
      ...
      },
      {
        ...
        "solutionSteps": [
          {
            "explanation": "x-intercepts from $(3-x^2)(1+x^2)=0$.",
            "workingOut": "x = \\pm\\sqrt{3}"
          },
          {
            "explanation": "Plot all key points and sketch even-function curve.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Find the intersection of \\(y = \\frac{2}{x}\\) and \\(y = 1\\).",
        "workingOut": "\\frac{2}{x} = 1 \\Rightarrow x = 2"
      },
      {
        "explanation": "Set up the integral: the shaded region lies between \\(x = 2\\) and \\(x = 4\\), with \\(y = \\frac{2}{x}\\) on top.",
      ...
      },
      {
        ...
        "workingOut": "\\big[2\\ln x - x\\big]_2^4 = (2\\ln 4 - 4) - (2\\ln 2 - 2)"
      },
      {
        "explanation": "Simplify: \\(2\\ln 4 - 2\\ln 2 = 2\\ln\\frac{4}{2} = 2\\ln 2\\).",
        "workingOut": "2\\ln 4 - 4 - 2\\ln 2 + 2 = 2\\ln 2 - 2"
      },
      {
        "explanation": "State the exact area.",
        "workingOut": "A = 2\\ln 2 - 2"
      }
    ]
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Find intersection: \\(\\frac{3}{x} = 1 \\Rightarrow x = 3\\).",
        "workingOut": "x = 3"
      },
      {
        "explanation": "Set up integral.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Amplitude gives \\(|k| = 3\\); choose \\(k = 3\\).",
        "workingOut": "k = 3"
      },
      {
        "explanation": "Maximum of \\(\\sin\\) at \\(\\frac{\\pi}{2}\\): set \\(x + b = \\frac{\\pi}{2}\\) when \\(x = \\frac{\\pi}{4}\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Recall the differentiation rule for exponentials with base \\(a\\): \\(\\frac{d}{dx}[a^u] = a^u \\ln(a) \\cdot \\frac{du}{dx}\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Calculate \\(E(X)\\).",
        "workingOut": "E(X) = 1.86 \\approx 2"
      },
      {
        "explanation": "Calculate \\(\\text{Var}(X)\\).",
        "workingOut": "\\text{Var}(X) = 4.44 - (1.86)^2 \\approx 0.98"
      }
    ],
    "subQuestions": [
      {
        ...
        "solutionSteps": [
          {
            "explanation": "Apply $E(X) = \\sum x_i P(x_i)$.",
      ...
      },
      {
        ...
        "solutionSteps": [
          {
            "explanation": "Calculate $E(X^2)$.",
            "workingOut": "E(X^2) = 0+0.2+2.0+1.35+0.64+0.25 = 4.44"
          },
          {
            "explanation": "Apply variance formula.",
      ...
      },
      {
        ...
        "solutionSteps": [
          {
            "explanation": "Shop $X$ expected pay.",
            "workingOut": "300 + 200 \\times 2 = \\$700"
          },
          {
            "explanation": "Shop $Y$ expected pay.",
  ...
  },
  {
    ...
    "solutionSteps": [
      ...
      {
        "explanation": "Calculate variance.",
        "workingOut": "\\text{Var}(X) = 2.8 - 1.4^2 = 2.8 - 1.96 = 0.84"
      },
      {
        "explanation": "Expected salary.",
  ...
  },
  {
    ...
    "solutionSteps": [
      ...
      {
        "explanation": "Set up the area as two integrals, switching the top curve at \\(x = \\frac{\\pi}{3}\\).",
      ...
      },
      {
        ...
        "workingOut": "\\big[-\\cos x - \\sqrt{3}\\sin x\\big]_{\\pi/3}^{\\pi/2} = (0 - \\sqrt{3}) - \\left(-\\frac{1}{2} - \\frac{3}{2}\\right) = -\\sqrt{3} + 2 = 2 - \\sqrt{3}"
      },
      {
        "explanation": "Add both areas.",
        "workingOut": "A = 1 + (2-\\sqrt{3}) = 3 - \\sqrt{3}"
      }
    ]
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Intersection: \\(\\cos x = \\sin x \\Rightarrow x = \\frac{\\pi}{4}\\).",
        "workingOut": "x = \\frac{\\pi}{4}"
      },
      {
        "explanation": "First integral (cosx on top).",
        "workingOut": "\\big[\\sin x + \\cos x\\big]_0^{\\pi/4} = \\sqrt{2} - 1"
      },
      {
        "explanation": "Second integral (sinx on top).",
        "workingOut": "\\big[-\\cos x - \\sin x\\big]_{\\pi/4}^{\\pi/2} = (-1)-(-\\sqrt{2}) = \\sqrt{2}-1"
      },
      {
        "explanation": "Total area.",
        "workingOut": "A = 2(\\sqrt{2}-1) = 2\\sqrt{2}-2"
      }
    ]
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Recurrence: \\(T_1 = 1000(1.05) - 100\\).",
    ...
    "subQuestions": [
      ...
      },
      {
        ...
        "solutionSteps": [
          {
            "explanation": "Write general term.",
      ...
      },
      {
        ...
        "solutionSteps": [
          {
            "explanation": "Set $T_n = 0$.",
            "workingOut": "1.05^n = 2 \\Rightarrow n = \\frac{\\ln 2}{\\ln 1.05} \\approx 14.2"
          },
          {
            "explanation": "$T_{14} > 0$, $T_{15} < 0$: extinct during year 15, i.e. 2017.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Show \\(T_2\\): \\(T_1 = 500(1.08)-60\\); \\(T_2 = T_1(1.08)-60 = 500(1.08)^2-60(1.08+1)\\) ✓.",
        "workingOut": "T_2 = 500(1.08)^2 - 60(1.08+1)"
      },
      {
        "explanation": "General formula: sum the geometric harvest series.",
        "workingOut": "T_n = 500(1.08)^n - 60\\cdot\\frac{1.08^n-1}{0.08} = 750 - 250(1.08)^n"
      },
      {
        "explanation": "Set \\(T_n = 0\\): \\(1.08^n = 3 \\Rightarrow n = \\frac{\\ln 3}{\\ln 1.08} \\approx 14.3\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Set integral to 1 to find \\(a\\).",
        "workingOut": "a = \\frac{3}{500}"
      }
    ],
    "subQuestions": [
      {
        ...
        "solutionSteps": [
          {
            "explanation": "Integrate $ax(10-x)$ over $[0,10]$ and set equal to 1.",
      ...
      },
      {
        ...
        "solutionSteps": [
          {
            "explanation": "Integrate PDF from 0 to $x$.",
      ...
      },
      {
        ...
        "solutionSteps": [
          {
            "explanation": "Evaluate $F(7)$.",
            "workingOut": "F(7) = \\frac{49 \\times 8}{500} = 0.784"
          },
          {
            "explanation": "Apply complement.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Integrate to find \\(k\\): \\(k\\int_0^4(4x-x^2)dx = k[2x^2-x^3/3]_0^4 = k \\cdot \\frac{32}{3} = 1\\).",
        "workingOut": "k = \\frac{3}{32}"
      },
      {
        "explanation": "Compute \\(P(X>3) = \\int_3^4 \\frac{3}{32}x(4-x)dx\\).",
        "workingOut": "= \\frac{3}{32}\\left[2x^2 - \\frac{x^3}{3}\\right]_3^4 = \\frac{3}{32}\\left(\\frac{32}{3} - \\frac{5}{3}\\right) \\cdot\\ldots"
      },
      {
        "explanation": "Evaluate: \\([2x^2-x^3/3]_3^4 = (32-64/3)-(18-9) = 32/3-9 = 5/3\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "\\(A = 50\\theta + 3 \\times 50\\sin\\theta = 50(\\theta + 3\\sin\\theta)\\).",
        "workingOut": "A = 50(\\theta + 3\\sin\\theta)"
      }
    ],
    "subQuestions": [
      {
      ...
      },
      {
        ...
        "solutionSteps": [
          ...
          {
            "explanation": "Confirm maximum: $\\frac{d^2A}{d\\theta^2} = -150\\sin\\theta < 0$ ✓",
  ...
  },
  {
    ...
    "solutionSteps": [
      ...
      {
        "explanation": "Check for zeros: \\(2 + \\cos\\theta = 0 \\Rightarrow \\cos\\theta = -2\\), which is impossible.",
        "workingOut": "\\cos\\theta \\in [-1,1] \\Rightarrow 2+\\cos\\theta \\geq 1 > 0"
      },
      {
        "explanation": "Since \\(\\frac{dA}{d\\theta} > 0\\) always, \\(A\\) is strictly increasing; maximum is at the right endpoint.",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "\\(P(Z>1)\\approx 16\\%\\) so \\(\\sigma = 16.5 - 15 = 1.5\\).",
        "workingOut": "\\sigma = 1.5 \\text{ min}"
      }
    ],
    "subQuestions": [
      {
        ...
        "solutionSteps": [
          {
            "explanation": "$P(Z>1) \\approx 16\\%$, so 16.5 is $\\mu + \\sigma$.",
      ...
      },
      {
        ...
        "solutionSteps": [
          {
            "explanation": "Bell curve centred at $\\mu = 15$, shade region $x > 16.5$.",
      ...
      },
      {
        ...
        "solutionSteps": [
          {
            "explanation": "Fastest 1%: $P(X < t) = 0.01 \\Rightarrow z = -2.33$.",
            "workingOut": "z = -2.33"
          },
          {
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Top 5% means \\(P(X > h) = 0.05\\), so \\(P(Z > z) = 0.05\\) and \\(P(Z < z) = 0.95\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Integrate to find \\(V(t)\\).",
        "workingOut": "V = 100 + \\frac{9}{\\pi}\\left(\\cos\\frac{\\pi t}{30} - 1\\right)"
      }
    ],
    "subQuestions": [
      {
        ...
        "solutionSteps": [
          {
            "explanation": "Set flow rate to zero.",
            "workingOut": "\\sin\\frac{\\pi t}{30} = 0 \\Rightarrow \\frac{\\pi t}{30} = \\pi \\Rightarrow t = 30 \\text{ min}"
          },
          {
            "explanation": "Clock time.",
            "workingOut": "9{:}45 + 30 = 10{:}15 \\text{ am}"
          }
        ]
      },
      {
        ...
        "solutionSteps": [
          {
            ...
            "workingOut": "V = \\frac{9}{\\pi}\\cos\\frac{\\pi t}{30} + C"
          },
          {
            "explanation": "Apply $V(0)=100$.",
            "workingOut": "C = 100 - \\frac{9}{\\pi} \\Rightarrow V = 100 + \\frac{9}{\\pi}\\left(\\cos\\frac{\\pi t}{30}-1\\right)"
          }
        ]
      },
      {
        ...
        "solutionSteps": [
          {
            "explanation": "Minimum when $\\cos = -1$ (at $t = 30$).",
            "workingOut": "V_{\\min} = 100 + \\frac{9}{\\pi}(-1-1) = 100 - \\frac{18}{\\pi} \\text{ kL}"
          }
        ]
      }
    ]
