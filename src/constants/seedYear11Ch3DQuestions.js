    ...
    "subQuestions": [
      {
        ...
        "a": "The coefficient of \\( x^2 \\) is positive (\\( a = 1 > 0 \\))."
      },
      {
        "id": "y11a-3d-q1a2",
        "type": "short_answer",
    ...
    "subQuestions": [
      {
        ...
        "a": "The coefficient of \\( x^2 \\) is negative (\\( a = -1 < 0 \\))."
      },
      {
        "id": "y11a-3d-q2a2",
        "type": "short_answer",
    ...
    "subQuestions": [
      {
        ...
        "a": "Concave up because the coefficient of \\( x^2 \\) is positive (\\( a = 1 > 0 \\))."
      },
      {
        "id": "y11a-3d-q3a2",
        "type": "short_answer",
  ...
  // ── QUESTION 16 ──
  {
    ...
    "subQuestions": [
      ...
      },
      {
        ...
        "a": "It demonstrates that the parabola is symmetrical about the vertical line \\( x = 2 \\)."
      }
    ],
    "solutionSteps": [
      {
