...
,
  ...
  "graphData": {
    "jsxGraph": {
        ...
        "script": "board.suspendUpdate();\nvar A = board.create('point', [-3,0], {name: 'A', size: 0, label: {offset: [-10,-15]}});\nvar B = board.create('point', [4,0], {name: 'B', size: 0, label: {offset: [10,-15]}});\nvar O = board.create('point', [0,0], {name: 'O', size: 0, label: {offset: [0,-15]}});\nvar V = board.create('point', [0,4], {name: 'V', size: 0, label: {offset: [0,10]}});\nboard.create('segment', [A,B], {strokeColor: 'gray', strokeWidth: 2});\nboard.create('segment', [O,V], {strokeColor: 'black', strokeWidth: 3});\nboard.create('segment', [V,A], {strokeColor: '#4f46e5', strokeWidth: 2});\nboard.create('segment', [V,B], {strokeColor: '#4f46e5', strokeWidth: 2});\nboard.unsuspendUpdate();"
    }
},
