export const CARINGBAH_2020_QUESTIONS = [
  ...
  },
  {
    ...
    "a": 0,
    "answer": "0",
    "hint": "Differentiate to find $y'$, set $y' = 0$ for stationary points. Use $y''$ to determine nature. For inflection, set $y'' = 0$ and check sign change.",
    "solution": "The correct answer is (a) Local maximum at \\((1, 5)\\), local minimum at \\((2, 4)\\).\n\n(b) \\(y'' = 12x - 18 = 0 \\Rightarrow x = \\frac{3}{2}\\), and \\(y''\\) changes sign, confirming an inflection point.\n\n(c) See sketch..",
    "solutionSteps": [
      {
        "explanation": "Differentiate \\(y = 2x^3 - 9x^2 + 12x\\) with respect to \\(x\\) to find the gradient function. Why this step? It isolates one clear idea so the next calculation is reliable. What rule applies is shown in the working. A common student slip here is a sign error or swapping upper and lower limits, so re-check those before continuing.",
        "workingOut": "\\(y' = 6x^2 - 18x + 12\\)",
        "graphData": null
      },
      {
        "explanation": "Find the \\(y\\)-coordinates by substituting each \\(x\\) value into the original equation. Why this step? It isolates one clear idea so the next calculation is reliable. What rule applies is shown in the working. A common student slip here is a sign error or swapping upper and lower limits, so re-check those before continuing.",
      ...
      {
        "explanation": "Verify by checking that \\(y''\\) changes sign on either side of \\(x = \\frac{3}{2}\\). Why this step? It isolates one clear idea so the next calculation is reliable. What rule applies is shown in the working. A common student slip here is a sign error or swapping upper and lower limits, so re-check those before continuing.",
