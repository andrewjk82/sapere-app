    ...
    graphData: {
      jsxGraph: {
        ...
        elements: [
          ...
          { type: 'text', coords: [-1.5,2.5], content: '5 cm' }
        ]
      }
    },
    solutionSteps: [
    ...
    graphData: {
      jsxGraph: {
        ...
        elements: [
          ...
          { type: 'text', coords: [-1.5,0.5], content: '10 cm' }
        ]
      }
    },
    solutionSteps: [
    ...
    graphData: {
      jsxGraph: {
        ...
        elements: [
          ...
          { type: 'text', coords: [-1.5,2], content: '4 cm' }
        ]
      }
    },
    solutionSteps: [
    ...
    graphData: {
      jsxGraph: {
        ...
        elements: [
          ...
          { type: 'text', coords: [-1.5,4.3], content: '4 m' },
    ...
    graphData: {
      jsxGraph: {
        ...
        elements: [
          ...
          { type: 'circle', id: 'C_inner', center: 'O', radius: 4, color: 'white', fillOpacity: 1 },
    ...
    graphData: {
      jsxGraph: {
        ...
        elements: [
          ...
          { type: 'text', coords: [6,-0.6], content: '12 cm' },
          { type: 'text', coords: [-1.5,5], content: '10 cm' },
    ...
    graphData: {
      jsxGraph: {
        ...
        elements: [
          ...
          { type: 'text', coords: [3,-0.5], content: '6 cm' },
          { type: 'text', coords: [-1.2,2], content: '4 cm' },
    ...
    graphData: {
      jsxGraph: {
        ...
        elements: [
          ...
          { type: 'text', coords: [3,-0.5], content: '6 cm' },
          { type: 'text', coords: [-1.2,1.5], content: '3 cm' }
        ]
      }
    },
    solutionSteps: [
    ...
    graphData: {
      jsxGraph: {
        ...
        elements: [
          ...
          { type: 'text', coords: [-1.2,3.5], content: '7 m' }
        ]
      }
    },
    solutionSteps: [
