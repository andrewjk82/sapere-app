export const Y11_CH1D_QUESTIONS = [
  {
    ...
    solution: "\\(\\sqrt{x} = 2 \\implies x = 4; \\quad \\sqrt{x} = 4 \\implies x = 16\\)",
    solutionSteps: [
      {
        explanation: "This is a \"hidden quadratic\" — substitute u = √x so the equation becomes quadratic in u.",
        workingOut: "\\(u = \\sqrt{x} \\implies u^2 - 6u + 8 = 0\\)",
        graphData: null
      },
      {
        explanation: "Factor the quadratic in u: find two numbers that multiply to 8 and add to -6 (they are -2 and -4).",
        workingOut: "\\((u-2)(u-4) = 0 \\implies u = 2, 4\\)",
        graphData: null
      },
      {
        explanation: "Undo the substitution: since u = √x, square each value of u to recover x.",
        workingOut: "\\(\\sqrt{x} = 2 \\implies x = 4; \\quad \\sqrt{x} = 4 \\implies x = 16\\)",
        graphData: null
      }
    ],
    graphData: null,
  ...
  },
  {
    ...
    solutionSteps: [
      {
        explanation: "Identify the equation and the method to use (factoring).",
        workingOut: "Solve by factoring: \\( x^2 - 4x + 3 = 0 \\)",
        graphData: null
      },
      {
        explanation: "Set up the equation in standard form and find factors.",
        workingOut: "\\(x = 1, 3\\)",
        graphData: null
      },
      {
        explanation: "Write the factored form of the quadratic.",
        workingOut: "(x - a)(x - b) = 0",
        graphData: null
      },
      {
        explanation: "Solve each factor equal to zero to find the roots.",
  ...
  },
  {
    ...
    solutionSteps: [
      {
        explanation: "Identify the equation and the method to use (factoring).",
        workingOut: "Solve by factoring: \\( 5x^2 - 26x + 5 = 0 \\)",
        graphData: null
      },
      {
        explanation: "Set up the equation in standard form and find factors.",
      ...
      {
        explanation: "Solve each factor equal to zero to find the roots.",
        workingOut: "\\( (5x-1)(x-5) = 0 \\Rightarrow x = 5, \\frac{1}{5} \\)",
        graphData: null
      }
    ],
    graphData: null,
  ...
  },
  {
    ...
    solutionSteps: [
      {
        explanation: "Identify the equation and use completing the square method.",
        workingOut: "Solve by completing the square: \\( x^2 - 12x + 20 = 0 \\)",
        graphData: null
      },
      {
        explanation: "Move the constant term to the right side of the equation.",
        workingOut: "\\(x^2 - 12x + 36 = 16\\)",
        graphData: null
      },
      {
        explanation: "Add the square of half the coefficient of x to both sides.",
        workingOut: "\\((x - 6)^2 = 16 \\Rightarrow x - 6 = \\pm 4 \\Rightarrow x = 2, 10\\)",
        graphData: null
      },
      {
        explanation: "Take the square root of both sides and solve for x.",
        workingOut: "\\( x^2 - 12x = -20 \\Rightarrow x^2 - 12x + 36 = 16 \\Rightarrow (x-6)^2 = 16 \\Rightarrow x = 2, 10 \\)",
        graphData: null
      }
    ],
    graphData: null,
  ...
  },
  {
    ...
    blanks: [],
    hint: "Let \\( u = \\sqrt{x} \\). This means \\( u^2 = x \\). Substitute these in to form a quadratic equation.",
    solution: "\\(\\sqrt{x} = 3 \\implies x = 9; \\quad \\sqrt{x} = 5 \\implies x = 25\\)",
    solutionSteps: [
      {
        explanation: "This is a \"hidden quadratic\" — substitute u = √x so the equation becomes quadratic in u.",
        workingOut: "\\(u = \\sqrt{x} \\implies u^2 - 8u + 15 = 0\\)",
        graphData: null
      },
      {
        explanation: "Factor the quadratic in u: find two numbers that multiply to 15 and add to -8 (they are -3 and -5).",
        workingOut: "\\((u-3)(u-5) = 0 \\implies u = 3, 5\\)",
        graphData: null
      },
      {
        explanation: "Undo the substitution: since u = √x, square each value of u to recover x.",
        workingOut: "\\(\\sqrt{x} = 3 \\implies x = 9; \\quad \\sqrt{x} = 5 \\implies x = 25\\)",
        graphData: null
      }
    ],
    graphData: null,
  ...
  },
  {
    ...
    solution: "\\(x^2 = 2 \\implies x = \\pm\\sqrt{2}; \\quad x^2 = 3 \\implies x = \\pm\\sqrt{3}\\)",
    solutionSteps: [
      {
        explanation: "This is a \"hidden quadratic\" in x^2 — substitute u = x^2 so the equation becomes quadratic in u.",
        workingOut: "\\(u = x^2 \\implies u^2 - 5u + 6 = 0\\)",
        graphData: null
      },
      {
        explanation: "Factor the quadratic in u: find two numbers that multiply to 6 and add to -5 (they are -2 and -3).",
        workingOut: "\\((u-2)(u-3) = 0 \\implies u = 2, 3\\)",
        graphData: null
      },
      {
        explanation: "Undo the substitution: since u = x^2, take the square root of each value of u (both + and - roots).",
        workingOut: "\\(x^2 = 2 \\implies x = \\pm\\sqrt{2}; \\quad x^2 = 3 \\implies x = \\pm\\sqrt{3}\\)",
        graphData: null
      }
    ],
    graphData: null,
  ...
  },
  {
    ...
    solutionSteps: [
      {
        explanation: "Identify the equation and the method to use (factoring).",
        workingOut: "Solve by factoring: \\( 3a^2 = 7a \\)",
        graphData: null
      },
      {
        explanation: "Set up the equation in standard form and find factors.",
      ...
      {
        explanation: "Solve each factor equal to zero to find the roots.",
        workingOut: "\\( 3a^2 - 7a = 0 \\Rightarrow a(3a - 7) = 0 \\Rightarrow a = 0, \\frac{7}{3} \\)",
        graphData: null
      }
    ],
    graphData: null,
  ...
  },
  {
    ...
    solutionSteps: [
      {
        explanation: "Identify the equation and the method to use (factoring).",
        workingOut: "Solve by factoring: \\( 3a^2 - 8a + 4 = 0 \\)",
        graphData: null
      },
      {
        explanation: "Set up the equation in standard form and find factors.",
      ...
      {
        explanation: "Solve each factor equal to zero to find the roots.",
        workingOut: "\\( (3a-2)(a-2) = 0 \\Rightarrow a = 2, \\frac{2}{3} \\)",
        graphData: null
      }
    ],
    graphData: null,
  ...
  },
  {
    ...
    solutionSteps: [
      {
        explanation: "Identify the coefficients a, b, and c from the standard form equation.",
        workingOut: "Solve using the quadratic formula: \\( a^2 + 16 = 9a \\)",
        graphData: null
      },
      {
        explanation: "Apply the quadratic formula: x = (-b ± √(b² - 4ac)) / 2a",
        workingOut: "Calculate the discriminant: b² - 4ac",
        graphData: null
      },
      {
      ...
      {
        explanation: "Simplify to find both roots.",
        workingOut: "\\( a^2 - 9a + 16 = 0 \\Rightarrow a = \\frac{9 \\pm \\sqrt{81 - 64}}{2} = \\frac{9 \\pm \\sqrt{17}}{2} \\)",
        graphData: null
      }
    ],
    graphData: null,
  ...
  },
  {
    ...
    solutionSteps: [
      {
        explanation: "Identify the equation and use completing the square method.",
        workingOut: "Solve by dividing both sides by the coefficient of \\( x^2 \\) and completing the square: \\( 4x^2 - 4x - 5 = 0 \\)",
        graphData: null
      },
      {
        explanation: "Move the constant term to the right side of the equation.",
      ...
      {
        explanation: "Take the square root of both sides and solve for x.",
        workingOut: "\\( x^2 - x - \\frac{5}{4} = 0 \\Rightarrow x^2 - x + \\frac{1}{4} = \\frac{6}{4} \\Rightarrow (x-\\frac{1}{2})^2 = \\frac{6}{4} \\Rightarrow x = \\frac{1 \\pm \\sqrt{6}}{2} \\)",
        graphData: null
      }
    ],
    graphData: null,
  ...
  },
  {
    ...
    solutionSteps: [
      {
        explanation: "Identify the equation and the method to use (factoring).",
        workingOut: "Solve the equation: \\( y^2 = 49 \\)",
        graphData: null
      },
      {
        explanation: "Set up the equation in standard form and find factors.",
      ...
      {
        explanation: "Solve each factor equal to zero to find the roots.",
        workingOut: "\\( y^2 = 49 \\Rightarrow y = \\pm \\sqrt{49} = \\pm 7 \\)",
        graphData: null
      }
    ],
    graphData: null,
  ...
  },
  {
    ...
    solutionSteps: [
      {
        explanation: "Identify the coefficients a, b, and c from the standard form equation.",
        workingOut: "Solve using the quadratic formula: \\( c^2 - 8c + 5 = 0 \\)",
        graphData: null
      },
      {
        explanation: "Apply the quadratic formula: x = (-b ± √(b² - 4ac)) / 2a",
      ...
      {
        explanation: "Simplify to find both roots.",
        workingOut: "\\( c = \\frac{8 \\pm \\sqrt{64 - 20}}{2} = \\frac{8 \\pm \\sqrt{44}}{2} = 4 \\pm \\sqrt{11} \\)",
        graphData: null
      }
    ],
    graphData: null,
  ...
  },
  {
    ...
    options: [
      ...
      {
        text: "\\(x = 6 \\pm 3\\sqrt{2}\\)",
        imageUrl: ""
      },
      {
        text: "\\(x = \\frac{6 \\pm \\sqrt{2}}{2}\\)",
        imageUrl: ""
      },
      {
        text: "\\(x = \\frac{3 \\pm 3\\sqrt{2}}{2}\\)",
        imageUrl: ""
      },
      {
    ...
    solutionSteps: [
      {
        explanation: "Identify the equation and use completing the square method.",
        workingOut: "Solve by dividing both sides by the coefficient of \\( x^2 \\) and completing the square: \\( 2x^2 - 12x + 9 = 0 \\)",
        graphData: null
      },
      {
        explanation: "Move the constant term to the right side of the equation.",
      ...
      {
        explanation: "Take the square root of both sides and solve for x.",
        workingOut: "\\( x^2 - 6x + \\frac{9}{2} = 0 \\Rightarrow x^2 - 6x + 9 = \\frac{9}{2} \\Rightarrow (x-3)^2 = \\frac{9}{2} \\Rightarrow x = 3 \\pm \\frac{3\\sqrt{2}}{2} = \\frac{6 \\pm 3\\sqrt{2}}{2} \\)",
        graphData: null
      }
    ],
    graphData: null,
  ...
  },
  {
    ...
    solutionSteps: [
      {
        explanation: "Identify the equation and the method to use (factoring).",
        workingOut: "Solve by factoring: \\( 4t^2 + 9 = 12t \\)",
        graphData: null
      },
      {
        explanation: "Set up the equation in standard form and find factors.",
      ...
      {
        explanation: "Solve each factor equal to zero to find the roots.",
        workingOut: "\\( 4t^2 - 12t + 9 = 0 \\Rightarrow (2t-3)^2 = 0 \\Rightarrow t = \\frac{3}{2} \\)",
        graphData: null
      }
    ],
    graphData: null,
  ...
  },
  {
    ...
    solutionSteps: [
      {
        explanation: "Identify the equation and the method to use (factoring).",
        workingOut: "Solve by factoring: \\( x^2 + 7x + 12 = 0 \\)",
        graphData: null
      },
      {
        explanation: "Set up the equation in standard form and find factors.",
      ...
      {
        explanation: "Solve each factor equal to zero to find the roots.",
        workingOut: "\\( (x+3)(x+4) = 0 \\Rightarrow x = -3, -4 \\)",
        graphData: null
      }
    ],
    graphData: null,
  ...
  },
  {
    ...
    solutionSteps: [
      {
        explanation: "Identify the equation and the method to use (factoring).",
        workingOut: "Solve by factoring: \\( 4y^2 - 7y + 3 = 0 \\)",
        graphData: null
      },
      {
        explanation: "Set up the equation in standard form and find factors.",
      ...
      {
        explanation: "Solve each factor equal to zero to find the roots.",
        workingOut: "\\( (4y-3)(y-1) = 0 \\Rightarrow y = 1, \\frac{3}{4} \\)",
        graphData: null
      }
    ],
    graphData: null,
  ...
  },
  {
    ...
    solutionSteps: [
      {
        explanation: "Identify the equation and the method to use (factoring).",
        workingOut: "Solve the equation: \\( x = \\frac{3}{x} + 2 \\)",
        graphData: null
      },
      {
        explanation: "Set up the equation in standard form and find factors.",
      ...
      {
        explanation: "Solve each factor equal to zero to find the roots.",
        workingOut: "\\( x^2 = 2x + 3 \\Rightarrow x^2 - 2x - 3 = 0 \\Rightarrow (x-3)(x+1) = 0 \\Rightarrow x = 3, -1 \\)",
        graphData: null
      }
    ],
    graphData: null,
  ...
  },
  {
    ...
    solutionSteps: [
      {
        explanation: "Given: read the full stem carefully and list the known values, the unknown, and any units or constraints. Strategy for Exam: choose the matching formula or geometric fact first so every later calculation has a clear purpose.",
        workingOut: "<div style=\"text-align: left;\"><p>We are asked to evaluate the expression step-by-step. First, identify the operations and any necessary common denominators or conversion method.</p></div>",
        graphData: null
      },
      {
  ...
  },
  {
    ...
    solutionSteps: [
      {
        explanation: "Identify the equation and the method to use (factoring).",
        workingOut: "Solve by factoring: \\( 2x^2 + 7x + 3 = 0 \\)",
        graphData: null
      },
      {
        explanation: "Set up the equation in standard form and find factors.",
      ...
      {
        explanation: "Solve each factor equal to zero to find the roots.",
        workingOut: "\\( (2x+1)(x+3) = 0 \\Rightarrow x = -3, -\\frac{1}{2} \\)",
        graphData: null
      }
    ],
    graphData: null,
  ...
  },
  {
    ...
    options: [
      ...
      {
        text: "\\(x = \\frac{3}{2}, -\\frac{7}{2}\\)",
        imageUrl: ""
      },
      {
        text: "\\(x = \\frac{1}{2}, -\\frac{3}{2}\\)",
        imageUrl: ""
      },
      {
        text: "\\(x = -1, 5\\)",
    ...
    solutionSteps: [
      {
        explanation: "Identify the equation and use completing the square method.",
        workingOut: "Solve by dividing both sides by the coefficient of \\( x^2 \\) and completing the square: \\( 4x^2 + 8x - 5 = 0 \\)",
        graphData: null
      },
      {
        explanation: "Move the constant term to the right side of the equation.",
      ...
      {
        explanation: "Take the square root of both sides and solve for x.",
        workingOut: "\\( x^2 + 2x - \\frac{5}{4} = 0 \\Rightarrow x^2 + 2x + 1 = \\frac{9}{4} \\Rightarrow (x+1)^2 = \\frac{9}{4} \\Rightarrow x + 1 = \\pm \\frac{3}{2} \\Rightarrow x = \\frac{1}{2}, -\\frac{5}{2} \\)",
        graphData: null
      }
    ],
    graphData: null,
  ...
  },
  {
    ...
    solution: "\\(3n-4=0 \\implies n=\\frac{4}{3}; \\quad n+1=0 \\implies n=-1\\)",
    solutionSteps: [
      {
        explanation: "Factor the quadratic 3n^2 - n - 4. Look for factors of 3 and -4 that combine to give the middle coefficient -1.",
        workingOut: "\\(3n^2 - n - 4 = (3n - 4)(n + 1)\\)",
        graphData: null
      },
      {
        explanation: "Verify by expanding: 3n·n + 3n·1 - 4·n - 4·1 = 3n^2 + 3n - 4n - 4 = 3n^2 - n - 4 ✓.",
        workingOut: "\\((3n-4)(n+1) = 0\\)",
        graphData: null
      },
      {
        explanation: "Set each factor to zero and solve for n.",
        workingOut: "\\(3n-4=0 \\implies n=\\frac{4}{3}; \\quad n+1=0 \\implies n=-1\\)",
        graphData: null
      }
    ],
    graphData: null,
  ...
  },
  {
    ...
    solutionSteps: [
      {
        explanation: "Identify the equation and the method to use (factoring).",
        workingOut: "Solve by factoring: \\( 14t + 8 = 3t^2 \\)",
        graphData: null
      },
      {
        explanation: "Set up the equation in standard form and find factors.",
      ...
      {
        explanation: "Solve each factor equal to zero to find the roots.",
        workingOut: "\\( 3t^2 - 14t - 8 = 0 \\Rightarrow (3t+2)(t-4) = 0 \\Rightarrow t = -\\frac{2}{3}, 4 \\)",
        graphData: null
      }
    ],
    graphData: null,
  ...
  },
  {
    ...
    solutionSteps: [
      {
        explanation: "Identify the equation and the method to use (factoring).",
        workingOut: "Solve by factoring: \\( 2x^2 + 3x - 5 = 0 \\)",
        graphData: null
      },
      {
        explanation: "Set up the equation in standard form and find factors.",
      ...
      {
        explanation: "Solve each factor equal to zero to find the roots.",
        workingOut: "\\( (2x+5)(x-1) = 0 \\Rightarrow x = 1, -\\frac{5}{2} \\)",
        graphData: null
      }
    ],
    graphData: null,
  ...
  },
  {
    ...
    solutionSteps: [
      {
        explanation: "Identify the equation and the method to use (factoring).",
        workingOut: "Solve the equation: \\( (2b - 1)(3b + 2) = 5 \\)",
        graphData: null
      },
      {
        explanation: "Set up the equation in standard form and find factors.",
      ...
      {
        explanation: "Solve each factor equal to zero to find the roots.",
        workingOut: "\\( 6b^2 + b - 2 = 5 \\Rightarrow 6b^2 + b - 7 = 0 \\Rightarrow (6b+7)(b-1) = 0 \\Rightarrow b = 1, -\\frac{7}{6} \\)",
        graphData: null
      }
    ],
    graphData: null,
  ...
  },
  {
    ...
    solutionSteps: [
      {
        explanation: "Multiply all terms by y to clear the fraction.",
        workingOut: "\\(y^2 + 3 = \\frac{13y}{2}\\)",
        graphData: null
      },
      {
        explanation: "Multiply by 2 to eliminate the remaining fraction.",
      ...
      {
        explanation: "Factor by finding factors of 2×6=12 that sum to -13. Use -1 and -12.",
        workingOut: "\\(2y^2 - y - 12y + 6 = 0\\)",
        graphData: null
      },
      {
        explanation: "Factor by grouping.",
        workingOut: "\\(y(2y - 1) - 6(2y - 1) = 0\\)",
        graphData: null
      },
      {
        explanation: "Write as product of binomials and solve.",
        workingOut: "\\((2y - 1)(y - 6) = 0 \\Rightarrow y = \\frac{1}{2}, 6\\)",
        graphData: null
      }
    ],
    graphData: null,
  ...
  },
  {
    ...
    blanks: [],
    hint: "Let \\( u = \\sqrt{x} \\). This means \\( u^2 = x \\). Substitute these in to form a quadratic equation.",
    solution: "\\(\\sqrt{x} = 1 \\implies x = 1; \\quad \\sqrt{x} = 3 \\implies x = 9\\)",
    solutionSteps: [
      {
        explanation: "This is a \"hidden quadratic\" — substitute u = √x so the equation becomes quadratic in u.",
        workingOut: "\\(u = \\sqrt{x} \\implies u^2 - 4u + 3 = 0\\)",
        graphData: null
      },
      {
        explanation: "Factor the quadratic in u: find two numbers that multiply to 3 and add to -4 (they are -1 and -3).",
        workingOut: "\\((u-1)(u-3) = 0 \\implies u = 1, 3\\)",
        graphData: null
      },
      {
        explanation: "Undo the substitution: since u = √x, square each value of u to recover x.",
        workingOut: "\\(\\sqrt{x} = 1 \\implies x = 1; \\quad \\sqrt{x} = 3 \\implies x = 9\\)",
        graphData: null
      }
    ],
    graphData: null,
  ...
  },
  {
    ...
    options: [
      ...
      {
        text: "\\(x = \\frac{2 \\pm \\sqrt{13}}{2}\\)",
        imageUrl: "",
        isCorrect: false
      },
      {
        text: "\\(x = \\frac{3 \\pm \\sqrt{13}}{2}\\)",
        imageUrl: "",
        isCorrect: false
      },
      {
  ...
  },
  {
    ...
    options: [
      ...
      {
        text: "\\(x = \\frac{-3 \\pm \\sqrt{3}}{2}\\)",
        imageUrl: "",
        isCorrect: false
      },
      {
        text: "\\(x = \\frac{-4 \\pm \\sqrt{3}}{2}\\)",
        imageUrl: "",
        isCorrect: false
      },
      {
  ...
  },
  {
    ...
    solution: "\\(2a-1=0 \\implies a=\\frac{1}{2}; \\quad a+5=0 \\implies a=-5\\)",
    solutionSteps: [
      {
        explanation: "Factor the quadratic 2a^2 + 9a - 5. Look for factors of 2 and -5 that combine to give the middle coefficient 9.",
        workingOut: "\\(2a^2 + 9a - 5 = (2a - 1)(a + 5)\\)",
        graphData: null
      },
      {
        explanation: "Verify by expanding: 2a·a + 2a·5 - 1·a - 1·5 = 2a^2 + 10a - a - 5 = 2a^2 + 9a - 5 ✓.",
        workingOut: "\\((2a-1)(a+5) = 0\\)",
        graphData: null
      },
      {
        explanation: "Set each factor to zero and solve for a.",
        workingOut: "\\(2a-1=0 \\implies a=\\frac{1}{2}; \\quad a+5=0 \\implies a=-5\\)",
        graphData: null
      }
    ],
    graphData: null,
  ...
  },
  {
    ...
    blanks: [],
    hint: "Let \\( u = x^2 \\). Rewrite the equation in terms of \\( u \\) as a quadratic equation, solve for \\( u \\), then substitute back to find \\( x \\).",
    solution: "\\(x^2 = 1 \\implies x = \\pm 1; \\quad x^2 = 2 \\implies x = \\pm\\sqrt{2}\\)",
    solutionSteps: [
      {
        explanation: "This is a \"hidden quadratic\" in x^2 — substitute u = x^2 so the equation becomes quadratic in u.",
        workingOut: "\\(u = x^2 \\implies u^2 - 3u + 2 = 0\\)",
        graphData: null
      },
      {
        explanation: "Factor the quadratic in u: find two numbers that multiply to 2 and add to -3 (they are -1 and -2).",
        workingOut: "\\((u-1)(u-2) = 0 \\implies u = 1, 2\\)",
        graphData: null
      },
      {
        explanation: "Undo the substitution: since u = x^2, take the square root of each value of u (both + and - roots).",
        workingOut: "\\(x^2 = 1 \\implies x = \\pm 1; \\quad x^2 = 2 \\implies x = \\pm\\sqrt{2}\\)",
        graphData: null
      }
    ],
    graphData: null,
  ...
  },
  {
    ...
    solutionSteps: [
      ...
      {
        explanation: "Expand the algebraic expression.",
  ...
  },
  {
    ...
    solutionSteps: [
      ...
      {
        explanation: "Solve for the variables.",
        workingOut: "\\(a = 2, -20\\)",
        graphData: null
      }
    ],
  ...
  },
  {
    ...
    blanks: [],
    hint: "Factor out \\( b \\).",
    solution: "\\(3b=1 \\implies b=\\frac{1}{3}\\)",
    solutionSteps: [
      {
        explanation: "There is no constant term, so factor out the common factor b directly (do not divide both sides by b — that would lose the root b=0).",
        workingOut: "\\(3b^2 - b = b(3b - 1)\\)",
        graphData: null
      },
      {
        explanation: "Set each factor to zero and solve for b.",
        workingOut: "\\(b(3b-1) = 0 \\implies b=0 \\text{ or } 3b-1=0\\)",
        graphData: null
      },
      {
        explanation: "Solve the second factor for b.",
        workingOut: "\\(3b=1 \\implies b=\\frac{1}{3}\\)",
        graphData: null
      }
    ],
    graphData: null,
  ...
  },
  {
    ...
    blanks: [],
    hint: "Let \\( u = x^2 \\). Rewrite the equation in terms of \\( u \\) as a quadratic equation, solve for \\( u \\), then substitute back to find \\( x \\).",
    solution: "\\(x^2 = 3 \\implies x = \\pm\\sqrt{3}; \\quad x^2 = 4 \\implies x = \\pm 2\\)",
    solutionSteps: [
      {
        explanation: "This is a \"hidden quadratic\" in x^2 — substitute u = x^2 so the equation becomes quadratic in u.",
        workingOut: "\\(u = x^2 \\implies u^2 - 7u + 12 = 0\\)",
        graphData: null
      },
      {
        explanation: "Factor the quadratic in u: find two numbers that multiply to 12 and add to -7 (they are -3 and -4).",
        workingOut: "\\((u-3)(u-4) = 0 \\implies u = 3, 4\\)",
        graphData: null
      },
      {
        explanation: "Undo the substitution: since u = x^2, take the square root of each value of u (both + and - roots). Note √4 simplifies to 2.",
        workingOut: "\\(x^2 = 3 \\implies x = \\pm\\sqrt{3}; \\quad x^2 = 4 \\implies x = \\pm 2\\)",
        graphData: null
      }
    ],
    graphData: null,
  ...
  },
  {
    ...
    options: [
      {
        text: "\\(\\approx 9\\) minutes (\\(t \\approx 8.8\\))",
        imageUrl: null,
        isCorrect: false
      },
      {
        text: "\\(\\approx 18\\) minutes (\\(t \\approx 17.6\\))",
        imageUrl: null,
        isCorrect: true
      },
      {
        text: "\\(\\approx 30\\) minutes",
        imageUrl: null,
        isCorrect: false
      },
      {
        text: "\\(\\approx 42\\) minutes (\\(t \\approx 42.4\\))",
        imageUrl: null,
        isCorrect: false
      }
    ],
  ...
  },
  {
    ...
    options: [
      ...
      {
        text: "\\(k \\leq \\frac{10}{19}\\)",
        imageUrl: null,
        isCorrect: false
      },
      {
        text: "\\(k \\leq \\frac{1}{10}\\)",
        imageUrl: null,
        isCorrect: false
      }
    ],
  ...
  },
  {
    ...
    options: [
      {
        text: "\\(\\approx 10\\) minutes (\\(t \\approx 9.8\\))",
        imageUrl: null,
        isCorrect: false
      },
      {
        text: "\\(\\approx 35\\) minutes",
        imageUrl: null,
        isCorrect: false
      },
      {
        text: "\\(\\approx 21\\) minutes (\\(t \\approx 20.5\\))",
        imageUrl: null,
        isCorrect: true
      },
      {
        text: "\\(\\approx 49\\) minutes (\\(t \\approx 49.5\\))",
        imageUrl: null,
        isCorrect: false
      }
    ],
