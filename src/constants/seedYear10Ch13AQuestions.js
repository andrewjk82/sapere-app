  ...
  },
  {
    ...
    "graphData": {
      "jsxGraph": {
        ...
        "script": "board.suspendUpdate();\nvar O = board.create('point', [0,0], {name: 'O', size: 2, color: 'red'});\nvar circle = board.create('circle', [O, 5], {strokeColor: '#3b82f6', highlight: false, strokeWidth: 2});\nvar A = board.create('point', [5*Math.cos(240*Math.PI/180), 5*Math.sin(240*Math.PI/180)], {name: 'A', size: 2, color: '#64748b'});\nvar B = board.create('point', [5*Math.cos(60*Math.PI/180), 5*Math.sin(60*Math.PI/180)], {name: 'B', size: 2, color: '#64748b'});\nvar P = board.create('point', [5,0], {name: 'P', size: 2, color: '#64748b'});\nboard.create('segment', [A,B], {strokeColor: 'black'});\nvar OA = board.create('segment', [O,A], {strokeColor: 'black'});\nvar AP = board.create('segment', [A,P], {strokeColor: 'black'});\nvar OP = board.create('segment', [O,P], {strokeColor: 'black'});\nvar BP = board.create('segment', [B,P], {strokeColor: 'black'});\nboard.create('ticks', [OA], {ticks: 2});\nboard.create('ticks', [AP], {ticks: 2});\nboard.create('angle', [A,O,P], {radius: 1, name: 'α'});\nboard.create('angle', [O,B,P], {radius: 1.5, name: 'β'});\nboard.unsuspendUpdate();"
      }
    }
  },
  {
  ...
  },
  {
    ...
    "graphData": {
      "jsxGraph": {
        ...
        "script": "board.suspendUpdate();\nvar O = board.create('point', [0,0], {name: 'O', size: 2, color: 'red'});\nvar circle = board.create('circle', [O, 5], {strokeColor: '#3b82f6', highlight: false, strokeWidth: 2});\nvar A = board.create('point', [5*Math.cos(190*Math.PI/180), 5*Math.sin(190*Math.PI/180)], {name: 'A', size: 2, color: '#64748b'});\nvar B = board.create('point', [5*Math.cos(50*Math.PI/180), 5*Math.sin(50*Math.PI/180)], {name: 'B', size: 2, color: '#64748b'});\nvar C = board.create('point', [5*Math.cos(310*Math.PI/180), 5*Math.sin(310*Math.PI/180)], {name: 'C', size: 2, color: '#64748b'});\nboard.create('polygon', [A,B,C], {fillColor: 'transparent', borders: {strokeColor: 'black'}});\nboard.create('segment', [O,A], {strokeColor: 'black'});\nboard.create('segment', [O,B], {strokeColor: 'black'});\nboard.create('segment', [O,C], {strokeColor: 'black'});\nboard.create('angle', [A,O,B], {radius: 1, name: '140°', label: {offset: [5, 15]}});\nboard.create('angle', [C,A,B], {radius: 1, name: '50°', label: {offset: [15, 0]}});\nboard.create('angle', [A,O,C], {radius: 1, name: 'α', label: {offset: [-5, -15]}});\nboard.create('angle', [A,B,C], {radius: 1, name: 'β', label: {offset: [-10, -10]}});\nboard.create('angle', [A,C,B], {radius: 1, name: 'γ', label: {offset: [-10, 10]}});\nboard.unsuspendUpdate();"
      }
    }
  },
  {
  ...
  },
  {
    ...
    "graphData": {
      "jsxGraph": {
        ...
        "script": "board.suspendUpdate();\nvar O = board.create('point', [0,0], {name: 'O', size: 2, color: 'red'});\nvar circle = board.create('circle', [O, 5], {strokeColor: '#3b82f6', highlight: false, strokeWidth: 2});\nvar A = board.create('point', [5*Math.cos(170*Math.PI/180), 5*Math.sin(170*Math.PI/180)], {name: 'A', size: 2, color: '#64748b'});\nvar B = board.create('point', [5*Math.cos(70*Math.PI/180), 5*Math.sin(70*Math.PI/180)], {name: 'B', size: 2, color: '#64748b'});\nvar C = board.create('point', [5*Math.cos(-30*Math.PI/180), 5*Math.sin(-30*Math.PI/180)], {name: 'C', size: 2, color: '#64748b'});\nboard.create('segment', [O,A], {strokeColor: 'black'});\nboard.create('segment', [O,B], {strokeColor: 'black'});\nboard.create('segment', [O,C], {strokeColor: 'black'});\nvar AB = board.create('segment', [A,B], {strokeColor: 'black'});\nvar BC = board.create('segment', [B,C], {strokeColor: 'black'});\nboard.create('segment', [A,C], {strokeColor: 'black'});\nboard.create('ticks', [AB], {ticks: 2});\nboard.create('ticks', [BC], {ticks: 2});\nboard.create('angle', [C,O,A], {radius: 1, name: '200°'});\nboard.create('angle', [O,A,B], {radius: 1, name: 'α'});\nboard.create('angle', [O,B,C], {radius: 1, name: 'β'});\nboard.create('angle', [O,C,A], {radius: 1.5, name: 'γ'});\nboard.unsuspendUpdate();"
      }
    }
  },
  {
  ...
  },
  {
    ...
    "graphData": {
      "jsxGraph": {
        ...
        "script": "board.suspendUpdate();\nvar O = board.create('point', [0,0], {name: 'O', size: 2, color: 'red'});\nvar circle = board.create('circle', [O, 5], {strokeColor: '#3b82f6', highlight: false, strokeWidth: 2});\nvar P = board.create('point', [0,5], {name: 'P', size: 2, color: '#64748b'});\nvar A = board.create('point', [5*Math.cos(220*Math.PI/180), 5*Math.sin(220*Math.PI/180)], {name: 'A', size: 2, color: '#64748b'});\nvar B = board.create('point', [5*Math.cos(320*Math.PI/180), 5*Math.sin(320*Math.PI/180)], {name: 'B', size: 2, color: '#64748b'});\nvar X = board.create('point', [0,-5], {name: '', size: 0, visible: false});\nboard.create('segment', [P,A], {strokeColor: 'black'});\nboard.create('segment', [P,B], {strokeColor: 'black'});\nboard.create('segment', [O,A], {strokeColor: 'red', dash: 2});\nboard.create('segment', [O,B], {strokeColor: 'red', dash: 2});\nboard.create('segment', [P,X], {strokeColor: 'red', dash: 2});\nboard.create('angle', [O,P,A], {radius: 1, name: 'α'});\nboard.create('angle', [B,P,O], {radius: 1.2, name: 'β'});\nboard.unsuspendUpdate();"
      }
    }
  },
  {
    ...
    "graphData": {
      "jsxGraph": {
        ...
        "script": "board.suspendUpdate();\nvar O = board.create('point', [0,0], {name: 'O', size: 2, color: 'red'});\nvar circle = board.create('circle', [O, 5], {strokeColor: '#3b82f6', highlight: false, strokeWidth: 2});\nvar P = board.create('point', [5*Math.cos(60*Math.PI/180), 5*Math.sin(60*Math.PI/180)], {name: 'P', size: 2, color: '#64748b'});\nvar A = board.create('point', [5*Math.cos(220*Math.PI/180), 5*Math.sin(220*Math.PI/180)], {name: 'A', size: 2, color: '#64748b'});\nvar B = board.create('point', [5*Math.cos(340*Math.PI/180), 5*Math.sin(340*Math.PI/180)], {name: 'B', size: 2, color: '#64748b'});\nvar X = board.create('point', [5*Math.cos(240*Math.PI/180), 5*Math.sin(240*Math.PI/180)], {name: 'X', size: 2, color: '#64748b'});\nboard.create('segment', [P,A], {strokeColor: 'black'});\nboard.create('segment', [P,B], {strokeColor: 'black'});\nboard.create('segment', [O,A], {strokeColor: 'red', dash: 2});\nboard.create('segment', [O,B], {strokeColor: 'red', dash: 2});\nboard.create('segment', [P,X], {strokeColor: 'red', dash: 2});\nboard.create('angle', [O,P,A], {radius: 1, name: 'α'});\nboard.create('angle', [B,P,O], {radius: 1.5, name: 'β'});\nboard.unsuspendUpdate();"
      }
    }
  },
  {
  ...
  },
  {
    ...
    "graphData": {
      "jsxGraph": {
        ...
        "script": "board.suspendUpdate();\nvar O = board.create('point', [0,0], {name: 'O (Centre)', size: 2, color: 'red'});\nvar circle = board.create('circle', [O, 5], {strokeColor: '#3b82f6', highlight: false, strokeWidth: 2});\nvar P = board.create('point', [0,-5], {name: 'P (Punter)', size: 2, color: '#64748b'});\nvar A = board.create('point', [5,0], {name: 'A (Start)', size: 2, color: '#64748b'});\nvar H = board.create('point', [5*Math.cos(60*Math.PI/180), 5*Math.sin(60*Math.PI/180)], {name: 'H (Horse)', size: 2, color: '#10b981'});\nboard.create('segment', [O,A], {strokeColor: '#9ca3af', dash: 2});\nboard.create('segment', [O,H], {strokeColor: '#9ca3af', dash: 2});\nboard.create('segment', [P,A], {strokeColor: '#9ca3af', dash: 2});\nboard.create('segment', [P,H], {strokeColor: 'black', lastArrow: true});\nboard.create('angle', [A,O,H], {radius: 1, name: '2θ'});\nboard.create('angle', [A,P,H], {radius: 1.5, name: 'θ'});\nboard.unsuspendUpdate();"
      }
    }
  }
];
