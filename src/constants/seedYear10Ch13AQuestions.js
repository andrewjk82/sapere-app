export const Y10_CH13A_QUESTIONS = [
  {
    ...
    timeLimit: 90,
    question:
      "Find the values of $\\alpha$ and $\\beta$. Enter your answer as two numbers separated by a comma (e.g. 30, 40).",
    a: "90, 75",
    solution:
  ...
  },
  {
    ...
    timeLimit: 90,
    question:
      "Find the values of $\\alpha$ and $\\beta$. Enter your answer as two numbers separated by a comma.",
    a: "90, 35",
    solution:
  ...
  },
  {
    ...
    timeLimit: 90,
    question:
      "Find the values of $\\alpha$ and $\\theta$. Enter your answer as two numbers separated by a comma.",
    a: "20, 40",
    solution:
  ...
  },
  {
    ...
    timeLimit: 90,
    question:
      "Find the values of $\\alpha$, $\\beta$, and $\\gamma$. Enter your answer as three numbers separated by commas.",
    a: "100, 20, 50",
    solution:
  ...
  },
  {
    ...
    solutionSteps: [
      ...
      {
        explanation:
          "Use the exterior angle theorem on the two isosceles triangles.",
        workingOut:
          "\\triangle OPB \\text{ is isosceles} \\Rightarrow \\angle BOX = 2\\beta\n\\triangle OPA \\text{ is isosceles} \\Rightarrow \\angle AOX = 2\\alpha",
        graphData: null,
      },
      {
        explanation: "Sum the angles at the centre.",
        workingOut:
          "\\angle AOB = 2\\alpha + 2\\beta = 2(\\alpha + \\beta) = 2\\angle APB",
        graphData: null,
      },
    ],
    graphData: {
  ...
  },
  {
    ...
    solutionSteps: [
      ...
      },
      {
        ...
        workingOut:
          "\\text{Since } \\angle AOH \\text{ changes at a constant rate, } \\frac{1}{2}\\angle AOH \\text{ also changes at a constant rate.}\n\\text{Thus, the binoculars rotate at a constant rate.}",
        graphData: null,
      },
    ],
    graphData: {
