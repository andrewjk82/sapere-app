  ...
  },
  {
    ...
    "graphData": {
      "jsxGraph": {
        ...
        "script": "board.suspendUpdate();\nvar O = board.create('point', [0,0], {name: 'O', size: 2, color: 'red', label: {offset: [0, 10]}});\nvar circle = board.create('circle', [O, 5], {strokeColor: '#3b82f6', highlight: false, strokeWidth: 2});\nvar P = board.create('point', [5*Math.cos(90*Math.PI/180), 5*Math.sin(90*Math.PI/180)], {name: 'P', size: 2, color: '#64748b', label: {offset: [7.347880794884119e-16, 12]}});\nvar Q = board.create('point', [5*Math.cos(-30*Math.PI/180), 5*Math.sin(-30*Math.PI/180)], {name: 'Q', size: 2, color: '#64748b', label: {offset: [10.392304845413264, -5.999999999999999]}});\nvar R = board.create('point', [5*Math.cos(210*Math.PI/180), 5*Math.sin(210*Math.PI/180)], {name: 'R', size: 2, color: '#64748b', label: {offset: [-10.392304845413264, -6.000000000000002]}});\nboard.create('polygon', [P,R,Q], {fillColor: 'transparent', borders: {strokeColor: 'black'}});\nboard.create('segment', [O,P], {strokeColor: 'black'});\nboard.create('segment', [O,Q], {strokeColor: 'black'});\nboard.create('segment', [O,R], {strokeColor: 'black'});\nboard.create('angle', [Q,O,P], {radius: 1.5, name: '120°', label: {offset: [0, 0]}});\nboard.create('angle', [O,R,Q], {radius: 1, name: '40°', label: {offset: [0, 0]}});\nboard.create('angle', [R,O,Q], {radius: 1, name: 'α', label: {offset: [0, 0]}});\nboard.create('angle', [O,P,R], {radius: 1, name: 'β', label: {offset: [0, 0]}});\nboard.create('angle', [R,P,Q], {radius: 1, name: 'γ', label: {offset: [0, 0]}});\nboard.unsuspendUpdate();"
      }
    }
  },
  {
  ...
  },
  {
    ...
    "graphData": {
      "jsxGraph": {
        ...
        "script": "board.suspendUpdate();\nvar O = board.create('point', [0,0], {name: 'O', size: 2, color: 'red', label: {offset: [0, 10]}});\nvar circle = board.create('circle', [O, 5], {strokeColor: '#3b82f6', highlight: false, strokeWidth: 2});\nvar A = board.create('point', [-5,0], {name: 'A', size: 2, color: '#64748b', label: {offset: [0, 10]}});\nvar B = board.create('point', [5,0], {name: 'B', size: 2, color: '#64748b', label: {offset: [0, 10]}});\nvar F = board.create('point', [5*Math.cos(200*Math.PI/180), 5*Math.sin(200*Math.PI/180)], {name: 'F', size: 2, color: '#64748b', label: {offset: [-12, -12]}});\nvar G = board.create('point', [5*Math.cos(340*Math.PI/180), 5*Math.sin(340*Math.PI/180)], {name: 'G', size: 2, color: '#64748b', label: {offset: [12, -12]}});\nboard.create('segment', [A,B], {strokeColor: 'black', lastArrow: true});\nboard.create('segment', [F,G], {strokeColor: 'black', lastArrow: true});\nboard.create('segment', [A,G], {strokeColor: 'black'});\nboard.create('segment', [F,B], {strokeColor: 'black'});\nvar M = board.create('intersection', [board.create('line',[A,G],{visible:false}), board.create('line',[F,B],{visible:false}), 0], {name: '', visible: false});\nboard.create('angle', [A,B,F], {radius: 1.5, name: '10°', label: {offset: [0, 0]}});\nboard.create('angle', [A,F,G], {radius: 1, name: 'α', label: {offset: [0, 0]}});\nboard.create('angle', [F,M,G], {radius: 1, name: 'β', label: {offset: [0, 0]}});\nboard.unsuspendUpdate();"
      }
    }
  },
  {
    ...
    "graphData": {
      "jsxGraph": {
        ...
        "script": "board.suspendUpdate();\nvar O = board.create('point', [0,0], {name: 'O', size: 2, color: 'red', label: {offset: [0, 10]}});\nvar circle = board.create('circle', [O, 5], {strokeColor: '#3b82f6', highlight: false, strokeWidth: 2});\nvar A = board.create('point', [5*Math.cos(240*Math.PI/180), 5*Math.sin(240*Math.PI/180)], {name: 'A', size: 2, color: '#64748b', label: {offset: [0, 10]}});\nvar B = board.create('point', [5*Math.cos(60*Math.PI/180), 5*Math.sin(60*Math.PI/180)], {name: 'B', size: 2, color: '#64748b', label: {offset: [0, 10]}});\nvar P = board.create('point', [5,0], {name: 'P', size: 2, color: '#64748b', label: {offset: [0, 10]}});\nboard.create('segment', [A,B], {strokeColor: 'black'});\nvar OA = board.create('segment', [O,A], {strokeColor: 'black'});\nvar AP = board.create('segment', [A,P], {strokeColor: 'black'});\nvar OP = board.create('segment', [O,P], {strokeColor: 'black'});\nvar BP = board.create('segment', [B,P], {strokeColor: 'black'});\nboard.create('ticks', [OA], {ticks: 2});\nboard.create('ticks', [AP], {ticks: 2});\nboard.create('angle', [A,O,P], {radius: 1, name: 'α', label: {offset: [0, 0]}});\nboard.create('angle', [O,B,P], {radius: 1.5, name: 'β', label: {offset: [0, 0]}});\nboard.unsuspendUpdate();"
      }
    }
  },
  {
    ...
    "graphData": {
      "jsxGraph": {
        ...
        "script": "board.suspendUpdate();\nvar O = board.create('point', [0,0], {name: 'O', size: 2, color: 'red', label: {offset: [0, 10]}});\nvar circle = board.create('circle', [O, 5], {strokeColor: '#3b82f6', highlight: false, strokeWidth: 2});\nvar P = board.create('point', [5*Math.cos(150*Math.PI/180), 5*Math.sin(150*Math.PI/180)], {name: 'P', size: 2, color: '#64748b', label: {offset: [0, 10]}});\nvar Q = board.create('point', [5*Math.cos(250*Math.PI/180), 5*Math.sin(250*Math.PI/180)], {name: 'Q', size: 2, color: '#64748b', label: {offset: [0, 10]}});\nvar R = board.create('point', [5*Math.cos(290*Math.PI/180), 5*Math.sin(290*Math.PI/180)], {name: 'R', size: 2, color: '#64748b', label: {offset: [0, 10]}});\nboard.create('segment', [O,P], {strokeColor: 'black'});\nboard.create('segment', [O,R], {strokeColor: 'black', lastArrow: true});\nboard.create('polygon', [P,Q,R], {fillColor: 'transparent', borders: {strokeColor: 'black'}});\nboard.create('segment', [P,Q], {strokeColor: 'black', lastArrow: true});\nboard.create('angle', [O,R,P], {radius: 1.5, name: '20°', label: {offset: [5, 10]}});\nboard.create('angle', [O,P,Q], {radius: 1.2, name: 'α', label: {offset: [-10, -5]}});\nboard.create('angle', [P,Q,R], {radius: 1, name: 'β', label: {offset: [0, -15]}});\nboard.create('angle', [P,O,R], {radius: 1, name: 'γ', label: {offset: [-5, 15]}});\nboard.unsuspendUpdate();"
      }
    }
  },
  {
    ...
    "graphData": {
      "jsxGraph": {
        ...
        "script": "board.suspendUpdate();\nvar O = board.create('point', [0,0], {name: 'O', size: 2, color: 'red', label: {offset: [0, 10]}});\nvar circle = board.create('circle', [O, 5], {strokeColor: '#3b82f6', highlight: false, strokeWidth: 2});\nvar A = board.create('point', [5*Math.cos(190*Math.PI/180), 5*Math.sin(190*Math.PI/180)], {name: 'A', size: 2, color: '#64748b', label: {offset: [0, 10]}});\nvar B = board.create('point', [5*Math.cos(50*Math.PI/180), 5*Math.sin(50*Math.PI/180)], {name: 'B', size: 2, color: '#64748b', label: {offset: [0, 10]}});\nvar C = board.create('point', [5*Math.cos(310*Math.PI/180), 5*Math.sin(310*Math.PI/180)], {name: 'C', size: 2, color: '#64748b', label: {offset: [0, 10]}});\nboard.create('polygon', [A,B,C], {fillColor: 'transparent', borders: {strokeColor: 'black'}});\nboard.create('segment', [O,A], {strokeColor: 'black'});\nboard.create('segment', [O,B], {strokeColor: 'black'});\nboard.create('segment', [O,C], {strokeColor: 'black'});\nboard.create('angle', [A,O,B], {radius: 1, name: '140°', label: {offset: [5, 15]}});\nboard.create('angle', [C,A,B], {radius: 1, name: '50°', label: {offset: [15, 0]}});\nboard.create('angle', [A,O,C], {radius: 1, name: 'α', label: {offset: [-5, -15]}});\nboard.create('angle', [A,B,C], {radius: 1, name: 'β', label: {offset: [-10, -10]}});\nboard.create('angle', [A,C,B], {radius: 1, name: 'γ', label: {offset: [-10, 10]}});\nboard.unsuspendUpdate();"
      }
    }
  },
  {
    ...
    "graphData": {
      "jsxGraph": {
        ...
        "script": "board.suspendUpdate();\nvar O = board.create('point', [0,0], {name: 'O', size: 2, color: 'red', label: {offset: [0, 10]}});\nvar circle = board.create('circle', [O, 5], {strokeColor: '#3b82f6', highlight: false, strokeWidth: 2});\nvar P = board.create('point', [5*Math.cos(160*Math.PI/180), 5*Math.sin(160*Math.PI/180)], {name: 'P', size: 2, color: '#64748b', label: {offset: [0, 10]}});\nvar Q = board.create('point', [5,0], {name: 'Q', size: 2, color: '#64748b', label: {offset: [0, 10]}});\nvar R = board.create('point', [5*Math.cos(20*Math.PI/180), 5*Math.sin(20*Math.PI/180)], {name: 'R', size: 2, color: '#64748b', label: {offset: [0, 10]}});\nboard.create('segment', [O,P], {strokeColor: 'black'});\nboard.create('segment', [O,Q], {strokeColor: 'black', lastArrow: true});\nboard.create('segment', [O,R], {strokeColor: 'black'});\nboard.create('segment', [P,R], {strokeColor: 'black', lastArrow: true});\nboard.create('segment', [Q,R], {strokeColor: 'black'});\nboard.create('angle', [Q,O,P], {radius: 1, name: '160°', label: {offset: [-5, 15]}});\nboard.create('angle', [R,O,P], {radius: 0.8, name: 'α', label: {offset: [10, 5]}});\nboard.create('angle', [O,Q,R], {radius: 1, name: 'β', label: {offset: [-15, 5]}});\nboard.create('angle', [O,R,P], {radius: 1.5, name: 'γ', label: {offset: [-10, 5]}});\nboard.unsuspendUpdate();"
      }
    }
  },
  {
    ...
    "graphData": {
      "jsxGraph": {
        ...
        "script": "board.suspendUpdate();\nvar O = board.create('point', [0,0], {name: 'O', size: 2, color: 'red', label: {offset: [0, 10]}});\nvar circle = board.create('circle', [O, 5], {strokeColor: '#3b82f6', highlight: false, strokeWidth: 2});\nvar A = board.create('point', [5*Math.cos(170*Math.PI/180), 5*Math.sin(170*Math.PI/180)], {name: 'A', size: 2, color: '#64748b', label: {offset: [0, 10]}});\nvar B = board.create('point', [5*Math.cos(70*Math.PI/180), 5*Math.sin(70*Math.PI/180)], {name: 'B', size: 2, color: '#64748b', label: {offset: [0, 10]}});\nvar C = board.create('point', [5*Math.cos(-30*Math.PI/180), 5*Math.sin(-30*Math.PI/180)], {name: 'C', size: 2, color: '#64748b', label: {offset: [0, 10]}});\nboard.create('segment', [O,A], {strokeColor: 'black'});\nboard.create('segment', [O,B], {strokeColor: 'black'});\nboard.create('segment', [O,C], {strokeColor: 'black'});\nvar AB = board.create('segment', [A,B], {strokeColor: 'black'});\nvar BC = board.create('segment', [B,C], {strokeColor: 'black'});\nboard.create('segment', [A,C], {strokeColor: 'black'});\nboard.create('ticks', [AB], {ticks: 2});\nboard.create('ticks', [BC], {ticks: 2});\nboard.create('angle', [C,O,A], {radius: 1, name: '200°', label: {offset: [0, 0]}});\nboard.create('angle', [O,A,B], {radius: 1, name: 'α', label: {offset: [0, 0]}});\nboard.create('angle', [O,B,C], {radius: 1, name: 'β', label: {offset: [0, 0]}});\nboard.create('angle', [O,C,A], {radius: 1.5, name: 'γ', label: {offset: [0, 0]}});\nboard.unsuspendUpdate();"
      }
    }
  },
  {
    ...
    "graphData": {
      "jsxGraph": {
        ...
        "script": "board.suspendUpdate();\nvar O = board.create('point', [0,0], {name: 'O', size: 2, color: 'red', label: {offset: [0, 10]}});\nvar circle = board.create('circle', [O, 5], {strokeColor: '#3b82f6', highlight: false, strokeWidth: 2});\nvar A = board.create('point', [-5,0], {name: 'A', size: 2, color: '#64748b', label: {offset: [0, 10]}});\nvar B = board.create('point', [5,0], {name: 'B', size: 2, color: '#64748b', label: {offset: [0, 10]}});\nvar P = board.create('point', [5*Math.cos(60*Math.PI/180), 5*Math.sin(60*Math.PI/180)], {name: 'P', size: 2, color: '#64748b', label: {offset: [-5, 12]}});\nvar X = board.create('point', [8*Math.cos(60*Math.PI/180), 8*Math.sin(60*Math.PI/180)], {name: 'X', size: 2, color: '#64748b', visible: false, label: {offset: [0, 10]}});\nboard.create('segment', [A,B], {strokeColor: 'black'});\nboard.create('segment', [A,X], {strokeColor: 'red', dash: 2});\nboard.create('segment', [P,B], {strokeColor: 'black'});\nboard.create('segment', [O,P], {strokeColor: 'red', dash: 2});\nboard.create('angle', [B,A,P], {radius: 1, name: 'α', label: {offset: [0, 0]}});\nboard.create('angle', [P,B,A], {radius: 1, name: 'β', label: {offset: [0, 0]}});\nboard.unsuspendUpdate();"
      }
    }
  },
  {
    ...
    "graphData": {
      "jsxGraph": {
        ...
        "script": "board.suspendUpdate();\nvar O = board.create('point', [0,0], {name: 'O', size: 2, color: 'red', label: {offset: [0, 10]}});\nvar circle = board.create('circle', [O, 5], {strokeColor: '#3b82f6', highlight: false, strokeWidth: 2});\nvar A = board.create('point', [-5,0], {name: 'A', size: 2, color: '#64748b', label: {offset: [0, 10]}});\nvar B = board.create('point', [5,0], {name: 'B', size: 2, color: '#64748b', label: {offset: [0, 10]}});\nvar P = board.create('point', [5*Math.cos(60*Math.PI/180), 5*Math.sin(60*Math.PI/180)], {name: 'P', size: 2, color: '#64748b', label: {offset: [-5, 12]}});\nvar M = board.create('point', [5*Math.cos(240*Math.PI/180), 5*Math.sin(240*Math.PI/180)], {name: 'M', size: 2, color: '#64748b', visible: false, label: {offset: [0, 10]}});\nboard.create('segment', [A,B], {strokeColor: 'black'});\nboard.create('segment', [A,P], {strokeColor: 'black'});\nboard.create('segment', [P,B], {strokeColor: 'black'});\nboard.create('segment', [P,M], {strokeColor: 'red', dash: 2});\nboard.create('text', [-2.5, -4.3, 'M'], {fontSize: 14});\nboard.create('angle', [B,A,P], {radius: 1, name: 'α', label: {offset: [0, 0]}});\nboard.create('angle', [P,B,A], {radius: 1, name: 'β', label: {offset: [0, 0]}});\nboard.unsuspendUpdate();"
      }
    }
  },
  {
    ...
    "graphData": {
      "jsxGraph": {
        ...
        "script": "board.suspendUpdate();\nvar O = board.create('point', [0,0], {name: 'O', size: 2, color: 'red', label: {offset: [0, 10]}});\nvar circle = board.create('circle', [O, 5], {strokeColor: '#3b82f6', highlight: false, strokeWidth: 2});\nvar P = board.create('point', [0,5], {name: 'P', size: 2, color: '#64748b', label: {offset: [0, 10]}});\nvar A = board.create('point', [5*Math.cos(220*Math.PI/180), 5*Math.sin(220*Math.PI/180)], {name: 'A', size: 2, color: '#64748b', label: {offset: [0, 10]}});\nvar B = board.create('point', [5*Math.cos(320*Math.PI/180), 5*Math.sin(320*Math.PI/180)], {name: 'B', size: 2, color: '#64748b', label: {offset: [0, 10]}});\nvar X = board.create('point', [0,-5], {name: '', size: 0, visible: false, label: {offset: [0, 10]}});\nboard.create('segment', [P,A], {strokeColor: 'black'});\nboard.create('segment', [P,B], {strokeColor: 'black'});\nboard.create('segment', [O,A], {strokeColor: 'red', dash: 2});\nboard.create('segment', [O,B], {strokeColor: 'red', dash: 2});\nboard.create('segment', [P,X], {strokeColor: 'red', dash: 2});\nboard.create('angle', [O,P,A], {radius: 1, name: 'α', label: {offset: [0, 0]}});\nboard.create('angle', [B,P,O], {radius: 1.2, name: 'β', label: {offset: [0, 0]}});\nboard.unsuspendUpdate();"
      }
    }
  },
  {
    ...
    "graphData": {
      "jsxGraph": {
        ...
        "script": "board.suspendUpdate();\nvar O = board.create('point', [0,0], {name: 'O', size: 2, color: 'red', label: {offset: [0, 10]}});\nvar circle = board.create('circle', [O, 5], {strokeColor: '#3b82f6', highlight: false, strokeWidth: 2});\nvar P = board.create('point', [5*Math.cos(60*Math.PI/180), 5*Math.sin(60*Math.PI/180)], {name: 'P', size: 2, color: '#64748b', label: {offset: [0, 10]}});\nvar A = board.create('point', [5*Math.cos(220*Math.PI/180), 5*Math.sin(220*Math.PI/180)], {name: 'A', size: 2, color: '#64748b', label: {offset: [0, 10]}});\nvar B = board.create('point', [5*Math.cos(340*Math.PI/180), 5*Math.sin(340*Math.PI/180)], {name: 'B', size: 2, color: '#64748b', label: {offset: [0, 10]}});\nvar X = board.create('point', [5*Math.cos(240*Math.PI/180), 5*Math.sin(240*Math.PI/180)], {name: 'X', size: 2, color: '#64748b', label: {offset: [0, 10]}});\nboard.create('segment', [P,A], {strokeColor: 'black'});\nboard.create('segment', [P,B], {strokeColor: 'black'});\nboard.create('segment', [O,A], {strokeColor: 'red', dash: 2});\nboard.create('segment', [O,B], {strokeColor: 'red', dash: 2});\nboard.create('segment', [P,X], {strokeColor: 'red', dash: 2});\nboard.create('angle', [O,P,A], {radius: 1, name: 'α', label: {offset: [0, 0]}});\nboard.create('angle', [B,P,O], {radius: 1.5, name: 'β', label: {offset: [0, 0]}});\nboard.unsuspendUpdate();"
      }
    }
  },
  {
  ...
  },
  {
    ...
    "graphData": {
      "jsxGraph": {
        ...
        "script": "board.suspendUpdate();\nvar O = board.create('point', [0,0], {name: 'O (Centre)', size: 2, color: 'red', label: {offset: [0, 10]}});\nvar circle = board.create('circle', [O, 5], {strokeColor: '#3b82f6', highlight: false, strokeWidth: 2});\nvar P = board.create('point', [0,-5], {name: 'P (Punter)', size: 2, color: '#64748b', label: {offset: [0, 10]}});\nvar A = board.create('point', [5,0], {name: 'A (Start)', size: 2, color: '#64748b', label: {offset: [0, 10]}});\nvar H = board.create('point', [5*Math.cos(60*Math.PI/180), 5*Math.sin(60*Math.PI/180)], {name: 'H (Horse)', size: 2, color: '#10b981', label: {offset: [0, 10]}});\nboard.create('segment', [O,A], {strokeColor: '#9ca3af', dash: 2});\nboard.create('segment', [O,H], {strokeColor: '#9ca3af', dash: 2});\nboard.create('segment', [P,A], {strokeColor: '#9ca3af', dash: 2});\nboard.create('segment', [P,H], {strokeColor: 'black', lastArrow: true});\nboard.create('angle', [A,O,H], {radius: 1, name: '2θ', label: {offset: [0, 0]}});\nboard.create('angle', [A,P,H], {radius: 1.5, name: 'θ', label: {offset: [0, 0]}});\nboard.unsuspendUpdate();"
      }
    }
  }
];
