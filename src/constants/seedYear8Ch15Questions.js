export const Y8_CH15A_QUESTIONS = [
    ...
    "graphData": {
      "geometry": {
        ...
        "segments": [
          ...
          { "from": "C", "to": "D" },
          { "from": "D", "to": "A" },
          { "from": "L1", "to": "L2", "ticks": 1 },
          { "from": "L2", "to": "L3", "ticks": 1 },
          { "from": "L3", "to": "L4", "ticks": 1 },
          { "from": "L4", "to": "L1", "ticks": 1 },
          { "from": "R1", "to": "R2", "ticks": 1 },
          { "from": "R2", "to": "R3", "ticks": 1 },
          { "from": "R3", "to": "R4", "ticks": 1 },
          { "from": "R4", "to": "L1", "ticks": 1 }
        ],
        "angles": [
          { "at": "A", "right": true },
          { "at": "B", "right": true },
        ...
        "sideLabels": [
          { "between": ["D", "A"], "text": "5 m" },
          { "between": ["A", "B"], "text": "8 m" },
          { "between": ["L4", "L3"], "text": "2 m" },
          { "between": ["R4", "R3"], "text": "2 m" }
        ],
        "freeLabels": []
      }
    }
  ...
  // --- Question 2d ---
  {
    ...
    "graphData": {
      "geometry": {
        ...
        "sideLabels": [
          { "between": ["D", "A"], "text": "9 cm" },
          { "between": ["A", "B"], "text": "16 cm" },
          { "between": ["D", "E"], "text": "6 cm" },
          { "between": ["F", "C"], "text": "4 cm" }
        ],
        "freeLabels": []
      }
    }
  ...
  // --- Question 4 ---
  {
    ...
    "a": "(1, 20), (2, 10), (4, 5) and their reverses",
    "opts": [
    ...
    "graphData": {
      "geometry": {
        ...
        "segments": [
          ...
          { "from": "D", "to": "E" },
          { "from": "E", "to": "C" },
          { "from": "E", "to": "H", "dashed": true, "ticks": 1 }
        ],
        "angles": [],
        "sideLabels": [
          { "between": ["A", "B"], "text": "4m" }
  ...
  // --- Question 7 ---
  {
    ...
    "graphData": {
      "geometry": {
        ...
        "sideLabels": [
          { "between": ["A", "C"], "text": "13 cm" },
          { "between": ["A", "D"], "text": "5 cm" },
          { "between": ["D", "B"], "text": "15 cm" },
          { "between": ["C", "D"], "text": "h cm" }
        ],
        "freeLabels": []
      }
    },
  ...
  // --- Question 8 ---
  {
    ...
    "graphData": {
      "geometry": {
        ...
        "sideLabels": [
          { "between": ["D", "A"], "text": "8 m" },
          { "between": ["D", "C"], "text": "x m" },
          { "between": ["A", "C"], "text": "17 m" }
        ],
        "freeLabels": []
      }
    },
  ...
  // --- Question 10 ---
  {
    ...
    "graphData": {
      "geometry": {
        ...
        "sideLabels": [],
        "freeLabels": [
          { "point": [2.7, 5.2], "text": "family room" },
          { "point": [2.7, 1.7], "text": "patio" },
          { "point": [6.5, 5.2], "text": "kitchen" },
          { "point": [6.5, 1.7], "text": "hall" },
          { "point": [8.7, 3.5], "text": "lounge" }
        ]
      }
    },
    "subQuestions": [
