export const Y12A_CH10A_QUESTIONS = [
  ...
  },
  {
    ...
    "solutionSteps": [
      ...
      {
        "explanation": "Calculate the probability of drawing two black balls in succession without replacement.",
  ...
  },
  {
    ...
    "solutionSteps": [
      ...
      {
        "explanation": "We simplify the equation by adding all the known decimal numbers together on the left-hand side.",
  ...
  },
  {
    ...
    "solutionSteps": [
      ...
      {
        "explanation": "Substitute this value of \\(b = 0.05\\) back into the first equation to solve for \\(a\\).",
  ...
  },
  {
    ...
    "solutionSteps": [
      ...
      {
        "explanation": "First, we sum all the probabilities and set the sum equal to one, then simplify the constants.",
        "workingOut": "0.25 + 0.4 + a + b = 1 \\implies 0.65 + a + b = 1",
        "graphData": null
      },
      {
        "explanation": "Isolate the variables by subtracting zero point six five from both sides of the equation.",
        "workingOut": "a + b = 0.35",
        "graphData": null
      },
      {
  ...
  },
  {
    ...
    "solutionSteps": [
      ...
      {
        "explanation": "Subtract this equation from equation two to solve for \\(b\\).",
        "workingOut": "(3a + 4b) - (3a + 3b) = 1.15 - 1.05 \\implies b = 0.10",
        "graphData": null
      },
      {
        "explanation": "Substitute the value of \\(b = 0.10\\) back into equation one to solve for \\(a\\).",
        "workingOut": "a + 0.10 = 0.35 \\implies a = 0.25",
        "graphData": null
      },
      {
