export const CTHS_2020_QUESTIONS = [
  ...
  },
  {
    ...
    "solutionSteps": [
      {
        "explanation": "Rewrite each logarithm term using the log power rule $\\ln a^k = k\\ln a$, converting the series into a sum of multiples of $\\ln 2$.",
        "workingOut": "\\(\\ln 2^1 + \\ln 2^2 + \\ln 2^3 + \\cdots + \\ln 2^{2n} = 1\\cdot\\ln 2 + 2\\cdot\\ln 2 + 3\\cdot\\ln 2 + \\cdots + 2n\\cdot\\ln 2\\)",
        "graphData": null
      },
      {
        "explanation": "Factor $\\ln 2$ out of every term, leaving the arithmetic series $1+2+3+\\cdots+2n$ inside the brackets.",
      ...
      {
        "explanation": "Multiply this result back by $\\ln 2$ to get the value of the original series.",
  ...
  },
  {
    ...
    "difficulty": "hard",
    "timeLimit": 120,
    "question": "The graph of $y = f(x)$ is shown below. The coordinates $x = A$ and $x = C$ denote stationary points, and $x = B$ denotes a point of inflection. Over what domain is $f'(x) < 0$ and $f''(x) > 0$?",
    "opts": [
      "\\((-\\infty, A)\\)",
      "\\((A, B)\\)",
      "\\((B, C)\\)",
  ...
  },
  {
    ...
    "graphData": {
      "jsxGraph": {
        ...
        "script": "board.suspendUpdate();\nboard.create('arrow', [[-3,0],[4,0]], {strokeColor:'black'});\nboard.create('arrow', [[0,-4],[0,10]], {strokeColor:'black'});\nvar f=function(x){ return -(x+1)*Math.pow(x-2, 3); };\nboard.create('functiongraph', [f, -2.5, 3.5], {strokeColor:'#1d4ed8',strokeWidth:2});\nboard.create('point', [-1, 0], {name:'-1', size:2, color:'red', label:{offset:[-10,10]}});\nboard.create('point', [2, 0], {name:'2', size:2, color:'red', label:{offset:[10,10]}});\nboard.create('point', [0, 8], {name:'8', size:2, color:'red', label:{offset:[10,5]}});\nboard.create('text', [3.6, -0.4, 'x'], {fontSize:13});\nboard.create('text', [0.15, 9.5, 'y'], {fontSize:13});\nboard.create('point', [-0.25, 8.54], {name:'Max', size:2, color:'purple', label:{offset:[-10,15]}});\nboard.unsuspendUpdate();"
      }
    },
    "isNew": true,
