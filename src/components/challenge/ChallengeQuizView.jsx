...
const ChallengeQuizView = ({
  ...
  // Fraction entry is handled by MathInput's built-in fraction builder:
  // inserting any \frac template (toolbar a/b or the virtual keyboard's own
  // fraction key) opens native numeric inputs instead of empty placeholders.
