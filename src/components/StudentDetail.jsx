      ...
      case 'curriculum':
        return (
          <div style={{ display: 'flex', flexDirection: 'column', gap: '32px' }}>
            ...
            <div style={styles.card} className="profile-card-mobile">
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '32px', flexWrap: 'wrap', gap: '20px' }}>
                <div className="section-title" style={{ fontSize: '0.75rem', fontWeight: 800, color: '#94a3b8', letterSpacing: '0.1em', textTransform: 'uppercase', margin: 0 }}>BASIC CALCULATION (V1.5)</div>
                <div style={{ display: 'flex', alignItems: 'center', gap: '20px' }}>
                  ...
                  <div style={{ 
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                      <span style={{ fontSize: '0.7rem', fontWeight: 900, color: '#92400e' }}>TIMER:</span>
                      <select 
                        value={student.calcTimeLimit || 30} 
                        onChange={e => handleUpdateCurriculumSetting('calcTimeLimit', parseInt(e.target.value) || 30)}
                        style={{ background: 'white', border: '1px solid #fcd34d', borderRadius: '6px', fontWeight: 900, color: '#92400e', outline: 'none', padding: '2px 4px', fontSize: '1rem', cursor: 'pointer' }}
                      >
                    ...
                    <div style={{ width: '2px', height: '20px', background: '#fcd34d' }}></div>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                      <span style={{ fontSize: '0.7rem', fontWeight: 900, color: '#92400e' }}>COUNT:</span>
                      <input 
                        type="number" 
                        min="5" 
                        max="50"
                        ...
                        style={{ width: '45px', background: 'white', border: '1px solid #fcd34d', borderRadius: '6px', fontWeight: 900, color: '#92400e', outline: 'none', textAlign: 'center', fontSize: '1rem' }}
                      />
                    </div>
                  </div>
                </div>
