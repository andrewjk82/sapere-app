...
// ========================================================
// Q1: Pencil case word equation problem (a to c)
// ========================================================
questions.push({
  chapterId: 'y7-15',
...
// ========================================================
// Q2: Solve equation mentally (a to l)
// ========================================================
const q2Params = [
  { eq: 'x + 4 = 12', ans: '8', o: ['8', '16', '6', '12'], step: '$$x = 12 - 4 = 8$$' },
  { eq: 'x - 6 = 13', ans: '19', o: ['19', '7', '18', '20'], step: '$$x = 13 + 6 = 19$$' },
  { eq: 'x - 7 = 11', ans: '18', o: ['18', '4', '17', '21'], step: '$$x = 11 + 7 = 18$$' },
  { eq: '3x = 12', ans: '4', o: ['4', '9', '15', '36'], step: '$$x = \\frac{12}{3} = 4$$' },
  { eq: 'x - 15 = 8', ans: '23', o: ['23', '7', '22', '15'], step: '$$x = 8 + 15 = 23$$' },
  { eq: '\\frac{x}{4} = 8', ans: '32', o: ['32', '2', '12', '16'], step: '$$x = 8 \\times 4 = 32$$' },
  { eq: '3x + 4 = 19', ans: '5', o: ['5', '6', '15', '8'], step: '$$3x = 19 - 4 = 15 \\implies x = \\frac{15}{3} = 5$$' },
  { eq: '19 - x = 12', ans: '7', o: ['7', '31', '6', '8'], step: '$$x = 19 - 12 = 7$$' },
  { eq: '2x + 8 = 17', ans: '4.5', o: ['4.5', '9', '5', '4'], step: '$$2x = 17 - 8 = 9 \\implies x = \\frac{9}{2} = 4.5$$' },
  { eq: '24 - 3x = 0', ans: '8', o: ['8', '24', '12', '6'], step: '$$3x = 24 \\implies x = \\frac{24}{3} = 8$$' },
  { eq: '\\frac{x}{5} = 7', ans: '35', o: ['35', '12', '2', '40'], step: '$$x = 7 \\times 5 = 35$$' },
  { eq: '\\frac{x}{6} = 15', ans: '90', o: ['90', '21', '9', '60'], step: '$$x = 15 \\times 6 = 90$$' }
];

q2Params.forEach((p, i) => {
  questions.push({
    chapterId: 'y7-15',
    chapterTitle: 'Chapter 15: Equations',
    topicId: 'y7-15a',
    ...
    isActive: true,
    isManual: true,
    question: `Solve the equation mentally: $$${p.eq}$$`,
    options: p.o.map(x => `$$x = ${x}$$`),
    answer: 0,
    solution: `<div style="text-align: left;"><p>Solving the equation:</p><p>${p.step}</p></div>`,
    createdAt: new Date().toISOString()
  });
});

// ========================================================
// Q3: Solve equation for a mentally (a to h)
// ========================================================
const q3Params = [
  { eq: 'a + 5 = 14', ans: '9', o: ['9', '19', '8', '10'], step: '$$a = 14 - 5 = 9$$' },
  { eq: 'a - 8 = 21', ans: '29', o: ['29', '13', '28', '30'], step: '$$a = 21 + 8 = 29$$' },
  { eq: '3a = 45', ans: '15', o: ['15', '42', '12', '13'], step: '$$a = \\frac{45}{3} = 15$$' },
  { eq: '6a = 42', ans: '7', o: ['7', '36', '8', '9'], step: '$$a = \\frac{42}{6} = 7$$' },
  { eq: '\\frac{a}{6} = 8', ans: '48', o: ['48', '14', '2', '24'], step: '$$a = 8 \\times 6 = 48$$' },
  { eq: '4a + 9 = 25', ans: '4', o: ['4', '16', '5', '6'], step: '$$4a = 25 - 9 = 16 \\implies a = \\frac{16}{4} = 4$$' },
  { eq: '17 - a = 9', ans: '8', o: ['8', '26', '7', '9'], step: '$$a = 17 - 9 = 8$$' },
  { eq: '3a + 12 = 39', ans: '9', o: ['9', '27', '8', '10'], step: '$$3a = 39 - 12 = 27 \\implies a = \\frac{27}{3} = 9$$' }
];

q3Params.forEach((p, i) => {
  questions.push({
    chapterId: 'y7-15',
    chapterTitle: 'Chapter 15: Equations',
    topicId: 'y7-15a',
    ...
    isManual: true,
    question: `Solve the equation mentally: $$${p.eq}$$`,
    options: p.o.map(x => `$$a = ${x}$$`),
    answer: 0,
    solution: `<div style="text-align: left;"><p>Solving the equation for $a$:</p><p>${p.step}</p></div>`,
    createdAt: new Date().toISOString()
  });
});

// ========================================================
// Q4: Chocolate boxes problem (a and b)
// ========================================================
questions.push({
  chapterId: 'y7-15',
  chapterTitle: 'Chapter 15: Equations',
...
// ========================================================
// Q5: Marbles bags problem (a and b)
// ========================================================
questions.push({
  chapterId: 'y7-15',
  chapterTitle: 'Chapter 15: Equations',
...
// ========================================================
// Q6: Minibus passengers problem (a and b)
// ========================================================
questions.push({
  chapterId: 'y7-15',
  chapterTitle: 'Chapter 15: Equations',
...
// ========================================================
// Q7: Craig packets chocolates (a and b)
// ========================================================
questions.push({
  chapterId: 'y7-15',
  chapterTitle: 'Chapter 15: Equations',
...
// ========================================================
// Q8: Sally stickers problem (a and b)
// ========================================================
questions.push({
  chapterId: 'y7-15',
  chapterTitle: 'Chapter 15: Equations',
...
// ========================================================
// Q9: Substitution in simple formula
// ========================================================
questions.push({
  chapterId: 'y7-15',
  chapterTitle: 'Chapter 15: Equations',
...
// ========================================================
// Q10: Substitution in linear formula
// ========================================================
questions.push({
  chapterId: 'y7-15',
  chapterTitle: 'Chapter 15: Equations',
...
// ========================================================
// Q11: Substitution in linear formula subtraction
// ========================================================
questions.push({
  chapterId: 'y7-15',
  chapterTitle: 'Chapter 15: Equations',
...
console.log('Total Chapter 15A questions built:', questions.length);
...
fs.writeFileSync('src/scripts/importYear7Ch15A.js', output);
console.log('Done!');
