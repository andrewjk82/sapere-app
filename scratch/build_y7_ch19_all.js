...
// ========================================================
// Q1: The local vet weighed each dog (Q1: Split into individual questions A, B, C)
// ========================================================
...
// ========================================================
// Q2: Brad's golf scores (Q2: Split into individual questions A, B, C, D)
// ========================================================
...
// ========================================================
// Q3: Zoologist counted organisms (Q3: Composite Question)
// ========================================================
questions.push({
  chapterId: 'y7-19',
  chapterTitle: 'Chapter 19: Numerical Data',
...
// ========================================================
// Q4: Handspan of class members (Q4: Composite Question with Image)
// ========================================================
questions.push({
  chapterId: 'y7-19',
  chapterTitle: 'Chapter 19: Numerical Data',
...
console.log('Total Chapter 19A questions built:', questions.length);
...
fs.writeFileSync('src/scripts/importYear7Ch19A.js', output);
console.log('Done!');
