...
## [13] 추가 시드 변환 규칙 (초중요)
수학 교육용 서비스의 문제 시드 데이터(JSON/JS Array 포맷)를 다음 3가지 규칙에 맞추어 변환해야 합니다:
...
- 학생들이 쉽게 이해할 수 있도록 3~5단계의 자세한 단계별 설명을 제공합니다.
...
- 객관식(multiple_choice) 보기에 정답 수식이 잘 보이게 하기 위해 가끔 식이 들어갈 수 있으나, 불필요한 식을 여기에 중복 기재할 필요는 없습니다.
