...
async function run() {
  ...
  <!-- 50 deg arc (sweep-flag flipped to 1) -->
  <path d="M 81,115.8 A 25,25 0 0,1 72.1,135.0" class="arc" />
  ...
  <!-- beta arc (sweep-flag flipped to 1) -->
  <path d="M 231.5,137.5 A 25,25 0 0,1 219,115.8" class="arc" />
  <text x="222" y="133" class="text-math" fill="#3b82f6">β</text>

  <!-- gamma arc (sweep-flag flipped to 1) -->
  <path d="M 151.3,229.4 A 25,25 0 0,1 179.9,226.9" class="arc" />
  ...
  console.log('Fixed y10-13a-q5d sweep-flags for A, B, C arcs');
