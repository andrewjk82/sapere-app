...
const geo = {
  ...
  // α is in Sector 0 of I1 (Bottom-Right, interior)
  // 130° needs to be in Sector 3 of I2 (Top-Right, interior) to be co-interior!
  angles: [
    { at:'I1', label:'α' },
    { at:'I2' }, // Sector 0 (empty)
    { at:'I2' }, // Sector 1 (empty)
    { at:'I2' }, // Sector 2 (empty)
    { at:'I2', label:'130°' } // Sector 3 (Top-Right, interior)
  ]
};
...
async function run() {
  ...
  console.log('Successfully corrected co-interior angles mapping for y9-7a-q3a!');
}
