...
// Inverting B/C and A/D sweep flags to ensure they curve inwards.
// Let's set:
// - A: sweep-flag = 0 (curves inward)
// - B: sweep-flag = 0 (curves inward)
// - C: sweep-flag = 0 (curves inward)
// - D: sweep-flag = 1 (curves inward)
const updates = {
  ...
  <!-- Angles -->
  <!-- D: 55deg (curves inwards with sweep-flag 1) -->
