...
// 15 new unique questions (y11a-5-newq139 to newq153) under topic 5A
const newQuestions = [
  {
    "id": "y11a-5-newq139",
    "chapterId": "y11a-5",
    ...
    "question": "A subsea pipeline depth model follows the rational curve \\(y = \\frac{12}{x}\\). If it is translated 5 units to the left and 3 units upward, find the new model equation.",
    "opts": [
      "\\(y = \\frac{12}{x + 5} + 3\\)",
      "\\(y = \\frac{12}{x - 5} + 3\\)",
      "\\(y = \\frac{12}{x + 5} - 3\\)",
    ...
    "solutionSteps": [
      {
        ...
        "workingOut": "Given: \\(y = \\frac{12}{x}\\), Horizontal: 5 units left, Vertical: 3 units up"
      },
      {
        ...
        "workingOut": "\\(x \\;\u2192\\; x + 5 \\;\\Rightarrow\\; y = \\frac{12}{x + 5}\\)"
      },
      {
  ...
  },
  {
    ...
    "difficulty": "medium",
    "type": "multiple_choice",
    "question": "A high-precision optical laser path is modeled by \\(y = (x - 6)^2 + 4\\). If the path is translated 2 units to the right and 3 units downward, find the new path equation.",
    "opts": [
      "\\(y = (x - 8)^2 + 1\\)",
      "\\(y = (x - 4)^2 + 1\\)",
      "\\(y = (x - 8)^2 + 7\\)",
    ...
    "solutionSteps": [
      {
        ...
        "workingOut": "Given: \\(y = (x - 6)^2 + 4\\), Horizontal: 2 units right, Vertical: 3 units down"
      },
      {
        ...
        "workingOut": "\\(x \\;\u2192\\; (x - 2) \\;\\Rightarrow\\; y = ((x - 2) - 6)^2 + 4\\)"
      },
      {
  ...
  },
  {
    ...
    "difficulty": "medium",
    "type": "multiple_choice",
    "question": "A cylindrical sensor boundary is represented by \\((x - 2)^2 + (y + 4)^2 = 36\\). If the machine is calibrated to translate the scan 3 units to the right and 2 units upward, find the new boundary equation.",
    "opts": [
      "\\((x - 5)^2 + (y + 2)^2 = 36\\)",
      "\\((x + 1)^2 + (y + 2)^2 = 36\\)",
      "\\((x - 5)^2 + (y + 6)^2 = 36\\)",
    ...
    "solutionSteps": [
      {
        ...
        "workingOut": "Given: \\((x - 2)^2 + (y + 4)^2 = 36\\)"
      },
      {
      ...
      },
      {
        ...
        "workingOut": "\\(((x - 3) - 2)^2 + ((y - 2) + 4)^2 = 36 \\;\\Rightarrow\\; (x - 5)^2 + (y + 2)^2 = 36\\)"
      }
    ],
    "isNew": true,
    "graphData": null
  },
  {
    ...
    "difficulty": "medium",
    "type": "multiple_choice",
    "question": "A logistics vehicle's route line is defined by \\(y = -2x + 4\\). Write the equation of the route after it is translated 4 units to the left.",
    "opts": [
      "\\(y = -2(x + 4) + 4\\)",
      "\\(y = -2(x - 4) + 4\\)",
      "\\(y = -2x - 4\\)",
    ...
    "solutionSteps": [
      {
        ...
        "workingOut": "Given: \\(y = -2x + 4\\) and translation of 4 units left"
      },
      {
        ...
        "workingOut": "\\(x \\;\u2192\\; (x + 4) \\;\\Rightarrow\\; y = -2(x + 4) + 4\\)"
      },
      {
  ...
  },
  {
    ...
    "difficulty": "medium",
    "type": "multiple_choice",
    "question": "A satellite trajectory profile is defined by \\(y = 3x^3 - 5\\). If the tracking model translates the curve 4 units to the right, write the new equation.",
    "opts": [
      "\\(y = 3(x - 4)^3 - 5\\)",
      "\\(y = 3(x + 4)^3 - 5\\)",
      "\\(y = 3x^3 - 17\\)",
    ...
    "solutionSteps": [
      {
        ...
        "workingOut": "Given: \\(y = 3x^3 - 5\\) and translation: 4 units right"
      },
      {
  ...
  },
  {
    ...
    "difficulty": "medium",
    "type": "multiple_choice",
    "question": "A thermal fluid channel boundary follows the curve \\(y = \\frac{16}{x}\\). If the channel is translated 2 units to the right and 3 units downward, find the new boundary equation.",
    "opts": [
      "\\(y = \\frac{16}{x - 2} - 3\\)",
      "\\(y = \\frac{16}{x + 2} - 3\\)",
      "\\(y = \\frac{16}{x - 2} + 3\\)",
    ...
    "solutionSteps": [
      {
        ...
        "workingOut": "Given: \\(y = \\frac{16}{x}\\), Horizontal: 2 units right, Vertical: 3 units down"
      },
      {
        ...
        "workingOut": "\\(x \\;\u2192\\; x - 2 \\;\\Rightarrow\\; y = \\frac{16}{x - 2}\\)"
      },
      {
  ...
  },
  {
    ...
    "difficulty": "medium",
    "type": "multiple_choice",
    "question": "A robotics arm path is defined by \\(y = (x + 2)^2 - 5\\). Describe the translation required to map this path onto the new trajectory \\(y = (x - 3)^2 - 5\\).",
    "opts": [
    ...
    "solutionSteps": [
      {
        ...
        "workingOut": "Initial: \\(y_1 = (x + 2)^2 - 5\\), Target: \\(y_2 = (x - 3)^2 - 5\\)"
      },
      {
  ...
  },
  {
    ...
    "difficulty": "medium",
    "type": "multiple_choice",
    "question": "A suspension cable contour follows the curve \\(y = x^2 - 4x + 2\\). If the engineering model is translated 4 units vertically upward, find the new equation of the cable.",
    "opts": [
      "\\(y = x^2 - 4x + 6\\)",
      "\\(y = x^2 - 4x - 2\\)",
      "\\(y = (x - 4)^2 - 4x + 2\\)",
    ...
    "solutionSteps": [
      {
        ...
        "workingOut": "Given: \\(y = x^2 - 4x + 2\\) and shift: +4 units vertically"
      },
      {
        ...
        "workingOut": "\\(y_{\\text{new}} = (x^2 - 4x + 2) + 4\\)"
      },
      {
  ...
  },
  {
    ...
    "difficulty": "medium",
    "type": "multiple_choice",
    "question": "A conveyor track's trajectory is modeled by the cubic function \\(y = (x - 1)^3 + 6\\). If the track is translated 2 units to the right, find the new path equation.",
    "opts": [
      "\\(y = (x - 3)^3 + 6\\)",
      "\\(y = (x + 1)^3 + 6\\)",
      "\\(y = (x - 3)^3 + 8\\)",
    ...
    "solutionSteps": [
      {
        ...
        "workingOut": "Given: \\(y = (x - 1)^3 + 6\\) and shift of 2 units right"
      },
      {
  ...
  },
  {
    ...
    "difficulty": "medium",
    "type": "multiple_choice",
    "question": "A high-precision laser alignment line follows the model \\(y = 2x - 3\\). If the alignment is translated 3 units to the right and 2 units downward, find the new linear equation.",
    "opts": [
      "\\(y = 2x - 11\\)",
      "\\(y = 2x - 3\\)",
      "\\(y = 2(x - 3) - 3\\)",
    ...
    "solutionSteps": [
      ...
      },
      {
        ...
        "workingOut": "\\(x \\;\u2192\\; (x - 3)\\) and \\(y \\;\u2192\\; y - 2 \\;\\Rightarrow\\; y = 2(x - 3) - 3 - 2\\)"
      },
      {
        ...
        "workingOut": "\\(y = 2x - 6 - 5 \\;\\Rightarrow\\; y = 2x - 11\\)"
      }
    ],
    "isNew": true,
    "graphData": null
  },
  {
    ...
    "difficulty": "medium",
    "type": "multiple_choice",
    "question": "A digital imaging sensor maps pixel intensity along the curve \\(y = x^2 - 10x + 22\\). Find the vertex of this intensity model by completing the square.",
    "opts": [
      "\\((5, -3)\\)",
      "\\((-5, -3)\\)",
      "\\((5, 3)\\)",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "type": "multiple_choice",
    "question": "A mechanical link deflection is modeled by \\(y = x^2 + 8x + 13\\). Complete the square to determine the coordinate pair of its minimum point.",
    "opts": [
      "\\((-4, -3)\\)",
      "\\((4, -3)\\)",
      "\\((-4, 3)\\)",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "type": "multiple_choice",
    "question": "A thermal expansion profile follows the parabola \\(y = x^2 - 12x + 31\\). Express the equation in vertex form to find the coordinates of the turning point.",
    "opts": [
      "\\((6, -5)\\)",
      "\\((-6, -5)\\)",
      "\\((6, 5)\\)",
...
async function run() {
  console.log(`Adding 15 new questions (139 to 153)...`);
