...
const geo = {
  rArc: 15, // Reduced arc radius!
  rLabel: 28, // Reduced label offset!
  points: {
    A: [151.11, 43.33],
    B: [93.33, 158.89],
    C: [237.78, 43.33],
  ...
  angles: [
    { at:'B' }, // Sector 0
    { at:'B', label:'75°' }, // Sector 1
    { at:'E' }, // Sector 0
    { at:'E', label:'γ' }, // Sector 1
    { at:'E' }, // Sector 2
    { at:'E', label:'β' }, // Sector 3
    { at:'F', label:'α' } // Sector 0
  ]
};
...
async function run() {
  ...
  for (const id of ids) {
    ...
    console.log(`Successfully reduced arc size and cleaned layout for ${id}!`);
  }
}
