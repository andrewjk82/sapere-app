...
board.unsuspendUpdate();`;
  ...
  const baseGraphData = {
    jsxGraph: {
      ...
      showConstructionPoints: true, // CRITICAL FIX: prevents JsxGraphDiagram component from hiding circle construction points!
      script: graphScript
    }
  };
  ...
  console.log("Successfully fixed circle visibility by adding showConstructionPoints: true!");
  process.exit(0);
}
