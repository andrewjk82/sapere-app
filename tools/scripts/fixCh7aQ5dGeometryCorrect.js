...
const geo = {
  ...
  angles: [
    { at:'S', label:'α' },
    { at:'T', label:'β' },
    { at:'R' }, // Sector 0 (exterior bottom)
    { at:'R', label:'30°' }, // Sector 1 (left triangle RSU interior)
    { at:'R', label:'50°' }, // Sector 2 (right triangle RUT interior)
    { at:'U', label:'60°' }, // Sector 0 (right triangle RUT interior)
    { at:'U', label:'70°' }  // Sector 1 (left triangle RSU interior)
  ]
};
