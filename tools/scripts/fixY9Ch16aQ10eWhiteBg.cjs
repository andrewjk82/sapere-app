...
// Change background-color:#f8fafc to background-color:#ffffff
if (questions[qIndex].graphData && questions[qIndex].graphData.svg) {
  questions[qIndex].graphData.svg = questions[qIndex].graphData.svg.replace('background-color:#f8fafc', 'background-color:#ffffff');
}
if (questions[qIndex].solutionSteps && questions[qIndex].solutionSteps[0] && questions[qIndex].solutionSteps[0].graphData) {
  questions[qIndex].solutionSteps[0].graphData.svg = questions[qIndex].solutionSteps[0].graphData.svg.replace('background-color:#f8fafc', 'background-color:#ffffff');
}
...
async function run() {
  ...
  console.log('Successfully updated background color to white in DB.');
  process.exit(0);
}
