...
async function run() {
  ...
  <polygon points="115,115.8 105,110.8 105,120.8" class="parallel-arrow" /> <!-- on PR (moved left to avoid text) -->
  ...
  <!-- 160 deg arc at O (radius 30) -->
  <path d="M 180,150 A 30,30 0 0,0 121.8,139.7" class="arc" />
  <text x="135" y="125" class="text-label">160°</text>

  <!-- alpha arc at POR (radius 20) -->
  <path d="M 168.8,143.2 A 20,20 0 0,0 131.2,143.2" class="arc" />
  <text x="145" y="142" class="text-math" fill="#3b82f6">α</text>
  ...
  console.log('Fixed y10-13a-q5e center arcs and text positions');
