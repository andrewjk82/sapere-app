...
const geo = {
  points: {
    E: [197.82, 147.08],
    T_S: [78.97, 52], T_E: [269.14, 52],
    B_S: [78.97, 218.4], B_E: [269.14, 218.4]
  },
  segments: [
    { from:'T_S', to:'T_E', marks:1 },
    { from:'B_S', to:'B_E', marks:1 },
    { from:'T_E', to:'E' },
    { from:'E', to:'B_E' }
  ],
  angles: [
    { at:'T_E', label:'40°' }, // Sector 0 (Bottom-Left)
    { at:'B_E', label:'30°' }, // Sector 0 (Top-Left)
    { at:'E' }, // Sector 0 (Left-facing)
    { at:'E', label:'θ' } // Sector 1 (Right-facing, interior of < shape)
  ]
};
...
async function run() {
  ...
  console.log('Successfully fixed geometry for y9-7a-q3f!');
}
