...
export const allQuestions = [
  ...
  },
  {
    ...
    "answer": 2,
    "solution": "<div style=\"text-align: left;\">\n      <p><strong>Pedagogical Note:</strong> <em>Converting: To convert a fraction to a decimal, use division or find an equivalent fraction with a power of 10 denominator.</em></p>\n    <p><strong>Step-by-step breakdown:</strong></p>\n      <p>\\(0.7\\) has 1 decimal place, so the denominator is \\(10\\). Thus, \\(0.7 = \\frac{7}{10}\\) (already in simplest form).</p>\n    </div>",
    "createdAt": "2026-05-17T12:29:11.733Z"
  },
  {
    "chapterId": "y7-7",
  ...
  },
  {
    ...
    "answer": 0,
    "solution": "<div style=\"text-align: left;\">\n      <p><strong>Pedagogical Note:</strong> <em>Recurring Decimals: Fractions that don't terminate produce repeating cycles. Use dot notation for repeating digits.</em></p>\n    <p><strong>Step-by-step breakdown:</strong></p>\n      <p>Divide \\(1\\) by \\(3\\) using long division:<br>\\(1.000... \\div 3 = 0.3333...\\)<br>Since the digit \\(3\\) repeats indefinitely, we write it as a recurring decimal: \\(0.\\dot{3}\\).</p>\n    </div>",
    "createdAt": "2026-05-17T12:29:11.733Z"
  },
  {
    "chapterId": "y7-7",
  ...
  },
  {
    ...
    "answer": 2,
    "solution": "<div style=\"text-align: left;\">\n      <p><strong>Pedagogical Note:</strong> <em>Adding/Subtracting: Always align the decimal points! If subtracting ragged decimals, pad the shorter number with zeros at the end.</em></p>\n    <p><strong>Step-by-step breakdown:</strong></p>\n      <p>Align the decimal points and add:<br>$\\(\\begin{aligned} &5.827 \\\\ + \\;&4.650 \\\\ \\hline &10.477 \\end{aligned}\\)$</p>\n    </div>",
    "createdAt": "2026-05-17T12:29:11.733Z",
    "timeLimit": 30
  },
  {
  ...
  },
  {
    ...
    "answer": 2,
    "solution": "<div style=\"text-align: left;\">\n      <p><strong>Pedagogical Note:</strong> <em>Multiplying Decimals: Ignore the decimal points, multiply as whole numbers, then ensure the answer has the total number of decimal places of the factors.</em></p>\n    <p><strong>Step-by-step breakdown:</strong></p>\n      <p>Step 1: Multiply ignoring the decimal point: \\(345 \\times 16 = 5520\\).<br>Step 2: Re-introduce the single decimal place: \\(552.0 = 552\\).</p>\n    </div>",
    "createdAt": "2026-05-17T12:29:11.733Z"
  },
  {
    "chapterId": "y7-7",
  ...
  },
  {
    ...
    "answer": 0,
    "solution": "<div style=\"text-align: left;\">\n      <p><strong>Pedagogical Note:</strong> <em>Multiplying/Dividing by 10s: Move the decimal point to the right for multiplication, and left for division by the number of zeros.</em></p>\n    <p><strong>Step-by-step breakdown:</strong></p>\n      <p>Multiplying by \\(100\\) shifts the decimal point two places to the right:<br>\\(7.304 \\rightarrow 73.04 \\rightarrow 730.4\\).</p>\n    </div>",
    "createdAt": "2026-05-17T12:29:11.733Z"
  },
  {
    "chapterId": "y7-7",
