...
async function run() {
  ...
  <!-- gamma arc at POR -->
  <!-- O(150, 150). OP vector (-86.6, -50), OR vector (34.2, 94). -->
  ...
  <!-- beta arc at PQR (vertex Q) -->
  <!-- Q(115.8, 244). QP vector (-52.4, -144). QR vector (68.4, 0). -->
  <path d="M 108.9,225.1 A 20,20 0 0,0 135.8,244" class="arc" />
  ...
  console.log('Fixed y10-13a-q5c with arcs');
