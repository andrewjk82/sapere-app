...
const geo = {
  ...
  // α is in Sector 1 of I1 (Bottom-Left, interior)
  // 130° needs to be in Sector 2 of I2 (Top-Left, interior) to be co-interior!
  angles: [
    { at:'I1', label:'α' },
    { at:'I2' }, // Sector 0 (empty)
    { at:'I2' }, // Sector 1 (empty)
    { at:'I2', label:'130°' } // Sector 2 (Top-Left, interior)
  ]
};

async function run() {
  const docRef = db.collection('questions').doc('y9-7a-q3a');
  ...
  console.log('Successfully updated geometry for y9-7a-q3a to make angles co-interior!');
}
