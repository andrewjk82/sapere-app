...
// 15 new unique questions (y11a-5-newq154 to newq168) under topic 5A
const newQuestions = [
  {
    "id": "y11a-5-newq154",
    "chapterId": "y11a-5",
    ...
    "question": "A subsea pipeline depth model follows the rational curve \\(y = \\frac{15}{x}\\). If it is translated 4 units to the left and 2 units upward, find the new model equation.",
    "opts": [
      "\\(y = \\frac{15}{x + 4} + 2\\)",
      "\\(y = \\frac{15}{x - 4} + 2\\)",
      "\\(y = \\frac{15}{x + 4} - 2\\)",
    ...
    "solutionSteps": [
      {
        ...
        "workingOut": "Given: \\(y = \\frac{15}{x}\\), Horizontal: 4 units left, Vertical: 2 units up"
      },
      {
        ...
        "workingOut": "\\(x \\;\u2192\\; x + 4 \\;\\Rightarrow\\; y = \\frac{15}{x + 4}\\)"
      },
      {
  ...
  },
  {
    ...
    "difficulty": "medium",
    "type": "multiple_choice",
    "question": "A high-precision optical laser path is modeled by \\(y = (x - 4)^2 + 5\\). If the path is translated 3 units to the right and 1 unit downward, find the new path equation.",
    "opts": [
      "\\(y = (x - 7)^2 + 4\\)",
      "\\(y = (x - 1)^2 + 4\\)",
      "\\(y = (x - 7)^2 + 6\\)",
    ...
    "solutionSteps": [
      {
        ...
        "workingOut": "Given: \\(y = (x - 4)^2 + 5\\), Horizontal: 3 units right, Vertical: 1 unit down"
      },
      {
        ...
        "workingOut": "\\(x \\;\u2192\\; (x - 3) \\;\\Rightarrow\\; y = ((x - 3) - 4)^2 + 5\\)"
      },
      {
        ...
        "workingOut": "\\(y = (x - 7)^2 + 5 - 1 \\;\\Rightarrow\\; y = (x - 7)^2 + 4\\)"
      }
    ],
    "isNew": true,
    "graphData": null
  },
  {
    ...
    "difficulty": "medium",
    "type": "multiple_choice",
    "question": "A cylindrical sensor boundary is represented by \\((x - 1)^2 + (y + 5)^2 = 49\\). If the machine is calibrated to translate the scan 4 units to the right and 1 unit upward, find the new boundary equation.",
    "opts": [
      "\\((x - 5)^2 + (y + 4)^2 = 49\\)",
      "\\((x + 3)^2 + (y + 4)^2 = 49\\)",
      "\\((x - 5)^2 + (y + 6)^2 = 49\\)",
    ...
    "solutionSteps": [
      {
        ...
        "workingOut": "Given: \\((x - 1)^2 + (y + 5)^2 = 49\\)"
      },
      {
      ...
      },
      {
        ...
        "workingOut": "\\(((x - 4) - 1)^2 + ((y - 1) + 5)^2 = 49 \\;\\Rightarrow\\; (x - 5)^2 + (y + 4)^2 = 49\\)"
      }
    ],
    "isNew": true,
    "graphData": null
  },
  {
    ...
    "difficulty": "medium",
    "type": "multiple_choice",
    "question": "A logistics vehicle's route line is defined by \\(y = -3x + 1\\). Write the equation of the route after it is translated 5 units to the left.",
    "opts": [
      "\\(y = -3(x + 5) + 1\\)",
      "\\(y = -3(x - 5) + 1\\)",
      "\\(y = -3x - 14\\)",
    ...
    "solutionSteps": [
      {
        ...
        "workingOut": "Given: \\(y = -3x + 1\\) and translation of 5 units left"
      },
      {
        ...
        "workingOut": "\\(x \\;\u2192\\; (x + 5) \\;\\Rightarrow\\; y = -3(x + 5) + 1\\)"
      },
      {
  ...
  },
  {
    ...
    "difficulty": "medium",
    "type": "multiple_choice",
    "question": "A satellite trajectory profile is defined by \\(y = 2x^3 - 6\\). If the tracking model translates the curve 2 units to the right, write the new equation.",
    "opts": [
      "\\(y = 2(x - 2)^3 - 6\\)",
      "\\(y = 2(x + 2)^3 - 6\\)",
      "\\(y = 2x^3 - 8\\)",
    ...
    "solutionSteps": [
      {
        ...
        "workingOut": "Given: \\(y = 2x^3 - 6\\) and translation: 2 units right"
      },
      {
  ...
  },
  {
    ...
    "difficulty": "medium",
    "type": "multiple_choice",
    "question": "A thermal fluid channel boundary follows the curve \\(y = \\frac{20}{x}\\). If the channel is translated 3 units to the right and 1 unit downward, find the new boundary equation.",
    "opts": [
      "\\(y = \\frac{20}{x - 3} - 1\\)",
      "\\(y = \\frac{20}{x + 3} - 1\\)",
      "\\(y = \\frac{20}{x - 3} + 1\\)",
    ...
    "solutionSteps": [
      {
        ...
        "workingOut": "Given: \\(y = \\frac{20}{x}\\), Horizontal: 3 units right, Vertical: 1 unit down"
      },
      {
        ...
        "workingOut": "\\(x \\;\u2192\\; x - 3 \\;\\Rightarrow\\; y = \\frac{20}{x - 3}\\)"
      },
      {
  ...
  },
  {
    ...
    "difficulty": "medium",
    "type": "multiple_choice",
    "question": "A robotics arm path is defined by \\(y = (x + 3)^2 - 4\\). Describe the translation required to map this path onto the new trajectory \\(y = (x - 2)^2 - 4\\).",
    "opts": [
    ...
    "solutionSteps": [
      {
        ...
        "workingOut": "Initial: \\(y_1 = (x + 3)^2 - 4\\), Target: \\(y_2 = (x - 2)^2 - 4\\)"
      },
      {
  ...
  },
  {
    ...
    "difficulty": "medium",
    "type": "multiple_choice",
    "question": "A suspension cable contour follows the curve \\(y = x^2 - 6x + 6\\). If the engineering model is translated 2 units vertically upward, find the new equation of the cable.",
    "opts": [
      "\\(y = x^2 - 6x + 8\\)",
      "\\(y = x^2 - 6x + 4\\)",
      "\\(y = (x - 2)^2 - 6x + 6\\)",
    ...
    "solutionSteps": [
      {
        ...
        "workingOut": "Given: \\(y = x^2 - 6x + 6\\) and shift: +2 units vertically"
      },
      {
        ...
        "workingOut": "\\(y_{\\text{new}} = (x^2 - 6x + 6) + 2\\)"
      },
      {
  ...
  },
  {
    ...
    "difficulty": "medium",
    "type": "multiple_choice",
    "question": "A conveyor track's trajectory is modeled by the cubic function \\(y = (x - 2)^3 + 5\\). If the track is translated 2 units to the right, find the new path equation.",
    "opts": [
      "\\(y = (x - 4)^3 + 5\\)",
      "\\(y = x^3 + 5\\)",
      "\\(y = (x - 4)^3 + 7\\)",
    ...
    "solutionSteps": [
      {
        ...
        "workingOut": "Given: \\(y = (x - 2)^3 + 5\\) and shift of 2 units right"
      },
      {
  ...
  },
  {
    ...
    "difficulty": "medium",
    "type": "multiple_choice",
    "question": "A high-precision laser alignment line follows the model \\(y = 3x - 4\\). If the alignment is translated 2 units to the right and 3 units downward, find the new linear equation.",
    "opts": [
      "\\(y = 3x - 13\\)",
      "\\(y = 3x - 5\\)",
      "\\(y = 3(x - 2) - 4\\)",
    ...
    "solutionSteps": [
      ...
      },
      {
        ...
        "workingOut": "\\(x \\;\u2192\\; (x - 2)\\) and \\(y \\;\u2192\\; y - 3 \\;\\Rightarrow\\; y = 3(x - 2) - 4 - 3\\)"
      },
      {
        ...
        "workingOut": "\\(y = 3x - 6 - 7 \\;\\Rightarrow\\; y = 3x - 13\\)"
      }
    ],
    "isNew": true,
    "graphData": null
  },
  {
    ...
    "difficulty": "medium",
    "type": "multiple_choice",
    "question": "A digital imaging sensor maps pixel intensity along the curve \\(y = x^2 - 8x + 19\\). Find the vertex of this intensity model by completing the square.",
    "opts": [
      "\\((4, 3)\\)",
      "\\((-4, 3)\\)",
      "\\((4, -3)\\)",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "type": "multiple_choice",
    "question": "A mechanical link deflection is modeled by \\(y = x^2 + 6x + 10\\). Complete the square to determine the coordinate pair of its minimum point.",
    "opts": [
      "\\((-3, 1)\\)",
      "\\((3, 1)\\)",
      "\\((-3, -1)\\)",
    ...
    "solutionSteps": [
      ...
      },
      {
        ...
        "workingOut": "\\(y = (x^2 + 6x + 9) - 9 + 10 \\;\\Rightarrow\\; y = (x + 3)^2 + 1\\)"
      },
      {
  ...
  },
  {
    ...
    "difficulty": "medium",
    "type": "multiple_choice",
    "question": "A thermal expansion profile follows the parabola \\(y = x^2 - 10x + 27\\). Express the equation in vertex form to find the coordinates of the turning point.",
    "opts": [
      "\\((5, 2)\\)",
      "\\((-5, 2)\\)",
      "\\((5, -2)\\)",
    ...
    "solutionSteps": [
      ...
      },
      {
        ...
        "workingOut": "\\(y = (x^2 - 10x + 25) - 25 + 27 \\;\\Rightarrow\\; y = (x - 5)^2 + 2\\)"
      },
      {
  ...
  },
  {
    ...
    "difficulty": "medium",
    "type": "multiple_choice",
    "question": "A structural brace deflection profile is modeled by \\(y = x^2 + 8x + 13\\). Complete the square to determine the coordinate pair of its minimum point.",
    "opts": [
      "\\((-4, -3)\\)",
      "\\((4, -3)\\)",
      "\\((-4, 3)\\)",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "type": "multiple_choice",
    "question": "An agricultural terrain gradient is modeled by the function \\(y = x^2 - 12x + 38\\). Complete the square to determine the coordinate pair of its minimum point.",
    "opts": [
      "\\((6, 2)\\)",
      "\\((-6, 2)\\)",
      "\\((6, -2)\\)",
    ...
    "solutionSteps": [
      {
        ...
        "workingOut": "Given: \\(y = x^2 - 12x + 38\\)"
      },
      {
        "explanation": "Next, we take the coefficient of the linear term, divide it by two, square it, and add and subtract this value to complete the square. A common mistake is failing to apply the correct sign inside the binomial squared expression.",
        "workingOut": "\\(y = (x^2 - 12x + 36) - 36 + 38 \\;\\Rightarrow\\; y = (x - 6)^2 + 2\\)"
      },
      {
        "explanation": "Finally, we extract the coordinates of the minimum turning point by comparing the equation with the standard vertex form.",
        "workingOut": "Standard form: \\(y = (x - h)^2 + k \\;\\Rightarrow\\; \\text{Turning Point: } (6, 2)\\)"
      }
    ],
    "isNew": true,
    "graphData": null
...
async function run() {
  console.log(`Adding 15 new questions (154 to 168)...`);
