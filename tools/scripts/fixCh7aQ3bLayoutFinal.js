...
const correctedGeo = {
  ...
  angles: [
    { at:'I1_L', label:'75°' }, // Sector 0 (Bottom-Left, acute) - 75 degrees belongs here!
    { at:'I2_L' }, // Sector 0 (Bottom-Left, acute)
    { at:'I2_L', label:'β' }, // Sector 1 (Top-Left, obtuse) - beta belongs here (obtuse co-interior, 105 degrees)!
    { at:'I1_R' }, // Sector 0 (Bottom-Left, acute)
    { at:'I1_R', label:'γ' } // Sector 1 (Top-Left, obtuse) - gamma belongs here (obtuse corresponding, 105 degrees)!
  ]
};
...
async function run() {
  ...
  for (const id of ids) {
    ...
    console.log(`Successfully fixed layout and sector labels for ${id}!`);
  }
}
