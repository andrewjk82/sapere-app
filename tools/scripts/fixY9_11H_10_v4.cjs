...
async function run() {
  ...
  // Draw BOTH the circle and the square.
  // Use point objects for circle to guarantee rendering.
  // Use raw coordinates for square lines to guarantee rendering.
...
board.unsuspendUpdate();`;
  ...
  console.log("Restored BOTH circle and square to the graph.");
  process.exit(0);
}
