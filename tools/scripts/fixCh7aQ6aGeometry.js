...
const geo = {
  ...
  angles: [
    { at:'A', label:'β' },
    { at:'B' }, // Sector 0 (exterior bottom)
    { at:'B', label:'70°' }, // Sector 1 (interior)
    { at:'C', label:'α' } // Sector 0 (interior)
  ]
};
...
async function run() {
  ...
  for (const id of ids) {
    ...
    console.log(`Successfully widened base and fixed overlap for ${id}!`);
  }
}
