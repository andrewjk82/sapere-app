...
const match = content.match(/export const Y11_CH5_QUESTIONS = (\[[\s\S]*\]);$/m);
...
const targetIds = [
  'y11a-5i-q12b', 'y11a-5i-q12b-sketch',
...
fs.writeFileSync(filePath, content.substring(0, match.index) + 'export const Y11_CH5_QUESTIONS = ' + newArrayStr + ';\n', 'utf8');
...
async function updateDb() {
  ...
  console.log('Successfully updated sketch questions in seedYear11Ch5Questions.js and Firestore.');
  process.exit(0);
}
updateDb();
