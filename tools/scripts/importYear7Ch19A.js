...
export const allQuestions = [
  {
    ...
    "options": [
      {
        "text": "\\(32 kg, with 10 dots\\)",
        "imageUrl": ""
      },
      {
        "text": "\\(31 kg, with 4 dots\\)",
        "imageUrl": ""
      },
      {
        "text": "\\(35 kg, with 5 dots\\)",
        "imageUrl": ""
      },
      {
        "text": "\\(36 kg, with 5 dots\\)",
        "imageUrl": ""
      }
    ],
    ...
    "solutionSteps": [
      ...
      },
      {
        ...
        "workingOut": "<div style=\"text-align: left;\"><p>In a dot plot, the height of each column represents the frequency of that category:</p><ul><li>The category with the highest frequency will have the tallest column of dots.</li><li>Looking at our table, the highest frequency is <strong>10</strong>, which corresponds to the weight <strong>32 kg</strong>.</li><li>Therefore, the column for <strong>32 kg</strong> will have the tallest column consisting of exactly <strong>10 dots</strong>.</li></ul></div>",
        "graphData": null
      },
      {
        "explanation": "State the final simplified answer and match it to the correct option.",
        "workingOut": "32 kg, with 10 dots",
        "graphData": null
      }
    ],
    ...
    "subQuestions": [
      {
        ...
        "solutionSteps": [
          {
            "explanation": "Tally each value in the dataset.",
            "workingOut": "17 cm appears 3 times, 18 cm appears 6 times, 19 cm appears 7 times, 20 cm appears 5 times, 21 cm appears 2 times, and 22 cm appears 1 time."
          }
        ]
      },
      {
        "id": "IRa64bCMUhlWorCP8T6S_b",
        "type": "multiple_choice",
        "question": "b) What is the shortest length?",
        "options": [
          {
            "text": "16 cm",
            "imageUrl": ""
        ...
        "solutionSteps": [
          {
            "explanation": "Find the minimum value in the dataset.",
            "workingOut": "The lowest value is 17 cm."
          }
        ]
      },
      {
        "id": "IRa64bCMUhlWorCP8T6S_c",
        "type": "multiple_choice",
        "question": "c) What is the longest length?",
        "options": [
          {
            "text": "21 cm",
            "imageUrl": ""
        ...
        "solutionSteps": [
          {
            "explanation": "Find the maximum value in the dataset.",
            "workingOut": "The highest value is 22 cm."
          }
        ]
      },
      {
        "id": "IRa64bCMUhlWorCP8T6S_d",
        "type": "multiple_choice",
        "question": "d) What is the most commonly occurring length?",
        "options": [
          {
            "text": "18 cm",
            "imageUrl": ""
        ...
        "solutionSteps": [
          {
            "explanation": "Find the value with the highest frequency.",
            "workingOut": "19 cm has the highest frequency (7 occurrences)."
          }
        ]
      },
      {
        "id": "IRa64bCMUhlWorCP8T6S_e",
        "type": "multiple_choice",
        "question": "e) Determine the highest stack on a dot plot for this data.",
        "options": [
          {
            "text": "6 dots",
            "imageUrl": ""
        ...
        "solutionSteps": [
          {
            "explanation": "Determine the number of dots for the most common value (19 cm).",
            "workingOut": "The tallest stack belongs to the mode (19 cm) which has a frequency of 7, so it will have 7 dots."
          }
        ]
      }
    ],
  ...
  },
  {
    ...
    "solutionSteps": [],
    "answer": "",
    "question": "A zoologist counted organisms living in droplets of water. The data are as follows:\n\n<div style=\"background: #f8fafc; padding: 12px; border: 1px solid #e2e8f0; border-radius: 8px; font-weight: bold; text-align: center; margin: 16px 0; font-family: monospace; letter-spacing: 1px;\">\n  21, 23, 24, 23, 21, 25, 34, 32, 21, 23, 34, 23, 22, 24, 25, 25, 26, 21, 24, 21, 20, 23, 27\n</div>\n\nAnalyze the data to answer parts (a) and (b):",
    "solution": "",
    "hint": "Complete a tally table first to find the frequencies, then look for gaps and peaks.",
    "options": [],
    "subQuestions": [
      {
        "id": "Ry7D47hTtZUoIBOm2JFH_a",
        "type": "multiple_choice",
        "question": "a) Complete a frequency table for the data. Which of the following lists the correct frequencies?",
        "options": [
          {
            "text": "20:1, 21:5, 22:1, 23:5, 24:2, 25:4, 26:1, 27:1, 32:2, 34:1",
            "imageUrl": ""
          },
          {
            "text": "20:2, 21:4, 22:1, 23:5, 24:3, 25:3, 26:1, 27:1, 32:1, 34:2",
            "imageUrl": ""
          },
          {
            "text": "20:1, 21:5, 22:1, 23:5, 24:3, 25:3, 26:1, 27:1, 32:1, 34:2",
            "imageUrl": ""
          },
          {
            "text": "20:1, 21:5, 22:2, 23:4, 24:3, 25:3, 26:1, 27:1, 32:1, 34:2",
            "imageUrl": ""
          }
        ],
        "answer": "2",
        "solutionSteps": [
          {
            "explanation": "Tally all the scores in the list.",
            "workingOut": "The frequencies are: 20: 1, 21: 5, 22: 1, 23: 5, 24: 3, 25: 3, 26: 1, 27: 1, 32: 1, 34: 2."
          }
        ]
      },
      {
        "id": "Ry7D47hTtZUoIBOm2JFH_b",
        "type": "multiple_choice",
        "question": "b) Determine the key features if you were to draw a dot plot.",
        "options": [
          {
            "text": "The tallest column is 23 with 5 dots; there are no gaps.",
            "imageUrl": ""
          },
          {
            "text": "The tallest column is 21 with 5 dots; there is a gap at 28–31 only.",
            "imageUrl": ""
          },
          {
            "text": "The tallest columns are 21 and 23 with 5 dots each; there are gaps at 28–31 and 33.",
            "imageUrl": ""
          },
          {
            "text": "The tallest columns are 21 and 25 with 5 dots each; there is a gap at 28–31.",
            "imageUrl": ""
          }
        ],
        "answer": "2",
        "solutionSteps": [
          {
            "explanation": "Analyze the frequencies and identify gaps (missing values between data points) and peaks (highest frequencies).",
            "workingOut": "The highest frequencies are 5 (at 21 and 23). Gaps occur where frequency is 0: at 28, 29, 30, 31 (gap of size 4) and at 33 (gap of size 1)."
          }
        ]
      }
    ],
  ...
  },
  {
    ...
    "options": [
      {
        "text": "Score 79: frequency of 7; Score 72: frequency of 3",
        "imageUrl": ""
      },
      {
        "text": "Score 79: frequency of 6; Score 72: frequency of 3",
        "imageUrl": ""
      },
      {
        "text": "Score 79: frequency of 7; Score 72: frequency of 2",
        "imageUrl": ""
      },
      {
        "text": "Score 79: frequency of 8; Score 72: frequency of 4",
        "imageUrl": ""
      }
    ],
    "requiresManualGrading": false,
    ...
    "solutionSteps": [
      ...
      {
        "explanation": "Carry out the calculation or algebraic rearrangement step by step. Watch signs, place value, and order of operations.",
        "workingOut": "<div style=\"text-align: left;\"><p>Let's count how many times each golf score appears in the dataset:</p><ul><li><strong>For score 72:</strong> It appears at positions 8, 19, and 20. Count = <strong>3</strong>.</li><li><strong>For score 79:</strong> It appears at positions 2, 6, 9, 10, 13, 15, and 16. Count = <strong>7</strong>.</li></ul><p>Therefore, the frequency of score 79 is 7, and the frequency of score 72 is 3.</p></div>",
        "graphData": null
      },
      {
        "explanation": "State the final simplified answer and match it to the correct option.",
        "workingOut": "Score 79: frequency of 7; Score 72: frequency of 3",
        "graphData": null
      }
    ],
    "question": "Brad's golf scores over the past 20 weeks are recorded as follows:\n\n<div style=\"background: #f1f5f9; padding: 12px; border-radius: 8px; font-weight: bold; text-align: center; margin: 16px 0; font-family: monospace; letter-spacing: 1px;\">\n  82, 79, 84, 82, 81, 79, 78, 72, 79, 79, 77, 88, 79, 81, 79, 79, 84, 78, 72, 72\n</div>\n\nFind the frequency of the scores <strong>79</strong> and <strong>72</strong> in this dataset."
  },
  {
    "id": "cKa1gVkKHiSZKCLa43Yi",
    "chapterId": "y7-19",
    "chapterTitle": "Chapter 19: Numerical Data",
    "topicId": "y7-19a",
    "topicCode": "19A",
    ...
    "solutionSteps": [
      ...
      {
        "explanation": "Carry out the calculation or algebraic rearrangement step by step. Watch signs, place value, and order of operations.",
        "workingOut": "<div style=\"text-align: left;\"><p>To find the total number of dogs, we sum up all frequencies obtained from the tally table:</p><ul><li>\\(\\text{Total} = 1 + 0 + 3 + 1 + 4 + 10 + 3 + 3 + 5 + 5 + 0 + 3\\)</li><li>\\(\\text{Total} = 38\\text{ dogs}\\)</li></ul><p>Therefore, a total of <strong>38 dogs</strong> were brought into the vet practice during the week.</p></div>",
        "graphData": null
      },
      {
        "explanation": "State the final simplified answer and match it to the correct option.",
  ...
  },
  {
    ...
    "solutionSteps": [
      ...
      {
        "explanation": "Carry out the calculation or algebraic rearrangement step by step. Watch signs, place value, and order of operations.",
        "workingOut": "<div style=\"text-align: left;\"><p>The most frequent score is the value that appears most often (highest frequency):</p><ul><li>72 appears 3 times.</li><li>77 appears 1 time.</li><li>78 appears 2 times.</li><li><strong>79 appears 7 times.</strong></li><li>81 appears 2 times.</li><li>82 appears 2 times.</li><li>84 appears 2 times.</li><li>88 appears 1 time.</li></ul><p>Since <strong>79</strong> has the highest frequency (7 occurrences), it is the most frequent golf score.</p></div>",
        "graphData": null
      },
      {
        "explanation": "State the final simplified answer and match it to the correct option.",
  ...
  },
  {
    ...
    "solutionSteps": [
      ...
      {
        "explanation": "Carry out the calculation or algebraic rearrangement step by step. Watch signs, place value, and order of operations.",
        "workingOut": "<div style=\"text-align: left;\"><p>To find the number of dots placed on <strong>78 or lower</strong>, we find all scores that are less than or equal to 78 and sum their frequencies:</p><ul><li>Scores \\(\\le 78\\) are <strong>72</strong>, <strong>77</strong>, and <strong>78</strong>.</li><li>Frequency of 72 = 3 dots.</li><li>Frequency of 77 = 1 dot.</li><li>Frequency of 78 = 2 dots.</li><li>\\(\\text{Total} = 3 + 1 + 2 = 6\\text{ dots}\\).</li></ul></div>",
        "graphData": null
      },
      {
        "explanation": "State the final simplified answer and match it to the correct option.",
    ...
    "question": "Brad's golf scores over the past 20 weeks are recorded as follows:\n\n<div style=\"background: #f1f5f9; padding: 12px; border-radius: 8px; font-weight: bold; text-align: center; margin: 16px 0; font-family: monospace; letter-spacing: 1px;\">\n  82, 79, 84, 82, 81, 79, 78, 72, 79, 79, 77, 88, 79, 81, 79, 79, 84, 78, 72, 72\n</div>\n\nIf you were to draw a dot plot for Brad's golf scores, how many dots in total would be placed on scores <strong>78 or lower</strong>?",
    "solution": "<div style=\"text-align: left;\"><p>To find the number of dots placed on <strong>78 or lower</strong>, we find all scores that are less than or equal to 78 and sum their frequencies:</p><ul><li>Scores \\(\\le 78\\) are <strong>72</strong>, <strong>77</strong>, and <strong>78</strong>.</li><li>Frequency of 72 = 3 dots.</li><li>Frequency of 77 = 1 dot.</li><li>Frequency of 78 = 2 dots.</li><li>\\(\\text{Total} = 3 + 1 + 2 = 6\\text{ dots}\\).</li></ul></div>"
  },
  {
    "id": "kNCQNIbnMJOBkKToJw0i",
    "chapterId": "y7-19",
    "chapterTitle": "Chapter 19: Numerical Data",
    "topicId": "y7-19a",
    "topicCode": "19A",
    ...
    "options": [
      {
        "text": "\\(31 kg: 4; 32 kg: 10; 35 kg: 5\\)",
        "imageUrl": ""
      },
      {
        "text": "\\(31 kg: 4; 32 kg: 9; 35 kg: 4\\)",
        "imageUrl": ""
      },
      {
        "text": "\\(31 kg: 3; 32 kg: 10; 35 kg: 5\\)",
        "imageUrl": ""
      },
      {
        "text": "\\(31 kg: 5; 32 kg: 10; 35 kg: 6\\)",
        "imageUrl": ""
      }
    ],
    "requiresManualGrading": false,
    ...
    "solutionSteps": [
      ...
      {
        "explanation": "Carry out the calculation or algebraic rearrangement step by step. Watch signs, place value, and order of operations.",
        "workingOut": "<div style=\"text-align: left;\"><p>Let's convert each tally into numerical frequencies step-by-step:</p><ul><li><strong>Weight 31 kg:</strong> The tally is four vertical strokes: <code>||||</code>, which represents a frequency of <strong>4</strong>.</li><li><strong>Weight 32 kg:</strong> The tally consists of two groups of five strokes: <code><s>||||</s> <s>||||</s></code>, which represents a frequency of \\(5 + 5 = <strong>10</strong>\\).</li><li><strong>Weight 35 kg:</strong> The tally is one group of five strokes: <code><s>||||</s></code>, which represents a frequency of <strong>5</strong>.</li></ul></div>",
        "graphData": null
      },
      {
        "explanation": "State the final simplified answer and match it to the correct option.",
        "workingOut": "31 kg: 4; 32 kg: 10; 35 kg: 5",
        "graphData": null
      }
    ],
    "question": "The local vet weighed each dog brought into the practice for one week. The tallies of the dogs with each of the different weights are shown in the table below:\n\n<div style=\"display: flex; justify-content: center; margin: 16px 0;\">\n  <table style=\"width: 100%; max-width: 600px; border-collapse: collapse; font-family: inherit; font-size: 13px; text-align: center; border: 1px solid #cbd5e1; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.05);\">\n    <thead>\n      <tr style=\"background: #4f46e5; color: white;\">\n        <th style=\"padding: 10px 8px; font-weight: 600; border: 1px solid #cbd5e1; width: 22%;\">Weight (correct to nearest kg)</th>\n        <th style=\"padding: 6px; font-weight: 600; border: 1px solid #cbd5e1; width: 6.5%;\">27</th>\n        <th style=\"padding: 6px; font-weight: 600; border: 1px solid #cbd5e1; width: 6.5%;\">28</th>\n        <th style=\"padding: 6px; font-weight: 600; border: 1px solid #cbd5e1; width: 6.5%;\">29</th>\n        <th style=\"padding: 6px; font-weight: 600; border: 1px solid #cbd5e1; width: 6.5%;\">30</th>\n        <th style=\"padding: 6px; font-weight: 600; border: 1px solid #cbd5e1; width: 6.5%;\">31</th>\n        <th style=\"padding: 6px; font-weight: 600; border: 1px solid #cbd5e1; width: 6.5%;\">32</th>\n        <th style=\"padding: 6px; font-weight: 600; border: 1px solid #cbd5e1; width: 6.5%;\">33</th>\n        <th style=\"padding: 6px; font-weight: 600; border: 1px solid #cbd5e1; width: 6.5%;\">34</th>\n        <th style=\"padding: 6px; font-weight: 600; border: 1px solid #cbd5e1; width: 6.5%;\">35</th>\n        <th style=\"padding: 6px; font-weight: 600; border: 1px solid #cbd5e1; width: 6.5%;\">36</th>\n        <th style=\"padding: 6px; font-weight: 600; border: 1px solid #cbd5e1; width: 6.5%;\">37</th>\n        <th style=\"padding: 6px; font-weight: 600; border: 1px solid #cbd5e1; width: 6.5%;\">38</th>\n      </tr>\n    </thead>\n    <tbody>\n      <tr style=\"background: #f8fafc;\">\n        <td style=\"padding: 8px; border: 1px solid #cbd5e1; font-weight: 600; text-align: left; color: #4f46e5;\">Tally</td>\n        <td style=\"padding: 8px; border: 1px solid #cbd5e1; color: #e11d48; font-weight: bold;\">|</td>\n        <td style=\"padding: 8px; border: 1px solid #cbd5e1; color: #94a3b8; font-style: italic;\"></td>\n        <td style=\"padding: 8px; border: 1px solid #cbd5e1; color: #e11d48; font-weight: bold;\">|||</td>\n        <td style=\"padding: 8px; border: 1px solid #cbd5e1; color: #e11d48; font-weight: bold;\">|</td>\n        <td style=\"padding: 8px; border: 1px solid #cbd5e1; color: #e11d48; font-weight: bold;\">||||</td>\n        <td style=\"padding: 8px; border: 1px solid #cbd5e1; color: #e11d48; font-weight: bold;\"><s>||||</s> <s>||||</s></td>\n        <td style=\"padding: 8px; border: 1px solid #cbd5e1; color: #e11d48; font-weight: bold;\">|||</td>\n        <td style=\"padding: 8px; border: 1px solid #cbd5e1; color: #e11d48; font-weight: bold;\">|||</td>\n        <td style=\"padding: 8px; border: 1px solid #cbd5e1; color: #e11d48; font-weight: bold;\"><s>||||</s></td>\n        <td style=\"padding: 8px; border: 1px solid #cbd5e1; color: #e11d48; font-weight: bold;\"><s>||||</s></td>\n        <td style=\"padding: 8px; border: 1px solid #cbd5e1; color: #94a3b8; font-style: italic;\"></td>\n        <td style=\"padding: 8px; border: 1px solid #cbd5e1; color: #e11d48; font-weight: bold;\">|||</td>\n      </tr>\n      <tr>\n        <td style=\"padding: 8px; border: 1px solid #cbd5e1; font-weight: 600; text-align: left; color: #475569;\">Frequency</td>\n        <td style=\"padding: 8px; border: 1px solid #cbd5e1; color: #94a3b8; font-style: italic;\">?</td>\n        <td style=\"padding: 8px; border: 1px solid #cbd5e1; color: #94a3b8; font-style: italic;\">?</td>\n        <td style=\"padding: 8px; border: 1px solid #cbd5e1; color: #94a3b8; font-style: italic;\">?</td>\n        <td style=\"padding: 8px; border: 1px solid #cbd5e1; color: #94a3b8; font-style: italic;\">?</td>\n        <td style=\"padding: 8px; border: 1px solid #cbd5e1; color: #94a3b8; font-style: italic;\">?</td>\n        <td style=\"padding: 8px; border: 1px solid #cbd5e1; color: #94a3b8; font-style: italic;\">?</td>\n        <td style=\"padding: 8px; border: 1px solid #cbd5e1; color: #94a3b8; font-style: italic;\">?</td>\n        <td style=\"padding: 8px; border: 1px solid #cbd5e1; color: #94a3b8; font-style: italic;\">?</td>\n        <td style=\"padding: 8px; border: 1px solid #cbd5e1; color: #94a3b8; font-style: italic;\">?</td>\n        <td style=\"padding: 8px; border: 1px solid #cbd5e1; color: #94a3b8; font-style: italic;\">?</td>\n        <td style=\"padding: 8px; border: 1px solid #cbd5e1; color: #94a3b8; font-style: italic;\">?</td>\n        <td style=\"padding: 8px; border: 1px solid #cbd5e1; color: #94a3b8; font-style: italic;\">?</td>\n      </tr>\n    </tbody>\n  </table>\n</div>\n\nComplete the frequency row of the table. What are the correct frequencies for the dog weights <strong>31 kg, 32 kg, and 35 kg</strong>?"
  }
];
...
export const importYear7Ch19A = async (forceReset = false) => {
  ...
  try {
    ...
    if (forceReset) {
      console.log('Force reset enabled. Deleting existing Y7 Ch19 (19a) questions...');
      const topicsToDelete = ['y7-19a'];
