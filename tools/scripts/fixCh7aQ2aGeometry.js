...
const geo = {
  points: { A:[0,0], B:[0,2], C:[-1.5,-1.8], D:[2,0] }, // D is [2, 0] (horizontal) to make BAC 90 degrees with B [0, 2]
  segments: [
...
async function run() {
  const docRef = db.collection('questions').doc('y9-7a-q2a');
  ...
  console.log('Successfully corrected right angle geometry for y9-7a-q2a!');
}
