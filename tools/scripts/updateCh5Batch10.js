...
// 15 new unique questions (y11a-5-newq116 to newq130) under topic 5A
const newQuestions = [
  {
    "id": "y11a-5-newq116",
    "chapterId": "y11a-5",
    ...
    "question": "A subsea pipeline depth model follows the rational curve \\(y = \\frac{10}{x}\\). If it is translated 4 units to the left and 3 units upward, find the new model equation.",
    "opts": [
      "\\(y = \\frac{10}{x + 4} + 3\\)",
      "\\(y = \\frac{10}{x - 4} + 3\\)",
      "\\(y = \\frac{10}{x + 4} - 3\\)",
    ...
    "solutionSteps": [
      {
        ...
        "workingOut": "Given: \\(y = \\frac{10}{x}\\), Horizontal: 4 units left, Vertical: 3 units up"
      },
      {
        ...
        "workingOut": "\\(x \\;\u2192\\; x + 4 \\;\\Rightarrow\\; y = \\frac{10}{x + 4}\\)"
      },
      {
  ...
  },
  {
    ...
    "difficulty": "medium",
    "type": "multiple_choice",
    "question": "A high-precision optical laser path is modeled by \\(y = (x - 5)^2 + 3\\). If the path is translated 3 units to the right and 2 units downward, find the new path equation.",
    "opts": [
      "\\(y = (x - 8)^2 + 1\\)",
      "\\(y = (x - 2)^2 + 1\\)",
      "\\(y = (x - 8)^2 + 5\\)",
    ...
    "solutionSteps": [
      {
        ...
        "workingOut": "Given: \\(y = (x - 5)^2 + 3\\), Horizontal: 3 units right, Vertical: 2 units down"
      },
      {
        ...
        "workingOut": "\\(x \\;\u2192\\; (x - 3) \\;\\Rightarrow\\; y = ((x - 3) - 5)^2 + 3\\)"
      },
      {
        "explanation": "Finally, we apply the vertical shift by subtracting two, then we simplify the constants inside the parentheses and combine the numbers outside to find the new quadratic equation.",
        "workingOut": "\\(y = (x - 8)^2 + 3 - 2 \\;\\Rightarrow\\; y = (x - 8)^2 + 1\\)"
      }
    ],
    "isNew": true,
    "graphData": null
  },
  {
    ...
    "difficulty": "medium",
    "type": "multiple_choice",
    "question": "A cylindrical sensor boundary is represented by \\((x - 4)^2 + (y + 3)^2 = 16\\). If the machine is calibrated to translate the scan 2 units to the right and 2 units upward, find the new boundary equation.",
    "opts": [
      "\\((x - 6)^2 + (y + 1)^2 = 16\\)",
      "\\((x - 2)^2 + (y + 1)^2 = 16\\)",
      "\\((x - 6)^2 + (y + 5)^2 = 16\\)",
    ...
    "solutionSteps": [
      {
        ...
        "workingOut": "Given: \\((x - 4)^2 + (y + 3)^2 = 16\\)"
      },
      {
      ...
      },
      {
        ...
        "workingOut": "\\(((x - 2) - 4)^2 + ((y - 2) + 3)^2 = 16 \\;\\Rightarrow\\; (x - 6)^2 + (y + 1)^2 = 16\\)"
      }
    ],
    "isNew": true,
    "graphData": null
  },
  {
    ...
    "difficulty": "medium",
    "type": "multiple_choice",
    "question": "A logistics vehicle's route line is defined by \\(y = -4x + 6\\). Write the equation of the route after it is translated 2 units to the left.",
    "opts": [
      "\\(y = -4(x + 2) + 6\\)",
      "\\(y = -4(x - 2) + 6\\)",
      "\\(y = -4x - 2\\)",
    ...
    "solutionSteps": [
      {
        "explanation": "We begin by writing down the initial line equation. The goal is to determine the equation after shifting the line horizontally left by two units. We identify the horizontal variable parameter.",
        "workingOut": "Given: \\(y = -4x + 6\\) and translation of 2 units left"
      },
      {
        ...
        "workingOut": "\\(x \\;\u2192\\; (x + 2) \\;\\Rightarrow\\; y = -4(x + 2) + 6\\)"
      },
      {
  ...
  },
  {
    ...
    "difficulty": "medium",
    "type": "multiple_choice",
    "question": "A satellite trajectory profile is defined by \\(y = 2x^3 - 3\\). If the tracking model translates the curve 4 units to the right, write the new equation.",
    "opts": [
      "\\(y = 2(x - 4)^3 - 3\\)",
      "\\(y = 2(x + 4)^3 - 3\\)",
      "\\(y = 2x^3 - 11\\)",
    ...
    "solutionSteps": [
      {
        ...
        "workingOut": "Given: \\(y = 2x^3 - 3\\) and translation: 4 units right"
      },
      {
  ...
  },
  {
    ...
    "difficulty": "medium",
    "type": "multiple_choice",
    "question": "A thermal fluid channel boundary follows the curve \\(y = \\frac{15}{x}\\). If the channel is translated 2 units to the right and 1 unit downward, find the new boundary equation.",
    "opts": [
      "\\(y = \\frac{15}{x - 2} - 1\\)",
      "\\(y = \\frac{15}{x + 2} - 1\\)",
      "\\(y = \\frac{15}{x - 2} + 1\\)",
    ...
    "solutionSteps": [
      {
        ...
        "workingOut": "Given: \\(y = \\frac{15}{x}\\), Horizontal: 2 units right, Vertical: 1 unit down"
      },
      {
        ...
        "workingOut": "\\(x \\;\u2192\\; x - 2 \\;\\Rightarrow\\; y = \\frac{15}{x - 2}\\)"
      },
      {
  ...
  },
  {
    ...
    "difficulty": "medium",
    "type": "multiple_choice",
    "question": "A robotics arm path is defined by \\(y = (x + 3)^2 - 5\\). Describe the translation required to map this path onto the new trajectory \\(y = (x - 2)^2 - 5\\).",
    "opts": [
    ...
    "solutionSteps": [
      {
        ...
        "workingOut": "Initial: \\(y_1 = (x + 3)^2 - 5\\), Target: \\(y_2 = (x - 2)^2 - 5\\)"
      },
      {
  ...
  },
  {
    ...
    "difficulty": "medium",
    "type": "multiple_choice",
    "question": "A suspension cable contour follows the curve \\(y = x^2 - 4x + 3\\). If the engineering model is translated 3 units vertically upward, find the new equation of the cable.",
    "opts": [
      "\\(y = x^2 - 4x + 6\\)",
      "\\(y = x^2 - 4x\\)",
      "\\(y = (x - 3)^2 - 4x + 3\\)",
    ...
    "solutionSteps": [
      {
        ...
        "workingOut": "Given: \\(y = x^2 - 4x + 3\\) and shift: +3 units vertically"
      },
      {
        ...
        "workingOut": "\\(y_{\\text{new}} = (x^2 - 4x + 3) + 3\\)"
      },
      {
  ...
  },
  {
    ...
    "difficulty": "medium",
    "type": "multiple_choice",
    "question": "A conveyor track's trajectory is modeled by the cubic function \\(y = (x - 2)^3 + 4\\). If the track is translated 3 units to the right, find the new path equation.",
    "opts": [
      "\\(y = (x - 5)^3 + 4\\)",
      "\\(y = (x + 1)^3 + 4\\)",
      "\\(y = (x - 5)^3 + 7\\)",
    ...
    "solutionSteps": [
      {
        ...
        "workingOut": "Given: \\(y = (x - 2)^3 + 4\\) and shift of 3 units right"
      },
      {
        ...
        "workingOut": "\\(x \\;\u2192\\; (x - 3) \\;\\Rightarrow\\; y = ((x - 3) - 2)^3 + 4\\)"
      },
      {
  ...
  },
  {
    ...
    "difficulty": "medium",
    "type": "multiple_choice",
    "question": "A high-precision laser alignment line follows the model \\(y = 2x - 5\\). If the alignment is translated 3 units to the right and 1 unit downward, find the new linear equation.",
    "opts": [
      "\\(y = 2x - 12\\)",
      "\\(y = 2x - 3\\)",
      "\\(y = 2(x - 3) - 5\\)",
    ...
    "solutionSteps": [
      {
        "explanation": "We begin by writing down the initial line equation. The goal is to determine the equation after shifting the line horizontally right by three units and vertically down by one unit.",
      ...
      },
      {
        ...
        "workingOut": "\\(x \\;\u2192\\; (x - 3)\\) and \\(y \\;\u2192\\; y - 1 \\;\\Rightarrow\\; y = 2(x - 3) - 5 - 1\\)"
      },
      {
        ...
        "workingOut": "\\(y = 2x - 6 - 6 \\;\\Rightarrow\\; y = 2x - 12\\)"
      }
    ],
    "isNew": true,
    "graphData": null
  },
  {
    ...
    "difficulty": "medium",
    "type": "multiple_choice",
    "question": "A digital imaging sensor maps pixel intensity along the curve \\(y = x^2 - 6x + 5\\). Find the vertex of this intensity model by completing the square.",
    "opts": [
      "\\((3, -4)\\)",
      "\\((-3, -4)\\)",
      "\\((3, 4)\\)",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "type": "multiple_choice",
    "question": "A mechanical link deflection is modeled by \\(y = x^2 + 6x + 5\\). Complete the square to determine the coordinate pair of its minimum point.",
    "opts": [
      "\\((-3, -4)\\)",
      "\\((3, -4)\\)",
      "\\((-3, 4)\\)",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "type": "multiple_choice",
    "question": "A thermal expansion profile follows the parabola \\(y = x^2 - 10x + 24\\). Express the equation in vertex form to find the coordinates of the turning point.",
    "opts": [
      "\\((5, -1)\\)",
      "\\((-5, -1)\\)",
      "\\((5, 1)\\)",
    ...
    "solutionSteps": [
      ...
      },
      {
        ...
        "workingOut": "\\(y = (x^2 - 10x + 25) - 25 + 24 \\;\\Rightarrow\\; y = (x - 5)^2 - 1\\)"
      },
      {
        ...
        "workingOut": "Standard form: \\(y = (x - h)^2 + k \\;\\Rightarrow\\; \\text{Turning Point: } (5, -1)\\)"
      }
    ],
    "isNew": true,
    "graphData": null
  },
  {
    ...
    "difficulty": "medium",
    "type": "multiple_choice",
    "question": "A structural brace deflection profile is modeled by \\(y = x^2 + 8x + 12\\). Complete the square to determine the coordinate pair of its minimum point.",
    "opts": [
      "\\((-4, -4)\\)",
      "\\((4, -4)\\)",
      "\\((-4, 4)\\)",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "type": "multiple_choice",
    "question": "An agricultural terrain gradient is modeled by the function \\(y = x^2 - 12x + 35\\). Complete the square to determine the coordinate pair of its minimum point.",
    "opts": [
      "\\((6, -1)\\)",
      "\\((-6, -1)\\)",
      "\\((6, 1)\\)",
    ...
    "solutionSteps": [
      {
        ...
        "workingOut": "Given: \\(y = x^2 - 12x + 35\\)"
      },
      {
        "explanation": "Next, we take the coefficient of the linear term, divide it by two, square it, and add and subtract this value to complete the square. A common mistake is failing to apply the correct sign inside the binomial squared expression.",
        "workingOut": "\\(y = (x^2 - 12x + 36) - 36 + 35 \\;\\Rightarrow\\; y = (x - 6)^2 - 1\\)"
      },
      {
        "explanation": "Finally, we extract the coordinates of the minimum turning point by comparing the equation with the standard vertex form.",
        "workingOut": "Standard form: \\(y = (x - h)^2 + k \\;\\Rightarrow\\; \\text{Turning Point: } (6, -1)\\)"
      }
    ],
    "isNew": true,
    "graphData": null
...
async function run() {
  console.log(`Adding 15 new questions (116 to 130)...`);
