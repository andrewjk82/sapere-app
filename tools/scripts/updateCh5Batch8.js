...
// 15 new unique questions (y11a-5-newq86 to newq100) under topic 5A
const newQuestions = [
  {
    "id": "y11a-5-newq86",
    "chapterId": "y11a-5",
    ...
    "question": "A subsea pipeline depth model follows the rational curve \\(y = \\frac{7}{x}\\). If it is translated 5 units to the left and 2 units upward, find the new model equation.",
    "opts": [
      "\\(y = \\frac{7}{x + 5} + 2\\)",
      "\\(y = \\frac{7}{x - 5} + 2\\)",
      "\\(y = \\frac{7}{x + 5} - 2\\)",
    ...
    "solutionSteps": [
      {
        ...
        "workingOut": "Given: \\(y = \\frac{7}{x}\\), Horizontal: 5 units left, Vertical: 2 units up"
      },
      {
        ...
        "workingOut": "\\(x \\;\u2192\\; x + 5 \\;\\Rightarrow\\; y = \\frac{7}{x + 5}\\)"
      },
      {
  ...
  },
  {
    ...
    "difficulty": "medium",
    "type": "multiple_choice",
    "question": "A high-precision optical laser path is modeled by \\(y = (x - 2)^2 + 3\\). If the path is translated 4 units to the right and 2 units downward, find the new path equation.",
    "opts": [
      "\\(y = (x - 6)^2 + 1\\)",
      "\\(y = (x + 2)^2 + 1\\)",
      "\\(y = (x - 6)^2 + 5\\)",
    ...
    "solutionSteps": [
      {
        ...
        "workingOut": "Given: \\(y = (x - 2)^2 + 3\\), Horizontal: 4 units right, Vertical: 2 units down"
      },
      {
        ...
        "workingOut": "\\(x \\;\u2192\\; (x - 4) \\;\\Rightarrow\\; y = ((x - 4) - 2)^2 + 3\\)"
      },
      {
        ...
        "workingOut": "\\(y = (x - 6)^2 + 3 - 2 \\;\\Rightarrow\\; y = (x - 6)^2 + 1\\)"
      }
    ],
    "isNew": true,
    "graphData": null
  },
  {
    ...
    "difficulty": "medium",
    "type": "multiple_choice",
    "question": "A cylindrical sensor boundary is represented by \\((x - 4)^2 + (y + 1)^2 = 16\\). If the machine is calibrated to translate the scan 2 units to the right and 3 units upward, find the new boundary equation.",
    "opts": [
      "\\((x - 6)^2 + (y - 2)^2 = 16\\)",
      "\\((x - 2)^2 + (y - 2)^2 = 16\\)",
      "\\((x - 6)^2 + (y + 4)^2 = 16\\)",
    ...
    "solutionSteps": [
      {
        ...
        "workingOut": "Given: \\((x - 4)^2 + (y + 1)^2 = 16\\)"
      },
      {
      ...
      },
      {
        ...
        "workingOut": "\\(((x - 2) - 4)^2 + ((y - 3) + 1)^2 = 16 \\;\\Rightarrow\\; (x - 6)^2 + (y - 2)^2 = 16\\)"
      }
    ],
    "isNew": true,
    "graphData": null
  },
  {
    ...
    "difficulty": "medium",
    "type": "multiple_choice",
    "question": "A logistics vehicle's route line is defined by \\(y = -3x + 5\\). Write the equation of the route after it is translated 2 units to the left.",
    "opts": [
      "\\(y = -3(x + 2) + 5\\)",
      "\\(y = -3(x - 2) + 5\\)",
      "\\(y = -3x - 1\\)",
    ...
    "solutionSteps": [
      {
        ...
        "workingOut": "Given: \\(y = -3x + 5\\) and translation of 2 units left"
      },
      {
        ...
        "workingOut": "\\(x \\;\u2192\\; (x + 2) \\;\\Rightarrow\\; y = -3(x + 2) + 5\\)"
      },
      {
  ...
  },
  {
    ...
    "difficulty": "medium",
    "type": "multiple_choice",
    "question": "A satellite trajectory profile is defined by \\(y = 2x^3 - 1\\). If the tracking model translates the curve 3 units to the right, write the new equation.",
    "opts": [
      "\\(y = 2(x - 3)^3 - 1\\)",
      "\\(y = 2(x + 3)^3 - 1\\)",
      "\\(y = 2x^3 - 7\\)",
    ...
    "solutionSteps": [
      {
        ...
        "workingOut": "Given: \\(y = 2x^3 - 1\\) and translation: 3 units right"
      },
      {
  ...
  },
  {
    ...
    "difficulty": "medium",
    "type": "multiple_choice",
    "question": "A thermal fluid channel boundary follows the curve \\(y = \\frac{10}{x}\\). If the channel is translated 2 units to the right and 3 units downward, find the new boundary equation.",
    "opts": [
      "\\(y = \\frac{10}{x - 2} - 3\\)",
      "\\(y = \\frac{10}{x + 2} - 3\\)",
      "\\(y = \\frac{10}{x - 2} + 3\\)",
    ...
    "solutionSteps": [
      {
        ...
        "workingOut": "Given: \\(y = \\frac{10}{x}\\), Horizontal: 2 units right, Vertical: 3 units down"
      },
      {
        ...
        "workingOut": "\\(x \\;\u2192\\; x - 2 \\;\\Rightarrow\\; y = \\frac{10}{x - 2}\\)"
      },
      {
  ...
  },
  {
    ...
    "difficulty": "medium",
    "type": "multiple_choice",
    "question": "A robotics arm path is defined by \\(y = (x + 5)^2 - 2\\). Describe the translation required to map this path onto the new trajectory \\(y = x^2 - 2\\).",
    "opts": [
    ...
    "solutionSteps": [
      {
        ...
        "workingOut": "Initial: \\(y_1 = (x + 5)^2 - 2\\), Target: \\(y_2 = x^2 - 2\\)"
      },
      {
        ...
        "workingOut": "\\(x + 5 \\;\u2192\\; x \\;\\Rightarrow\\; x \\;\u2192\\; x - 5\\)"
      },
      {
  ...
  },
  {
    ...
    "difficulty": "medium",
    "type": "multiple_choice",
    "question": "A suspension cable contour follows the curve \\(y = x^2 - 8x + 10\\). If the engineering model is translated 3 units vertically upward, find the new equation of the cable.",
    "opts": [
      "\\(y = x^2 - 8x + 13\\)",
      "\\(y = x^2 - 8x + 7\\)",
      "\\(y = (x - 3)^2 - 8x + 10\\)",
    ...
    "solutionSteps": [
      {
        ...
        "workingOut": "Given: \\(y = x^2 - 8x + 10\\) and shift: +3 units vertically"
      },
      {
        ...
        "workingOut": "\\(y_{\\text{new}} = (x^2 - 8x + 10) + 3\\)"
      },
      {
  ...
  },
  {
    ...
    "difficulty": "medium",
    "type": "multiple_choice",
    "question": "A conveyor track's trajectory is modeled by the cubic function \\(y = (x - 5)^3 + 2\\). If the track is translated 2 units to the right, find the new path equation.",
    "opts": [
      "\\(y = (x - 7)^3 + 2\\)",
      "\\(y = (x - 3)^3 + 2\\)",
      "\\(y = (x - 7)^3 + 4\\)",
    ...
    "solutionSteps": [
      {
        ...
        "workingOut": "Given: \\(y = (x - 5)^3 + 2\\) and shift of 2 units right"
      },
      {
  ...
  },
  {
    ...
    "difficulty": "medium",
    "type": "multiple_choice",
    "question": "A high-precision laser alignment line follows the model \\(y = 4x - 3\\). If the alignment is translated 3 units to the right and 1 unit downward, find the new linear equation.",
    "opts": [
      "\\(y = 4x - 16\\)",
      "\\(y = 4x - 4\\)",
      "\\(y = 4(x - 3) - 3\\)",
    ...
    "solutionSteps": [
      ...
      },
      {
        ...
        "workingOut": "\\(x \\;\u2192\\; (x - 3)\\) and \\(y \\;\u2192\\; y - 1 \\;\\Rightarrow\\; y = 4(x - 3) - 3 - 1\\)"
      },
      {
        ...
        "workingOut": "\\(y = 4x - 12 - 4 \\;\\Rightarrow\\; y = 4x - 16\\)"
      }
    ],
    "isNew": true,
    "graphData": null
  },
  {
    ...
    "difficulty": "medium",
    "type": "multiple_choice",
    "question": "A digital imaging sensor maps pixel intensity along the curve \\(y = x^2 - 10x + 21\\). Find the vertex of this intensity model by completing the square.",
    "opts": [
      "\\((5, -4)\\)",
      "\\((-5, -4)\\)",
      "\\((5, 4)\\)",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "type": "multiple_choice",
    "question": "A mechanical link deflection is modeled by \\(y = x^2 + 4x + 9\\). Complete the square to determine the coordinate pair of its minimum point.",
    "opts": [
      "\\((-2, 5)\\)",
      "\\((2, 5)\\)",
      "\\((-2, -5)\\)",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "type": "multiple_choice",
    "question": "A thermal expansion profile follows the parabola \\(y = x^2 - 8x + 20\\). Express the equation in vertex form to find the coordinates of the turning point.",
    "opts": [
      "\\((4, 4)\\)",
      "\\((-4, 4)\\)",
      "\\((4, -4)\\)",
    ...
    "solutionSteps": [
      ...
      },
      {
        ...
        "workingOut": "\\(y = (x^2 - 8x + 16) - 16 + 20 \\;\\Rightarrow\\; y = (x - 4)^2 + 4\\)"
      },
      {
  ...
  },
  {
    ...
    "difficulty": "medium",
    "type": "multiple_choice",
    "question": "A structural brace deflection profile is modeled by \\(y = x^2 + 10x + 21\\). Complete the square to determine the coordinate pair of its minimum point.",
    "opts": [
      "\\((-5, -4)\\)",
      "\\((5, -4)\\)",
      "\\((-5, 4)\\)",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "type": "multiple_choice",
    "question": "An agricultural terrain gradient is modeled by the function \\(y = x^2 - 6x + 8\\). Complete the square to determine the coordinate pair of its minimum point.",
    "opts": [
      "\\((3, -1)\\)",
      "\\((-3, -1)\\)",
      "\\((3, 1)\\)",
...
async function run() {
  console.log(`Adding 15 new questions (86 to 100)...`);
