...
async function run() {
  ...
  // 8. y9-5a-8a to y9-5a-8l (Detailed 2-step solutions with fixed workingOut LaTeX delimiters)
  const q8_phrases = {
  ...
  await batch.commit();
  console.log('Successfully completed detailed step expansion and LaTeX wraps for all Year 9 Chapter 5a questions!');
  process.exit(0);
}
