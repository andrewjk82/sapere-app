...
async function run() {
  ...
  // Hypotenuse AC midpoint: ((30+95)/2, (220+64)/2) = (62.5, 142)
  // Angle of AC: atan2(220-64, 95-30) = atan2(156,65) = ~67.4 degrees
  // Label "13" rotated along the hypotenuse, placed to the left of AC
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 340 280" width="340" height="280" style="font-family:sans-serif;">
  ...
  <!-- Label h on the right of the dashed line -->
  <text x="115" y="148" text-anchor="start" font-size="15" font-style="italic" font-weight="bold" fill="#1e40af">h</text>

  <!-- Label 13 on hypotenuse AC (only once, rotated along AC) -->
  <!-- AC midpoint: (62, 142). Angle ~-67deg from horizontal -->
...
${svg}`;
  ...
  console.log("Removed duplicate 13 label from y8-15a-q7a SVG");
  process.exit(0);
}
