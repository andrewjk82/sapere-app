...
// 15 new unique questions (y11a-5-newq101 to newq115) under topic 5A
const newQuestions = [
  {
    "id": "y11a-5-newq101",
    "chapterId": "y11a-5",
    ...
    "question": "A subsea pipeline depth model follows the rational curve \\(y = \\frac{8}{x}\\). If it is translated 6 units to the left and 4 units upward, find the new model equation.",
    "opts": [
      "\\(y = \\frac{8}{x + 6} + 4\\)",
      "\\(y = \\frac{8}{x - 6} + 4\\)",
      "\\(y = \\frac{8}{x + 6} - 4\\)",
    ...
    "solutionSteps": [
      {
        ...
        "workingOut": "Given: \\(y = \\frac{8}{x}\\), Horizontal: 6 units left, Vertical: 4 units up"
      },
      {
        ...
        "workingOut": "\\(x \\;\u2192\\; x + 6 \\;\\Rightarrow\\; y = \\frac{8}{x + 6}\\)"
      },
      {
  ...
  },
  {
    ...
    "difficulty": "medium",
    "type": "multiple_choice",
    "question": "A high-precision optical laser path is modeled by \\(y = (x - 3)^2 + 4\\). If the path is translated 5 units to the right and 3 units downward, find the new path equation.",
    "opts": [
      "\\(y = (x - 8)^2 + 1\\)",
      "\\(y = (x + 2)^2 + 1\\)",
      "\\(y = (x - 8)^2 + 7\\)",
    ...
    "solutionSteps": [
      {
        ...
        "workingOut": "Given: \\(y = (x - 3)^2 + 4\\), Horizontal: 5 units right, Vertical: 3 units down"
      },
      {
        ...
        "workingOut": "\\(x \\;\u2192\\; (x - 5) \\;\\Rightarrow\\; y = ((x - 5) - 3)^2 + 4\\)"
      },
      {
        ...
        "workingOut": "\\(y = (x - 8)^2 + 4 - 3 \\;\\Rightarrow\\; y = (x - 8)^2 + 1\\)"
      }
    ],
    "isNew": true,
    "graphData": null
  },
  {
    ...
    "difficulty": "medium",
    "type": "multiple_choice",
    "question": "A cylindrical sensor boundary is represented by \\((x - 3)^2 + (y + 2)^2 = 25\\). If the machine is calibrated to translate the scan 4 units to the right and 3 units upward, find the new boundary equation.",
    "opts": [
      "\\((x - 7)^2 + (y - 1)^2 = 25\\)",
      "\\((x + 1)^2 + (y - 1)^2 = 25\\)",
      "\\((x - 7)^2 + (y + 5)^2 = 25\\)",
    ...
    "solutionSteps": [
      {
        ...
        "workingOut": "Given: \\((x - 3)^2 + (y + 2)^2 = 25\\)"
      },
      {
      ...
      },
      {
        ...
        "workingOut": "\\(((x - 4) - 3)^2 + ((y - 3) + 2)^2 = 25 \\;\\Rightarrow\\; (x - 7)^2 + (y - 1)^2 = 25\\)"
      }
    ],
    "isNew": true,
    "graphData": null
  },
  {
    ...
    "difficulty": "medium",
    "type": "multiple_choice",
    "question": "A logistics vehicle's route line is defined by \\(y = -3x + 4\\). Write the equation of the route after it is translated 3 units to the left.",
    "opts": [
      "\\(y = -3(x + 3) + 4\\)",
      "\\(y = -3(x - 3) + 4\\)",
      "\\(y = -3x - 5\\)",
    ...
    "solutionSteps": [
      {
        "explanation": "We begin by writing down the initial line equation. The goal is to determine the equation after shifting the line horizontally left by three units. We identify the horizontal variable parameter.",
        "workingOut": "Given: \\(y = -3x + 4\\) and translation of 3 units left"
      },
      {
        ...
        "workingOut": "\\(x \\;\u2192\\; (x + 3) \\;\\Rightarrow\\; y = -3(x + 3) + 4\\)"
      },
      {
  ...
  },
  {
    ...
    "difficulty": "medium",
    "type": "multiple_choice",
    "question": "A satellite trajectory profile is defined by \\(y = 3x^3 - 4\\). If the tracking model translates the curve 2 units to the right, write the new equation.",
    "opts": [
      "\\(y = 3(x - 2)^3 - 4\\)",
      "\\(y = 3(x + 2)^3 - 4\\)",
      "\\(y = 3x^3 - 10\\)",
    ...
    "solutionSteps": [
      {
        ...
        "workingOut": "Given: \\(y = 3x^3 - 4\\) and translation: 2 units right"
      },
      {
  ...
  },
  {
    ...
    "difficulty": "medium",
    "type": "multiple_choice",
    "question": "A thermal fluid channel boundary follows the curve \\(y = \\frac{12}{x}\\). If the channel is translated 3 units to the right and 2 units downward, find the new boundary equation.",
    "opts": [
      "\\(y = \\frac{12}{x - 3} - 2\\)",
      "\\(y = \\frac{12}{x + 3} - 2\\)",
      "\\(y = \\frac{12}{x - 3} + 2\\)",
    ...
    "solutionSteps": [
      {
        ...
        "workingOut": "Given: \\(y = \\frac{12}{x}\\), Horizontal: 3 units right, Vertical: 2 units down"
      },
      {
        ...
        "workingOut": "\\(x \\;\u2192\\; x - 3 \\;\\Rightarrow\\; y = \\frac{12}{x - 3}\\)"
      },
      {
  ...
  },
  {
    ...
    "difficulty": "medium",
    "type": "multiple_choice",
    "question": "A robotics arm path is defined by \\(y = (x + 4)^2 - 1\\). Describe the translation required to map this path onto the new trajectory \\(y = (x - 1)^2 - 1\\).",
    "opts": [
    ...
    "solutionSteps": [
      {
        ...
        "workingOut": "Initial: \\(y_1 = (x + 4)^2 - 1\\), Target: \\(y_2 = (x - 1)^2 - 1\\)"
      },
      {
  ...
  },
  {
    ...
    "difficulty": "medium",
    "type": "multiple_choice",
    "question": "A suspension cable contour follows the curve \\(y = x^2 - 6x + 8\\). If the engineering model is translated 2 units vertically upward, find the new equation of the cable.",
    "opts": [
      "\\(y = x^2 - 6x + 10\\)",
      "\\(y = x^2 - 6x + 6\\)",
      "\\(y = (x - 2)^2 - 6x + 8\\)",
    ...
    "solutionSteps": [
      {
        ...
        "workingOut": "Given: \\(y = x^2 - 6x + 8\\) and shift: +2 units vertically"
      },
      {
        ...
        "workingOut": "\\(y_{\\text{new}} = (x^2 - 6x + 8) + 2\\)"
      },
      {
  ...
  },
  {
    ...
    "difficulty": "medium",
    "type": "multiple_choice",
    "question": "A conveyor track's trajectory is modeled by the cubic function \\(y = (x - 3)^3 + 5\\). If the track is translated 3 units to the right, find the new path equation.",
    "opts": [
      "\\(y = (x - 6)^3 + 5\\)",
      "\\(y = x^3 + 5\\)",
      "\\(y = (x - 6)^3 + 8\\)",
    ...
    "solutionSteps": [
      {
        ...
        "workingOut": "Given: \\(y = (x - 3)^3 + 5\\) and shift of 3 units right"
      },
      {
  ...
  },
  {
    ...
    "difficulty": "medium",
    "type": "multiple_choice",
    "question": "A high-precision laser alignment line follows the model \\(y = 3x - 2\\). If the alignment is translated 4 units to the right and 3 units downward, find the new linear equation.",
    "opts": [
      "\\(y = 3x - 17\\)",
      "\\(y = 3x - 5\\)",
      "\\(y = 3(x - 4) - 2\\)",
    ...
    "solutionSteps": [
      {
        "explanation": "We begin by writing down the initial line equation. The goal is to determine the equation after shifting the line horizontally right by four units and vertically down by three units.",
        "workingOut": "Given: \\(y = 3x - 2\\)"
      },
      {
        ...
        "workingOut": "\\(x \\;\u2192\\; (x - 4)\\) and \\(y \\;\u2192\\; y - 3 \\;\\Rightarrow\\; y = 3(x - 4) - 2 - 3\\)"
      },
      {
        ...
        "workingOut": "\\(y = 3x - 12 - 5 \\;\\Rightarrow\\; y = 3x - 17\\)"
      }
    ],
    "isNew": true,
    "graphData": null
  },
  {
    ...
    "difficulty": "medium",
    "type": "multiple_choice",
    "question": "A digital imaging sensor maps pixel intensity along the curve \\(y = x^2 - 12x + 31\\). Find the vertex of this intensity model by completing the square.",
    "opts": [
      "\\((6, -5)\\)",
      "\\((-6, -5)\\)",
      "\\((6, 5)\\)",
    ...
    "solutionSteps": [
      ...
      },
      {
        ...
        "workingOut": "\\(y = (x^2 - 12x + 36) - 36 + 31 \\;\\Rightarrow\\; y = (x - 6)^2 - 5\\)"
      },
      {
        ...
        "workingOut": "Standard form: \\(y = (x - h)^2 + k \\;\\Rightarrow\\; \\text{Turning Point: } (6, -5)\\)"
      }
    ],
    "isNew": true,
    "graphData": null
  },
  {
    ...
    "difficulty": "medium",
    "type": "multiple_choice",
    "question": "A mechanical link deflection is modeled by \\(y = x^2 + 8x + 11\\). Complete the square to determine the coordinate pair of its minimum point.",
    "opts": [
      "\\((-4, -5)\\)",
      "\\((4, -5)\\)",
      "\\((-4, 5)\\)",
    ...
    "solutionSteps": [
      ...
      },
      {
        ...
        "workingOut": "\\(y = (x^2 + 8x + 16) - 16 + 11 \\;\\Rightarrow\\; y = (x + 4)^2 - 5\\)"
      },
      {
        ...
        "workingOut": "Standard form: \\(y = (x - h)^2 + k \\;\\Rightarrow\\; \\text{Turning Point: } (-4, -5)\\)"
      }
    ],
    "isNew": true,
    "graphData": null
  },
  {
    ...
    "difficulty": "medium",
    "type": "multiple_choice",
    "question": "A thermal expansion profile follows the parabola \\(y = x^2 - 10x + 21\\). Express the equation in vertex form to find the coordinates of the turning point.",
    "opts": [
      "\\((5, -4)\\)",
      "\\((-5, -4)\\)",
      "\\((5, 4)\\)",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "type": "multiple_choice",
    "question": "A structural brace deflection profile is modeled by \\(y = x^2 + 14x + 40\\). Complete the square to determine the coordinate pair of its minimum point.",
    "opts": [
      "\\((-7, -9)\\)",
      "\\((7, -9)\\)",
      "\\((-7, 9)\\)",
    ...
    "solutionSteps": [
      {
        ...
        "workingOut": "Given: \\(y = x^2 + 14x + 40\\)"
      },
      {
        "explanation": "Next, we take the coefficient of the linear term, divide it by two, square it, and add and subtract this value to complete the square. A common mistake is failing to apply the correct sign inside the binomial squared expression.",
        "workingOut": "\\(y = (x^2 + 14x + 49) - 49 + 40 \\;\\Rightarrow\\; y = (x + 7)^2 - 9\\)"
      },
      {
        "explanation": "Finally, we extract the coordinates of the minimum turning point by comparing the equation with the standard vertex form.",
        "workingOut": "Standard form: \\(y = (x - h)^2 + k \\;\\Rightarrow\\; \\text{Turning Point: } (-7, -9)\\)"
      }
    ],
    "isNew": true,
    "graphData": null
  },
  {
    ...
    "difficulty": "medium",
    "type": "multiple_choice",
    "question": "An agricultural terrain gradient is modeled by the function \\(y = x^2 - 8x + 12\\). Complete the square to determine the coordinate pair of its minimum point.",
    "opts": [
      "\\((4, -4)\\)",
      "\\((-4, -4)\\)",
      "\\((4, 4)\\)",
...
async function run() {
  console.log(`Adding 15 new questions (101 to 115)...`);
