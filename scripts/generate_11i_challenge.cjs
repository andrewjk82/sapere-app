...
// Q1: Point division of interval (medium, 90s, subQuestions)
questions.push({
  id: "y9-11i-q1",
  type: "teacher_review",
  difficulty: "medium",
...
// Q2: Equilateral triangle vertices (medium, 90s)
questions.push({
  id: "y9-11i-q2",
  type: "teacher_review",
  difficulty: "medium",
...
// Q3: Parallelogram vertices and diagonals (medium, 90s)
questions.push({
  id: "y9-11i-q3",
  type: "short_answer",
  difficulty: "medium",
...
// Q4: Find fourth vertex in first quadrant (medium, 90s)
questions.push({
  id: "y9-11i-q4",
  type: "short_answer",
  difficulty: "medium",
...
// Q5: Equation of line with scaled intercepts (medium, 90s)
questions.push({
  id: "y9-11i-q5",
  type: "short_answer",
  difficulty: "medium",
...
// Q6: Rhombus ABCD (hard, 120s, subQuestions)
questions.push({
  id: "y9-11i-q6",
  type: "teacher_review",
  difficulty: "hard",
...
// Q7: Apollonius' theorem proof (hard, 120s)
questions.push({
  id: "y9-11i-q7",
  type: "teacher_review",
  difficulty: "hard",
...
// Q8: Midpoint theorem proof (hard, 120s)
questions.push({
  id: "y9-11i-q8",
  type: "teacher_review",
  difficulty: "hard",
...
// Q9: Isosceles trapezium diagonals (hard, 120s)
questions.push({
  id: "y9-11i-q9",
  type: "teacher_review",
  difficulty: "hard",
...
// Q10: Medians concurrency (hard, 120s)
questions.push({
  id: "y9-11i-q10",
  type: "teacher_review",
  difficulty: "hard",
...
// Q11: Semicircle angle (hard, 120s, subQuestions)
questions.push({
  id: "y9-11i-q11",
  type: "teacher_review",
  difficulty: "hard",
