...
const q3f_add = `
  <text x="125" y="145" font-family="sans-serif" font-size="14" stroke="#f8fafc" stroke-width="4" stroke-linejoin="round" text-anchor="middle">10 cm</text>
  <text x="125" y="145" font-family="sans-serif" font-size="14" fill="#b45309" text-anchor="middle">10 cm</text>
  <text x="105" y="138" font-family="sans-serif" font-size="14" stroke="#f8fafc" stroke-width="4" stroke-linejoin="round" text-anchor="end">6 cm</text>
...
if (u1 && u2 && u3) {
  ...
  console.log('Successfully appended halo labels in local file.');
